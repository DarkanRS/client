public class Class160_Sub1_Sub1 extends Class160_Sub1 {
	...
	Class160_Sub1_Sub1(HardwareRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, boolean bool_7) {
	...
	Class160_Sub1_Sub1(HardwareRenderer hardwarerenderer_1, int i_2, int i_3) {
	...
	public void method2750(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		int[] ints_7 = this.aClass505_Sub3_8875.anIntArray8979;
		if (ints_7 == null) {
			throw new IllegalStateException("");
		} else {
			for (int i_8 = 0; i_8 < i_4; i_8++) {
				int i_9 = (i_8 + i_2) * this.anInt8851 + i_1;
				int i_10 = (i_8 + i_6) * this.aClass505_Sub3_8875.anInt8980 + i_5;
	...
	void method14247(boolean bool_1, boolean bool_2, boolean bool_3, int i_4, int i_5, float f_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, boolean bool_13) {
		if (i_7 > 0 && i_8 > 0 && (bool_1 || bool_2)) {
			...
			float[] floats_38 = this.aClass505_Sub3_8875.aFloatArray9010;
	...
	public void method2768(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		...
		if (ints_7 == null) {
			...
			for (int i_8 = 0; i_8 < i_4; i_8++) {
				...
				int i_10 = (i_6 + i_8) * this.aClass505_Sub3_8875.anInt8980 * 299731099 * 444800403 + i_5;
	...
	Class160_Sub1_Sub1(HardwareRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4) {
