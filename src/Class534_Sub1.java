...
public class Class534_Sub1 extends Class534 {
	...
	static int[] method12815(Class282_Sub50_Sub7 class282_sub50_sub7, int i) {
		...
		if (Class38.method859(-1441507225 * ((Class282_Sub50_Sub7) class282_sub50_sub7).anInt9587, 219826890))
			is = (IndexLoaders.ITEM_INDEX_LOADER.getItemDefinitions((int) (-5876141066140255231L * (((Class282_Sub50_Sub7) class282_sub50_sub7).aLong9584)), 327237779).quests);
		else if ((-270249393 * ((Class282_Sub50_Sub7) class282_sub50_sub7).anInt9579) != -1)
			is = (IndexLoaders.ITEM_INDEX_LOADER.getItemDefinitions((((Class282_Sub50_Sub7) class282_sub50_sub7).anInt9579 * -270249393), 616869394).quests);
	...
	static final void method12816(CS2Executor class527, int i) {
		...
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = i_0_ % i_1_;
	}
}
