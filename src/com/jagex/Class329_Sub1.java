...
public class Class329_Sub1 extends Class329 {
    ...
    final void method12459(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, int i_5, int objectId, int i_7, int i_8, ClipMap clipMap, int i_10, int i_11) {
        ...
        if (Class393.preferences.textures.method12873(590379458) != 0 || !objectDefs.hidden) {
            ...
            if (objectDefs.hasSound(317865608)) {
                Static.method6775(i_3, i_4, i_5, i_7, objectDefs, null, null, 2109240355);
            }
                ...
                for (i_5 = 0; i_5 <= this.maxY; i_5++) {
                    for (int i_6 = 0; i_6 <= this.maxX; i_6++) {
                        if ((this.aByteArrayArrayArray3794[i_4][i_6][i_5] & 0x4) != 0) {
                            ...
                            label99:
                            while (i_8 < this.maxX && i_8 - i_7 < 10) {
                                for (i_11 = i_9; i_11 <= i_10; i_11++) {
    ...
    boolean method12464(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3, boolean bool_4, ObjectDefinitions objectdefinitions_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, boolean bool_14, Ground class390_15, ClipMap clipmap_16, int i_17, int i_18) {
        ...
        if (i_2 == SceneObjectType.WALL_STRAIGHT.type) {
            ...
            this.sceneObjectManager.method3395(i_7, i_12, i_13, (Transform_Sub1_Sub5) obj_28, null, -759421433);
            if (i_3 == 0) {
            ...
            if (i_2 == SceneObjectType.WALL_DIAGONAL_CORNER.type) {
                ...
                this.sceneObjectManager.method3395(i_7, i_12, i_13, (Transform_Sub1_Sub5) obj_25, null, -68723515);
                ...
                this.sceneObjectManager.method3395(i_7, i_12, i_13, (Transform_Sub1_Sub5) obj_25, null, -340500627);
                if (objectdefinitions_5.castsShadow && this.aBool3773) {
                    if (i_3 == 0) {
                        class390_15.LA(i_12, i_13 + 1, 50);
                    } else if (i_3 == 1) {
    ...
    boolean method12465(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3, boolean bool_4, ObjectDefinitions objectdefinitions_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13) {
        if (i_2 == SceneObjectType.STRAIGHT_INSIDE_WALL_DEC.type) {
            ...
            this.sceneObjectManager.method3396(i_7, i_12, i_13, (Transform_Sub1_Sub4) obj_15, null);
            return true;
        } else {
            int i_22;
            ...
            if (i_2 == SceneObjectType.STRAIGHT_OUSIDE_WALL_DEC.type) {
                ...
                this.sceneObjectManager.method3396(i_7, i_12, i_13, (Transform_Sub1_Sub4) obj_27, null);
                return true;
                ...
                this.sceneObjectManager.method3396(i_7, i_12, i_13, (Transform_Sub1_Sub4) obj_16, null);
                return true;
