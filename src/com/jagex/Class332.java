...
public class Class332 {
    ...
    public static Class350 method5928(Packet rsbytebuffer_0) {
    ...
    public static void preloadSong(int songId) {
        TCPPacket tcpmessage_2 = Class271.createPacket(ClientProt.SONG_LOADED, client.GAME_CONNECTION_CONTEXT.isaac);
