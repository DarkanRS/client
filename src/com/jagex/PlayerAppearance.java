...
public class PlayerAppearance {
    ...
    public void method3993(int i_1, int i_2, IdentiKitIndexLoader class31_3, int i_4) {
        int i_5 = anIntArray2917[i_1];
        if (class31_3.getIdentiKit(i_2) != null) {
    ...
    public MeshRasterizer method3998(GraphicalRenderer graphicalrenderer_1, int i_2, RenderAnimIndexLoader renderanimindexloader_3, IdentiKitIndexLoader class31_4, NPCIndexLoader npcindexloader_5, ItemIndexLoader itemindexloader_6, AnimationIndexLoader animationindexloader_7, VarProvider interface42_8, Animation animation_9, Animation animation_10, Animation[] arr_11, int[] ints_12, int i_13, EquipmentDefaults defaults6loader_15, short s_16) {
        if (this.anInt2928 != -1) {
            return npcindexloader_5.getNPCDefinitions(this.anInt2928).method6875(graphicalrenderer_1, i_2, renderanimindexloader_3, interface42_8, animation_9, animation_10, arr_11, ints_12, i_13, null, 2039422694);
        } else {
            int i_17 = i_2;
            ...
            if (meshrasterizer_39 == null || graphicalrenderer_1.method8452(meshrasterizer_39.m(), i_17) != 0) {
                ...
                while (true) {
                    ...
                    } else if ((i_31 & ~0x7fffffff) != 0 && !class31_4.getIdentiKit(i_31 & 0x3fffffff).method898()) {
                        bool_29 = true;
                    }
                    ++i_30;
                }
            ...
            if (!bool_38 && !bool_50) {
                ...
                for (i_31 = 1; i_30 < i_24; i_31 <<= 1) {
                    if (arr_11[i_30] != null) {
                        arr_11[i_30].method7578(meshrasterizer_45, i_31, 892744834);
                    }
                    ++i_30;
                }
                if (bool_50) {
    ...
    public MeshRasterizer method3999(GraphicalRenderer graphicalrenderer_1, int i_2, IdentiKitIndexLoader IdentiKitLoader, AnimationIndexLoader animationindexloader_4, Animation animation_5, int idKit1, int idKit2, int idKit3) {
    ...
    public MeshRasterizer method4021(GraphicalRenderer graphicalrenderer_1, int i_2, IdentiKitIndexLoader class31_3, NPCIndexLoader npcindexloader_4, ItemIndexLoader itemindexloader_5, AnimationIndexLoader animationindexloader_6, VarProvider interface42_7, Animation animation_8) {
        if (this.anInt2928 != -1) {
            return npcindexloader_4.getNPCDefinitions(this.anInt2928).renderHead(graphicalrenderer_1, i_2, interface42_7, animation_8, null, 1135826867);
        } else {
            ...
            if (meshrasterizer_11 == null || graphicalrenderer_1.method8452(meshrasterizer_11.m(), i_10) != 0) {
                ...
                for (int i_14 = 0; i_14 < this.anIntArray2921.length; i_14++) {
                    ...
                    } else if ((i_15 & ~0x7fffffff) != 0 && !class31_3.getIdentiKit(i_15 & 0x3fffffff).method900()) {
                        bool_13 = true;
                    }
                }
                if (bool_13) {
    ...
    static void method4034(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
        int i_8 = EntityNode.method4890(i_2, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068, 843506601);
        int i_9 = EntityNode.method4890(i_3, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068, -196621682);
        int i_10 = EntityNode.method4890(i_0, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069, 1641610688);
        int i_11 = EntityNode.method4890(i_1, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069, 444789004);
        int i_12 = EntityNode.method4890(i_2 + i_6, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068, 995356010);
