...
public class OpenGLGraphicalRenderer extends GraphicalRenderer {
    ...
    final Interface15 method13598(byte[] bytes_2, int i_3, boolean bool_4) {
        return !this.aBool8309 || bool_4 && !this.aBool8362 ? new Class131_Sub2(this, bytes_2, i_3) : new Class135_Sub1(this, bytes_2, i_3, bool_4);
    }

    final Interface14 method13599(int i_1, byte[] bytes_2, int i_3, boolean bool_4) {
        return !this.aBool8309 || bool_4 && !this.aBool8362 ? new Class131_Sub1(this, i_1, bytes_2, i_3) : new Class135_Sub2(this, i_1, bytes_2, i_3, bool_4);
    }

    final Interface14 createArrayBuffer(int i_1, Buffer buffer_2, int i_3) {
        return !this.aBool8309 || false && !this.aBool8362 ? new Class131_Sub1(this, i_1, buffer_2) : new Class135_Sub2(this, i_1, buffer_2, i_3);
    }
