...
public class Class319_Sub4 extends Class319 implements Interface31 {
    ...
    Class319_Sub4(AbstractRenderer_Sub2_Sub1 class505_sub2_sub1_1, int i_2, boolean bool_3, int[][] ints_4) {
        ...
        if (bool_3) {
            ...
            for (i_5 = 0; i_5 < 6; i_5++) {
                OpenGL.glTexImage2Di(i_5 + 34069, 0, AbstractRenderer_Sub2_Sub1.method15574(aClass150_3708, aClass76_3710), i_2, i_2, 0, AbstractRenderer_Sub2_Sub1.method15575(aClass150_3708), aGraphicalRenderer_Sub2_Sub1_3700.anInt10198, ints_4[i_5], 0);
            }
        }
