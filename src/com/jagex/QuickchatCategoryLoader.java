...
public class QuickchatCategoryLoader {
    ...
    public QuickChatCategoryDefinitions getChat(int id) {
        QuickChatCategoryDefinitions class282_sub50_sub14_3 = (QuickChatCategoryDefinitions) this.aClass229_3871.get(id);
        if (class282_sub50_sub14_3 != null) {
            ...
            this.aClass229_3871.put(class282_sub50_sub14_3, id);
            return class282_sub50_sub14_3;
        }
    }
