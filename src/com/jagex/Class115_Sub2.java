...
public class Class115_Sub2 extends Class115 {
    ...
    void method1928(Node_Sub21_Sub1 class282_sub21_sub1_1, int i_2, Interface30 obj_3) {
        ...
        if (i_4 != -1) {
            ...
            if (i_2 < this.aGraphicalRenderer_Sub2_Sub1_9419.anInt8825) {
                ...
                this.aGraphicalRenderer_Sub2_Sub1_9419.method14035(obj_3);
            } else {
    ...
    public void method32() {
        if (this.anInt9423 != 0) {
            ...
            if (this.anInt9435 != 0) {
                this.aGraphicalRenderer_Sub2_Sub1_9419.method15580(this.anInt9435);
            }

            if (this.anInt9424 != 0) {
                this.aGraphicalRenderer_Sub2_Sub1_9419.method15580(this.anInt9424);
            }
