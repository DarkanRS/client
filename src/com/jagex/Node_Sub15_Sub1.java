...
public class Node_Sub15_Sub1 extends Node_Sub15 {
    ...
    synchronized void method12230(int[] ints_1, int i_2, int i_3) {
        if (!this.aBool9574) {
            if (this.method14812() == null) {
                ...
                while (i_2 < i_4) {
                    Node_Sub39 class282_sub39_7 = this.method14812();
    ...
    synchronized Node_Sub39 method14812() {
        return (Node_Sub39) this.aClass482_9568.head();
    }

    synchronized void method14813(int i_1) {
        Node_Sub39 class282_sub39_2 = this.method14812();
    ...
    Node_Sub39 method14814(int i_1, double d_2) {
        long long_4 = this.anInt9567 << 32 | i_1;
        Node_Sub39 class282_sub39_6 = (Node_Sub39) aClass321_9573.method5739(Long.valueOf(long_4));
        if (class282_sub39_6 != null) {
            class282_sub39_6.aDouble8004 = d_2;
            aClass321_9573.method5737(Long.valueOf(long_4));
        } else {
            class282_sub39_6 = new Node_Sub39(new short[this.anInt9567][i_1], d_2);
        }
        return class282_sub39_6;
    }

    synchronized void method14815(Node_Sub39 class282_sub39_1, int i_2) {
    ...
    synchronized double method14819() {
        if (this.anInt9569 < 1) {
            ...
            Node_Sub39 class282_sub39_2 = (Node_Sub39) this.aClass482_9568.head();
