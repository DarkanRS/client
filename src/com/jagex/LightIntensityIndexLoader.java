...
public class LightIntensityIndexLoader {
    ...
    public LightIntensityDefinitions method7304(int i_1, byte b_2) {
        ...
        synchronized (this.aClass229_5334) {
            class416_3 = (LightIntensityDefinitions) this.aClass229_5334.get(i_1);
        }
        ...
        if (class416_3 != null) {
            ...
            synchronized (this.aClass229_5334) {
                this.aClass229_5334.put(class416_3, i_1);
                return class416_3;
            }
        }
    }
    ...
    static final void method7313(IFSubNode class282_sub44_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, byte b_10) {
        if (MovingAnimation.isInterfaceLoaded(i_1, null, -149079200)) {
