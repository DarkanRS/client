...
public class SceneObjectManager {
    ...
    public boolean method3397(Transform_Sub1_Sub1 class521_sub1_sub1_1, boolean bool_2, int i_3) {
        ...
        if (class521_sub1_sub1_1.aShort9458 >= 0 && class521_sub1_sub1_1.aShort9456 >= 0 && class521_sub1_sub1_1.localX < this.sizeX && class521_sub1_sub1_1.localY < this.sizeY) {
            short s_8 = 0;
            int i_9;
            int i_10;
            ...
            if (!this.aBoolArray2647[i_2]) {
                ...
                for (int i_13 = i_11; i_13 <= i_12; i_13++) {
                    ...
                    for (int i_19 = i_17; i_19 <= i_18; i_19++) {
                        byte b_20 = 1;
                        Transform_Sub1_Sub1 class521_sub1_sub1_21 = this.getInteractableObject(i_5, i_19, i_13, null);
    ...
    void method3441(boolean bool_1, byte[][][] bytes_2, int i_3, byte b_4) {
        ...
        if (this.aBool2598) {
            this.aGraphicalRenderer_2596.method8547(0, null);
        }
        if ((0 & 0x2) == 0) {
            for (i_16 = 0; i_16 < this.anInt2601; i_16++) {
                ...
                if (i_16 >= i_3 && bytes_2 != null) {
                    ...
                    if (this.aBoolArrayArray2651.length + this.anInt2637 > this.sizeX) {
                        i_8 -= this.aBoolArrayArray2651.length + this.anInt2637 - this.sizeX;
                    }
                    i_9 = this.aBoolArrayArray2651[0].length;
                    if (this.aBoolArrayArray2651[0].length + this.anInt2621 > this.sizeY) {
                        i_9 -= this.aBoolArrayArray2651[0].length + this.anInt2621 - this.sizeY;
                    }
                    ...
                    if (this.aBool2599) {
                        for (i_11 = this.anInt2602; i_11 < i_8; i_11++) {
                            i_12 = i_11 + this.anInt2637 - this.anInt2602;
                            for (i_13 = this.anInt2636; i_13 < i_9; i_13++) {
                                bools_10[i_11][i_13] = this.aBoolArrayArray2651[i_11][i_13] && !this.aClass201_2600.method3271(i_16, i_12, i_13 + this.anInt2621 - this.anInt2636);
                            }
                        }
                    }
    ...
    public void method3447(int i_1, int i_2, int i_3, int i_4, byte[][][] bytes_5, int[] ints_6, int[] ints_7, int[] ints_8, int[] ints_9, int[] ints_10, int i_11, byte b_12, int i_13, int i_14, boolean bool_15) {
        ...
        if (this.anInt2638 > this.sizeX) {
            this.anInt2638 = this.sizeX;
        }
        this.anInt2640 = this.anInt2652 + this.anInt2629;
        if (this.anInt2640 > this.sizeY) {
    ...
    void method3508(Transform_Sub1 class521_sub1_1, Node_Sub24[] arr_2) {
        ...
        if (this.aGroundArray2614 == this.aGroundArray2591) {
            ...
            class90_8.color = this.getColor(i_6, i_7);
            class90_8.scale = this.getScale(i_6, i_7);
    ...
    public SceneObjectManager(GraphicalRenderer renderer, int sizeX, int sizeY, int i_6, boolean highDetailWater, boolean bool_8) {
        ...
        if (highDetailWater) {
            ...
            this.scales = new short[this.sizeX][this.sizeY];
            this.waterRelatedArray4 = new byte[this.sizeX][this.sizeY];
