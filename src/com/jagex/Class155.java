...
public final class Class155 {
    ...
    public void method2625(int i_1, int i_2) {
        ...
        IntNode class282_sub38_4 = (IntNode) this.aClass465_1969.get(i_1);
        if (class282_sub38_4 != null) {
            class282_sub38_4.value = i_2;
        } else {
            class282_sub38_4 = new IntNode(i_2);
            this.aClass465_1969.put(class282_sub38_4, i_1);
        }
    }

    public int method2626(int i_1, byte b_2) {
        IntNode class282_sub38_3 = (IntNode) this.aClass465_1969.get(i_1);
