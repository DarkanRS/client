...
public abstract class Class278 {
    ...
    boolean method4910(int i_1) {
        if (this.aNode_Sub41_Sub4_3366 != null) {
            ...
            double d_2 = this.aNode_Sub41_Sub3_3363.method14791();
    ...
    Node_Sub41 method4911(byte b_1) throws IOException {
        if (this.aBool3360) {
            ...
            if (!this.anOggPage3352.isBOS()) {
                Node_Sub41 class282_sub41_9 = (Node_Sub41) this.aClass465_3358.get(i_2);
                ...
                if (!oggstreamstate_3.pageIn(this.anOggPage3352)) {
                    ...
                    this.aClass465_3358.put((Node) obj_4, i_2);
    ...
    public boolean method4921() {
        return (this.aBool3360 || this.aBool3361) && (this.aNode_Sub41_Sub4_3366 == null || this.aNode_Sub41_Sub4_3366.method14847(1747379029) <= 0);
    }
        ...
        if (!this.aBool3353) {
            for (; !this.aBool3360; this.aBool3359 = false) {
                ...
                if (!this.aBool3359) {
                    ...
                    class282_sub41_2 = (Node_Sub41) this.aClass465_3358.get(this.anOggPage3352.getSerialNumber());
                }
