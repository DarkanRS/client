...
public class MapSpriteIndexLoader {
    ...
    public MapSpriteDefinitions method7172(int i_1) {
        ...
        synchronized (this.aClass229_5117) {
            class418_3 = (MapSpriteDefinitions) this.aClass229_5117.get(i_1);
        }
        if (class418_3 != null) {
            return class418_3;
        } else {
            ...
            synchronized (this.aClass229_5117) {
                this.aClass229_5117.put(class418_3, i_1);
                return class418_3;
            }
        }
    }
        ...
        if (animable_0.anInt10340 == 0) {
            ...
            if (animable_0.faceEntity != -1) {
                ...
                if (animable_0.faceEntity < 32768) {
                    StringNode class282_sub47_3 = (StringNode) client.NPCS.get(animable_0.faceEntity);
                ...
                if (obj_2 != null) {
                    ...
                    i_5 = (int) vector3_9.z;
                    if (i_4 != 0 || i_5 != 0) {
                        animable_0.method15863((int) (Math.atan2(i_4, i_5) * 2607.5945876176133D) & 0x3fff, 1489120080);
                    }
                }
            }
            if (animable_0 instanceof Player) {
                ...
                if (npc_10.faceX != -1 && (npc_10.anInt10355 == 0 || npc_10.anInt10366 > 0)) {
                    ...
                    if (i_5 != 0 || i_6 != 0) {
                        npc_10.method15863((int) (Math.atan2(i_5, i_6) * 2607.5945876176133D) & 0x3fff, 1631347734);
                    }
                    npc_10.faceX = -1;
                }
            }
