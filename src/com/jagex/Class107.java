...
public class Class107 {
    ...
    public Node_Sub21 method1820(String string_1, int i_2) {
        long long_3 = this.anInterface11_1078.method79(string_1, 166693021);
        for (Node_Sub21 class282_sub21_5 = (Node_Sub21) this.aClass465_1080.get(long_3); class282_sub21_5 != null; class282_sub21_5 = (Node_Sub21) this.aClass465_1080.method7747(-1934040693)) {
    ...
    void method1821(int i_1) {
        Node_Sub21 class282_sub21_3 = this.method1823(i_1, 1887501575);
        if (class282_sub21_3 != null) {
            class282_sub21_3.remove();
            this.aNode_Sub21Array1079[class282_sub21_3.anInt7675] = null;
        }
    }

    public void method1822(int i_1, String string_2, Node_Sub21 class282_sub21_3) {
        Node_Sub21 class282_sub21_5 = this.method1820(string_2, -2129504033);
        if (class282_sub21_5 != null && class282_sub21_5.anInt7675 != i_1) {
            ...
            if (i_1 >= this.aNode_Sub21Array1079.length) {
                ...
                for (int i_7 = 0; i_7 < this.aNode_Sub21Array1079.length; i_7++) {
                    Node_Sub21 class282_sub21_10 = this.aNode_Sub21Array1079[i_7];
                ...
                for (int i_8 = 0; i_8 < this.aNode_Sub21Array1079.length; i_8++) {
                    arr_9[i_8] = this.aNode_Sub21Array1079[i_8];
                }
                this.aNode_Sub21Array1079 = arr_9;
            }
            ...
            this.aNode_Sub21Array1079[i_1] = class282_sub21_3;
        }
    }

    public Node_Sub21 method1823(int i_1, int i_2) {
        return i_1 >= this.aNode_Sub21Array1079.length ? null : this.aNode_Sub21Array1079[i_1];
    }
}
