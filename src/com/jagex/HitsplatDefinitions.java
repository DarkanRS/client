...
public class HitsplatDefinitions {
    ...
    public NativeSprite method3832(GraphicalRenderer graphicalrenderer_1) {
        if (this.anInt2851 < 0) {
            ...
            NativeSprite nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2851);
            if (nativesprite_3 == null) {
                this.method3839(graphicalrenderer_1);
                nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2851);
            }
    ...
    public NativeSprite method3835(GraphicalRenderer graphicalrenderer_1) {
        if (this.anInt2842 < 0) {
            ...
            NativeSprite nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2842);
            if (nativesprite_3 == null) {
                this.method3839(graphicalrenderer_1);
                nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2842);
            }
    ...
    public NativeSprite method3836(GraphicalRenderer graphicalrenderer_1) {
        if (this.anInt2843 < 0) {
            ...
            NativeSprite nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2843);
            if (nativesprite_3 == null) {
                this.method3839(graphicalrenderer_1);
                nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2843);
            }
    ...
    public NativeSprite method3838(GraphicalRenderer graphicalrenderer_1, byte b_2) {
        if (this.anInt2845 < 0) {
            ...
            NativeSprite nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2845);
            if (nativesprite_3 == null) {
                this.method3839(graphicalrenderer_1);
                nativesprite_3 = (NativeSprite) this.aClass210_2850.aClass229_2664.get(this.anInt2845);
            }
    ...
    void method3839(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (this.anInt2842 >= 0 && this.aClass210_2850.aClass229_2664.get(this.anInt2842) == null && index_3.loadFile(this.anInt2842)) {
            class91_4 = SpriteDefinitions.method1515(index_3, this.anInt2842);
            this.aClass210_2850.aClass229_2664.put(graphicalrenderer_1.method8444(class91_4, true), this.anInt2842);
        }

        if (this.anInt2843 >= 0 && this.aClass210_2850.aClass229_2664.get(this.anInt2843) == null && index_3.loadFile(this.anInt2843)) {
            class91_4 = SpriteDefinitions.method1515(index_3, this.anInt2843);
            this.aClass210_2850.aClass229_2664.put(graphicalrenderer_1.method8444(class91_4, true), this.anInt2843);
        }

        if (this.anInt2851 >= 0 && this.aClass210_2850.aClass229_2664.get(this.anInt2851) == null && index_3.loadFile(this.anInt2851)) {
            class91_4 = SpriteDefinitions.method1515(index_3, this.anInt2851);
            this.aClass210_2850.aClass229_2664.put(graphicalrenderer_1.method8444(class91_4, true), this.anInt2851);
        }

        if (this.anInt2845 >= 0 && this.aClass210_2850.aClass229_2664.get(this.anInt2845) == null && index_3.loadFile(this.anInt2845)) {
            class91_4 = SpriteDefinitions.method1515(index_3, this.anInt2845);
            this.aClass210_2850.aClass229_2664.put(graphicalrenderer_1.method8444(class91_4, true), this.anInt2845);
        }
    ...
    static void method3851() {
        for (CacheableNode_Sub15 class282_sub50_sub15_1 = (CacheableNode_Sub15) Class20.aClass477_182.method7941(); class282_sub50_sub15_1 != null; class282_sub50_sub15_1 = (CacheableNode_Sub15) Class20.aClass477_182.method7955(-395453439)) {
