...
public class Node_Sub20_Sub12 extends Node_Sub20 {
    ...
    static {
        ...
        for (int i_1 = 0; i_1 < 256; i_1++) {
            for (int i_2 = 0; i_2 <= i_1; i_2++) {
                aByteArray9814[i_0++] = (byte) ((int) (255.0D / Math.sqrt((float) (i_2 * i_2 + i_1 * i_1 + 65535) / 65535.0F)));
            }
        }
    ...
    void method15266() {
        double d_2 = Math.cos((float) this.anInt9807 / 4096.0F);
        this.anIntArray9808[0] = (int) (Math.sin((float) this.anInt9813 / 4096.0F) * d_2 * 4096.0D);
        this.anIntArray9808[1] = (int) (Math.cos((float) this.anInt9813 / 4096.0F) * d_2 * 4096.0D);
        this.anIntArray9808[2] = (int) (Math.sin((float) this.anInt9807 / 4096.0F) * 4096.0D);
