...
public class Class141_Sub3 extends Class141 {
    ...
    void method2411() {
        ...
        if (this.aGraphicalRenderer_Sub1_1664.anInt8358 > 0) {
            this.aGraphicalRenderer_Sub1_1664.method13610(1);
            this.aGraphicalRenderer_Sub1_1664.method13654(null);
            this.aGraphicalRenderer_Sub1_1664.method13591(1.0F, 0.0F);
    ...
    void method2396(int i_1, int i_2) {
        if ((i_1 & 0x1) == 1) {
            if (this.aClass136_9044.aBool1631) {
                this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass136_9044.aClass137_Sub4_1633);
                aFloatArray9048[0] = 0.0F;
                aFloatArray9048[1] = 0.0F;
                aFloatArray9048[2] = 0.0F;
                aFloatArray9048[3] = (float) (this.aGraphicalRenderer_Sub1_1664.anInt8368 % 4000) / 4000.0F;
                OpenGL.glTexGenfv(8194, 9473, aFloatArray9048, 0);
            } else {
                int i_3 = this.aGraphicalRenderer_Sub1_1664.anInt8368 % 4000 * 16 / 4000;
                this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass136_9044.aClass137_Sub1Array1632[i_3]);
            }
            ...
            this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass136_9044.aClass137_Sub1Array1632[0]);
        }

    }

    void method2408(boolean bool_1) {
        this.aGraphicalRenderer_Sub1_1664.method13717(260, 8448);
    }
    ...
    void method2397(boolean bool_1) {
        if (this.aGraphicalRenderer_Sub1_1664.anInt8358 > 0) {
            float f_2 = -0.5F / (float) this.aGraphicalRenderer_Sub1_1664.anInt8358;
            this.aGraphicalRenderer_Sub1_1664.method13610(1);
            aFloatArray9048[0] = 0.0F;
            aFloatArray9048[1] = 0.0F;
            aFloatArray9048[2] = f_2;
            aFloatArray9048[3] = this.aGraphicalRenderer_Sub1_1664.aFloat8406 * f_2 + 0.25F;
            OpenGL.glPushMatrix();
            OpenGL.glLoadIdentity();
            OpenGL.glTexGenfv(8192, 9474, aFloatArray9048, 0);
            OpenGL.glPopMatrix();
            this.aGraphicalRenderer_Sub1_1664.method13591(0.5F, (float) this.aGraphicalRenderer_Sub1_1664.anInt8358);
            this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass137_Sub3_9047);
            this.aGraphicalRenderer_Sub1_1664.method13610(0);
        }
    ...
    void method14423() {
        this.aClass138_9046 = new Class138(this.aGraphicalRenderer_Sub1_1664, 2);
        this.aClass138_9046.method2380(0);
        this.aGraphicalRenderer_Sub1_1664.method13610(1);
        this.aGraphicalRenderer_Sub1_1664.method13717(7681, 260);
    ...
    Class141_Sub3(OpenGLGraphicalRenderer class505_sub1_1, Class136 class136_2) {
        ...
        this.method14423();
        this.aClass137_Sub3_9047 = new Class137_Sub3(this.aGraphicalRenderer_Sub1_1664, Class150.aClass150_1951, Class76.aClass76_751, new byte[]{(byte) 0, (byte) -1}, Class150.aClass150_1951);
