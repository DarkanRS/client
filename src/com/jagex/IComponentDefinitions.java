...
public class IComponentDefinitions {
    ...
    void readValues(RsByteBuffer rsbytebuffer_1) {
        ...
        if (i_16 != 0) {
            ...
            for (this.anIntArray1267 = new int[11]; i_16 != 0; i_16 = rsbytebuffer_1.readUnsignedByte()) {
                i_7 = (i_16 >> 4) - 1;
        ...
        if (i_3 >= 0) {
            ...
            for (i_12 = 0; i_12 < i_11; i_12++) {
                ...
                this.aClass465_1365.put(new IntNode(i_14), i_13);
            }
            ...
            for (i_13 = 0; i_13 < i_12; i_13++) {
                ...
                this.aClass465_1365.put(new StringNode(string_15), i_14);
            }
        }
    ...
    public void method1987() {
        ...
        this.anIntArray1315 = null;
        this.anObjectArray1405 = null;
        this.anIntArray1406 = null;
        this.anObjectArray1409 = null;
        this.params = null;
        this.anObjectArray1393 = null;
        this.anObjectArray1412 = null;
        this.anObjectArray1413 = null;
        this.anObjectArray1292 = null;
        this.anObjectArray1415 = null;
        this.anObjectArray1416 = null;
        this.anObjectArray1383 = null;
        this.anObjectArray1419 = null;
        this.anObjectArray1361 = null;
        this.anObjectArray1421 = null;
        this.anObjectArray1346 = null;
        this.anObjectArray1353 = null;
        this.anObjectArray1271 = null;
    }
    ...
    public void method1991(GraphicalRenderer graphicalrenderer_1, MeshRasterizer meshrasterizer_2, Matrix44Var matrix44var_3, int i_4) {
        ...
        if (this.particleSystem != null) {
            this.particleSystem.method11511(graphicalrenderer_1, i_4, arr_6, arr_7);
        }
    }
    ...
    public void method1995(int i_1) {
        if (this.aClass465_1365 != null) {
            Node node_3 = this.aClass465_1365.get(i_1);
            if (node_3 != null) {
                node_3.remove();
            }
        }
    ...
    public int method1997(int i_1, int i_2, int i_3) {
        if (this.aClass465_1365 == null) {
            return i_2;
        } else {
            IntNode class282_sub38_4 = (IntNode) this.aClass465_1365.get(i_1);
    ...
    public String method1998(int i_1, String string_2) {
        if (this.aClass465_1365 == null) {
            ...
            StringNode class282_sub47_4 = (StringNode) this.aClass465_1365.get(i_1);
            return class282_sub47_4 == null ? string_2 : (String) class282_sub47_4.anObject8068;
        }
    }

    public void method1999(int i_1, int i_2, int i_3) {
        if (this.aClass465_1365 == null) {
            this.aClass465_1365 = new IterableNodeMap(16);
            this.aClass465_1365.put(new IntNode(i_2), i_1);
        } else {
            IntNode class282_sub38_4 = (IntNode) this.aClass465_1365.get(i_1);
    ...
    public void method2000(int i_1, String string_2) {
        if (this.aClass465_1365 == null) {
            this.aClass465_1365 = new IterableNodeMap(16);
            this.aClass465_1365.put(new StringNode(string_2), i_1);
        } else {
            StringNode class282_sub47_4 = (StringNode) this.aClass465_1365.get(i_1);
    ...
    public MeshRasterizer method2002(GraphicalRenderer graphicalrenderer_1, int i_2, RenderAnimIndexLoader renderanimindexloader_3, IdentiKitIndexLoader class31_4, NPCIndexLoader npcindexloader_5, ItemIndexLoader itemindexloader_6, AnimationIndexLoader animationindexloader_7, VarProvider interface42_8, Animation animation_9, PlayerAppearance playerappearance_10) {
        ...
        if (this.modelType == ModelType.NONE) {
            ...
            if (this.modelType == ModelType.NPC_HEAD) {
                ...
                meshrasterizer_23 = npcindexloader_5.getNPCDefinitions(this.modelId).method6875(graphicalrenderer_1, i_2, renderanimindexloader_3, interface42_8, animation_9, null, null, null, 0, this.npcMeshModifier, -653193588);
                if (meshrasterizer_23 == null) {
                    aBool1399 = true;
                    return null;
                } else {
    ...
    public Class247 method2027(SkyboxIndexLoader class288_1, SunIndexLoader class45_2, int i_3) {
        if (this.anInt1404 == -1) {
            ...
            long long_4 = ((long) this.anInt1432 & 0xffffL) << 48 | ((long) this.anInt1433 & 0xffffL) << 32 | ((long) this.anInt1434 & 0xffffL) << 16 | (long) this.anInt1404 & 0xffffL;
            Class247 class247_6 = (Class247) aClass229_1282.get(long_4);
            if (class247_6 == null) {
                class247_6 = class288_1.method5077(this.anInt1404, this.anInt1432, this.anInt1433, this.anInt1434, class45_2, 1112626910);
    ...
    public static IComponentDefinitions getDefs(int hash) {
        ...
        if (CustomCursorsPreference.INTERFACES[interfaceId] == null || CustomCursorsPreference.INTERFACES[interfaceId].getComponent(hash) == null) {
            boolean bool_3 = MovingAnimation.isInterfaceLoaded(interfaceId, null, -1161112150);
            if (!bool_3) {
                return null;
            }
        }
