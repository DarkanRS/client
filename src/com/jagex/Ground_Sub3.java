...
public class Ground_Sub3 extends Ground {
    ...
    public void method6708(int i_1, int i_2, int[] ints_3, int[] ints_4, int[] ints_5, int[] ints_6, int[] ints_7, int[] ints_8, int[] ints_9, int[] ints_10, int[] ints_11, int[] ints_12, int[] ints_13, HDWaterTile class90_14) {
        ...
        if (!bool_16) {
            ...
            for (i_22 = 0; i_22 < s_29; i_22++) {
                ...
                i_23 = ints_12[i_22];
                if (i_23 != -1) {
                    TextureDetails class169_24 = this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_23);
            ...
            for (i_22 = 0; i_22 < s_29; i_22++) {
                if (ints_10[i_22] >= 0 || ints_11 != null && ints_11[i_22] >= 0) {
                    ...
                    if (bool_30) {
                        if (ints_12[i_22] != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(ints_12[i_22]).isGroundMesh) {
            ...
            i_19 = ints_12[0];
            if (ints_11 != null) {
                class178_32.anInt2213 = Node_Sub20_Sub2.method15076(Class372.method6362(ints_11[0], 866250443), this.aByteArrayArray9355[i_1][i_2] - this.aByteArrayArray9356[i_1][i_2], -1962172044);
                if (i_18 == -1) {
            ...
            if (i_19 != -1) {
                class169_26 = this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_19);
            }
            ...
            if (class169_26 != null && (class178_32.aByte2219 & 0x2) == 0 && !class169_26.isGroundMesh) {
                ...
                class178_32.aShort2214 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1][i_2] - this.aByteArrayArray9356[i_1][i_2], -1738485590);
                class178_32.aShort2217 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1 + 1][i_2] - this.aByteArrayArray9356[i_1 + 1][i_2], -1271688896);
                class178_32.aShort2216 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1 + 1][i_2 + 1] - this.aByteArrayArray9356[i_1 + 1][i_2 + 1], -1529002876);
                class178_32.aShort2218 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1][i_2 + 1] - this.aByteArrayArray9356[i_1][i_2 + 1], -1592668079);
            ...
            if (bool_13) {
                ...
                for (i_15 = 0; i_15 < class181_29.aShort2248; i_15++) {
                    ...
                    if (ints_7[i_15] == 0) {
                        ...
                        i_34 = -16777216;
                        if (ints_9[i_15] != -1 && this.method14620(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(ints_9[i_15]).effectId)) {
                            i_34 = -1694498816;
                        }
                ...
                if (bool_31) {
                    ...
                    if (i_21 != -1 && (class177_30.aByte2210 & 0x2) == 0 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_21).isGroundMesh) {
                        ...
                        class177_30.anInt2209 = FontRenderer_Sub3.method14337(method14616(ints_7[i_15] >> 8, this.aByteArrayArray9355[i_1][i_2] - this.aByteArrayArray9356[i_1][i_2]), class90_11.color, i_22);
                        ...
                        class177_30.anInt2204 = FontRenderer_Sub3.method14337(method14616(ints_7[i_16] >> 8, this.aByteArrayArray9355[i_1 + 1][i_2] - this.aByteArrayArray9356[i_1 + 1][i_2]), class90_11.color, i_22);
                        if (class177_30.anInt2203 != 0) {
                        ...
                        class177_30.anInt2211 = FontRenderer_Sub3.method14337(method14616(ints_7[i_17] >> 8, this.aByteArrayArray9355[i_1 + 1][i_2 + 1] - this.aByteArrayArray9356[i_1 + 1][i_2 + 1]), class90_11.color, i_22);
                        if (class177_30.anInt2203 != 0) {
                        ...
                        class177_30.anInt2206 = FontRenderer_Sub3.method14337(method14616(ints_7[i_32] >> 8, this.aByteArrayArray9355[i_1][i_2 + 1] - this.aByteArrayArray9356[i_1][i_2 + 1]), class90_11.color, i_22);
                    ...
                    for (i_21 = 0; i_21 < class196_38.aShort2415; i_21++) {
                        if (ints_9[i_21 * 3] != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(ints_9[i_21 * 3]).isGroundMesh) {
                            bool_33 = true;
                        }
                    }
                    ...
                    for (i_21 = 0; i_21 < class196_38.aShort2415; i_21++) {
                        ...
                        if (bool_33) {
                            ...
                            i_27 = ints_9[i_22];
                            if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                bool_36 = true;
                            } else {
                                bool_37 = false;
                            }
                            ...
                            if (bool_37) {
                                ...
                                if (bool_36) {
                                    i_27 = ints_9[i_22];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_22] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 1039237710) & 0xffff];
                                    }

                                    i_27 = ints_9[i_34];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_34] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 197018698) & 0xffff];
                                    }

                                    i_27 = ints_9[i_24];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_24] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 2122916828) & 0xffff];
                                    }
                                }
    ...
    void method14617(int i_1, int i_2, boolean bool_3, Class185 class185_4, ChoppyItemFixClass choppyitemfixclass_5, float[] floats_6, float[] floats_7, float[] floats_8, float[] floats_9, float[] floats_10, int i_11) {
        ...
        if (class177_12 != null) {
            if ((class177_12.aByte2210 & 0x2) == 0) {
                ...
                boolean bool_59 = class177_12.aShort2212 != -1 && this.method14620(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(class177_12.aShort2212).effectId);
                f_60 = f_18 + f_19 + f_20;
                        ...
                        if ((f_18 - f_19) * (f_23 - f_22) - (f_21 - f_22) * (f_20 - f_19) > 0.0F) {
                            ...
                            if (f_24 < 3.0F) {
                                ...
                                if (f_24 > 0.0F) {
                                    if (s_57 != -1) {
                                        i_58 = -16777216;
                                        if (s_57 != -1 && this.method14620(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(s_57).effectId)) {
                                            i_58 = -1694498816;
                                        }
    ...
    public void method6717(int i_1, int i_2, int i_3, boolean[][] bools_4, boolean bool_5) {
        if (this.aGraphicalRenderer_Sub3_9353.anIntArray8979 != null && this.aGraphicalRenderer_Sub3_9353.aFloatArray9010 != null) {
            Matrix44Arr matrix44arr_7 = this.aGraphicalRenderer_Sub3_9353.aClass384_8996;
    ...
    void method14618(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, boolean[][] bools_8, Class185 class185_9, ChoppyItemFixClass choppyitemfixclass_10, float[] floats_11, float[] floats_12) {
        ...
        this.aGraphicalRenderer_Sub3_9353.RA(false);
                    ...
                    if (this.aClass177ArrayArray9336 != null) {
                        if (this.aClass177ArrayArray9336[i_18][i_19] != null) {
                            ...
                            if (class177_33.aShort2212 != -1 && (class177_33.aByte2210 & 0x2) == 0 && class177_33.anInt2203 == 0) {
                                i_21 = this.aGraphicalRenderer_Sub3_9353.method14362(class177_33.aShort2212);
                                choppyitemfixclass_10.method2426(true, true, false, (float) (i_17 - i_14), (float) (i_17 - i_14), (float) i_17, (float) (i_16 + i_14), (float) i_16, (float) (i_16 + i_14), 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2211, -1827436229), (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2206, -1440789808), (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2204, -1699690217));
                                choppyitemfixclass_10.method2426(true, true, false, (float) i_17, (float) i_17, (float) (i_17 - i_14), (float) i_16, (float) (i_16 + i_14), (float) i_16, 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2209, -1603627148), (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2204, -1946394922), (float) Node_Sub20_Sub2.method15076(i_21, class177_33.anInt2206, -1527416514));
                            ...
                            for (i_21 = 0; i_21 < class196_32.aShort2415; i_21++) {
                                ...
                                if (class196_32.anIntArray2423 == null || class196_32.anIntArray2423[i_21] == 0 || class196_32.aShortArray2413 != null && (class196_32.aShortArray2413 == null || class196_32.aShortArray2413[i_21] != -1)) {
                                    if (class196_32.aShortArray2413 != null && class196_32.aShortArray2413[i_21] != -1) {
                                        i_31 = this.aGraphicalRenderer_Sub3_9353.method14362(class196_32.aShortArray2413[i_21]);
        ...
        this.aGraphicalRenderer_Sub3_9353.RA(bool_15);
    }
    ...
    boolean method14620(int i_1) {
        return (this.anInt9345 & 0x8) != 0 && (i_1 == 4 || (i_1 == 8 || i_1 == 9));
    }
                ...
                if (bools_8[i_18 - i_4][i_19 - i_5]) {
                    ...
                    if (this.aClass178ArrayArray9352[i_18][i_19] != null) {
                        ...
                        if (class178_32.aShort2215 != -1 && (class178_32.aByte2219 & 0x2) == 0 && class178_32.anInt2213 == -1) {
                            i_21 = this.aGraphicalRenderer_Sub3_9353.method14362(class178_32.aShort2215);
                            choppyitemfixclass_10.method2426(true, true, false, (float) (i_17 - i_14), (float) (i_17 - i_14), (float) i_17, (float) (i_16 + i_14), (float) i_16, (float) (i_16 + i_14), 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2216 & 0xffff, -1425918442), (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2218 & 0xffff, -1439118140), (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2217 & 0xffff, -1530744036));
                            choppyitemfixclass_10.method2426(true, true, false, (float) i_17, (float) i_17, (float) (i_17 - i_14), (float) i_16, (float) (i_16 + i_14), (float) i_16, 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2214 & 0xffff, -1392036644), (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2217 & 0xffff, -1288744310), (float) Node_Sub20_Sub2.method15076(i_21, class178_32.aShort2218 & 0xffff, -2095834541));
                        ...
                        for (i_21 = 0; i_21 < class183_20.aShort2269; i_21++) {
                            ...
                            if (class183_20.anIntArray2277 != null && class183_20.anIntArray2277[i_21] != -1) {
                                ...
                                choppyitemfixclass_10.method2426(true, true, false, f_28, f_29, f_30, f_25, f_26, f_27, 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_22], -1637318410), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_23], -2083954388), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_24], -2043217255));
                            } else if (class183_20.aShortArray2270 != null && class183_20.aShortArray2270[i_21] != -1) {
                                i_31 = this.aGraphicalRenderer_Sub3_9353.method14362(class183_20.aShortArray2270[i_21]);
                                choppyitemfixclass_10.method2426(true, true, false, f_28, f_29, f_30, f_25, f_26, f_27, 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_22], -1565287282), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_23], -2091262596), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_24], -1960726262));
                            } else {
                                i_31 = class183_20.anIntArray2272[i_21];
                                choppyitemfixclass_10.method2426(true, true, false, f_28, f_29, f_30, f_25, f_26, f_27, 100.0F, 100.0F, 100.0F, (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_22], -1936732965), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_23], -1514344836), (float) Node_Sub20_Sub2.method15076(i_31, class183_20.aShortArray2274[s_24], -1852411858));
                            }
                        }
                    }
                }
                        ...
                        if (bool_33) {
                            ...
                            if (bool_37) {
                                ...
                                if (bool_36) {
                                    i_27 = ints_9[i_22];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_22] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 444597695) & 0xffff];
                                    }

                                    i_27 = ints_9[i_34];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_34] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 2037998587) & 0xffff];
                                    }

                                    i_27 = ints_9[i_24];
                                    if (i_27 != -1 && !this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).isGroundMesh) {
                                        class196_38.anIntArray2420[i_24] = Class335.anIntArray3916[Class372.method6362(this.aGraphicalRenderer_Sub3_9353.anInterface22_5834.method144(i_27).color & 0xffff, 818648524) & 0xffff];
                                    }
                                }
    ...
    public void method6710(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, boolean[][] bools_8) {
        Class185 class185_9 = this.aGraphicalRenderer_Sub3_9353.method14370(Thread.currentThread());
        ...
        this.aGraphicalRenderer_Sub3_9353.method14410();
    ...
    public void method6714(int i_1, int i_2, int[] ints_3, int[] ints_4, int[] ints_5, int[] ints_6, int[] ints_7, int[] ints_8, int[] ints_9, int[] ints_10, int[] ints_11, int[] ints_12, int[] ints_13, HDWaterTile class90_14, boolean bool_15) {
        ...
        if (!bool_16) {
            ...
            i_19 = ints_12[0];
            if (ints_11 != null) {
                class178_32.anInt2213 = Node_Sub20_Sub2.method15076(Class372.method6362(ints_11[0], 514771818), this.aByteArrayArray9355[i_1][i_2] - this.aByteArrayArray9356[i_1][i_2], -1389743133);
                if (i_18 == -1) {
                    class178_32.aByte2219 = (byte) (class178_32.aByte2219 | 0x2);
                }
            }
            ...
            if (class169_26 != null && (class178_32.aByte2219 & 0x2) == 0 && !class169_26.isGroundMesh) {
                ...
                class178_32.aShort2214 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1][i_2] - this.aByteArrayArray9356[i_1][i_2], -1603367966);
                class178_32.aShort2217 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1 + 1][i_2] - this.aByteArrayArray9356[i_1 + 1][i_2], -1346997242);
                class178_32.aShort2216 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1 + 1][i_2 + 1] - this.aByteArrayArray9356[i_1 + 1][i_2 + 1], -1355549005);
                class178_32.aShort2218 = (short) Node_Sub20_Sub2.method15076(s_31, this.aByteArrayArray9355[i_1][i_2 + 1] - this.aByteArrayArray9356[i_1][i_2 + 1], -1809366427);
                class178_32.aShort2215 = -1;
            }
                ...
                if (class183_48.aShortArray2270 != null) {
                    for (i_12 = 0; i_12 < class183_48.aShort2269; i_12++) {
                        ...
                        if ((f_16 - f_17) * (f_21 - f_20) - (f_19 - f_20) * (f_18 - f_17) > 0.0F) {
                            ...
                            if (s_53 != -1) {
                                ...
                                if (i_55 != -1) {
                                    choppyitemfixclass_3.method2426(true, true, false, f_19, f_20, f_21, f_16, f_17, f_18, floats_6[s_49], floats_6[s_50], floats_6[s_52], (float) Node_Sub20_Sub2.method15076(i_55, class183_48.aShortArray2274[s_49], -1496789581), (float) Node_Sub20_Sub2.method15076(i_55, class183_48.aShortArray2274[s_50], -1887497744), (float) Node_Sub20_Sub2.method15076(i_55, class183_48.aShortArray2274[s_52], -2145258045));
                                }
                            }
                        }
                    }
                    ...
                    for (i_12 = 0; i_12 < class183_48.aShort2269; i_12++) {
                        ...
                        if ((f_16 - f_17) * (f_21 - f_20) - (f_19 - f_20) * (f_18 - f_17) > 0.0F) {
                            ...
                            if (i_54 != -1) {
                                choppyitemfixclass_3.aBool1708 = f_16 < 0.0F || f_17 < 0.0F || f_18 < 0.0F || f_16 > (float) choppyitemfixclass_3.anInt1684 || f_17 > (float) choppyitemfixclass_3.anInt1684 || f_18 > (float) choppyitemfixclass_3.anInt1684;
                                choppyitemfixclass_3.method2426(true, true, false, f_19, f_20, f_21, f_16, f_17, f_18, floats_6[s_49], floats_6[s_50], floats_6[s_52], (float) Node_Sub20_Sub2.method15076(i_54, class183_48.aShortArray2274[s_49], -1918290292), (float) Node_Sub20_Sub2.method15076(i_54, class183_48.aShortArray2274[s_50], -1603828878), (float) Node_Sub20_Sub2.method15076(i_54, class183_48.aShortArray2274[s_52], -2059468671));
                            }
                        }
                    }
                }
    ...
    void method14638(int i_1, int i_2, int i_3) {
        Class185 class185_4 = this.aGraphicalRenderer_Sub3_9353.method14370(Thread.currentThread());
    ...
    Ground_Sub3(HardwareRenderer hardwarerenderer_1, int i_2, int i_3, int i_4, int i_5, int[][] ints_6, int[][] ints_7, int i_8) {
        super(i_4, i_5, i_8, ints_6);
        this.aGraphicalRenderer_Sub3_9353 = hardwarerenderer_1;
        this.anInt9345 = i_3;
        this.aByteArrayArray9355 = new byte[i_4 + 1][i_5 + 1];
        int i_9 = this.aGraphicalRenderer_Sub3_9353.anInt8992 >> 9;
        ...
        for (int i_10 = 1; i_10 < i_5; i_10++) {
            for (int i_11 = 1; i_11 < i_4; i_11++) {
                ...
                int i_12 = i_9 + (this.aGraphicalRenderer_Sub3_9353.anInt9011 * i_16 + this.aGraphicalRenderer_Sub3_9353.anInt8988 * i_17 + this.aGraphicalRenderer_Sub3_9353.anInt9007 * i_18 >> 17);
                i_12 >>= 1;
                if (i_12 < 2) {
                    i_12 = 2;
                } else if (i_12 > 126) {
