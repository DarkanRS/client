...
public class Transform_Sub1_Sub5_Sub1 extends Transform_Sub1_Sub5 implements SceneObject {
    ...
    public void method88(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -17);
        }

    }

    boolean method12986(int i_1) {
        return this.aMeshRasterizer_10513 == null || !this.aMeshRasterizer_10513.u();
    }
    ...
    Class452 method16101(GraphicalRenderer graphicalrenderer_1, int i_2, boolean bool_3, int i_4) {
        ...
        return objectdefinitions_5.method8010(graphicalrenderer_1, i_2, this.aByte10521, this.aByte10520, class390_6, class390_7, (int) vector3_8.x, (int) vector3_8.y, (int) vector3_8.z, bool_3, null, 1259203877);
    }
    ...
    public void method83(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -128);
        }
    ...
    public void method93(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -90);
        }
    ...
    public void method87(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_6 = this.method11166().coords;
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -39);
        }
    ...
    boolean method13000() {
        return this.aMeshRasterizer_10513 != null && this.aMeshRasterizer_10513.i();
    }
    ...
    public void method97(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) 23);
        }
    ...
    public void method98(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) 45);
        }
