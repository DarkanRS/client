...
public class Class52_Sub1 extends Class52 {
    ...
    static Class158_Sub2_Sub3 method14493(HardwareRenderer hardwarerenderer_0, Canvas canvas_1, int i_2, int i_3) {
    ...
    void method1081(boolean bool_1, int i_2, int i_3) {
        Renderers.SOFTWARE_RENDERER.method8430(i_2 - 2, i_3, aClass350_489.anInt4093 + 4, aClass350_489.anInt4088 + 2, ((Class350_Sub1) aClass350_489).anInt7755, 0);
    ...
    void method1077(int i_2, int i_3) {
        ...
        Renderers.SOFTWARE_RENDERER.r(i_2, i_3 + 2, i_5 + i_2, i_3 + aClass350_489.anInt4088);
    ...
    void method1080(int i_2, int i_3) {
        ...
        Renderers.SOFTWARE_RENDERER.r(i_2, i_3 + 2, i_4 + i_2, aClass350_489.anInt4088 * 1707725877 * 323608093 + i_3);
    ...
    void method1076(boolean bool_1, int i_2, int i_3) {
        Renderers.SOFTWARE_RENDERER.method8430(i_2 - 2, i_3, aClass350_489.anInt4093 * -229835439 * 329542577 + 4, aClass350_489.anInt4088 * 1707725877 * 323608093 + 2, 1505550823 * ((Class350_Sub1) aClass350_489).anInt7755 * 1943314903, 0);
        Renderers.SOFTWARE_RENDERER.method8430(i_2 - 1, 1 + i_3, 2 + 329542577 * aClass350_489.anInt4093 * -229835439, aClass350_489.anInt4088 * 1707725877 * 323608093, 0, 0);
    }
}
