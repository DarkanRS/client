...
public class Node_Sub20_Sub36 extends Node_Sub20 {
    ...
    int[][] method12320(int i_1, int i_2) {
        ...
        if (this.aClass308_7670.aBool3619) {
            ...
            for (int i_10 = 0; i_10 < Class316.anInt3670; i_10++) {
                ...
                int i_17 = (int) (Math.sqrt((float) (i_15 + i_16 + 4096) / 4096.0F) * 4096.0D);
                int i_18;
                int i_19;
                int i_20;
                if (i_17 != 0) {
    ...
    public static void method15418() {
        VorbisFileReference.method13449((byte) -118);
        ...
        Class42_Sub1.method14563(Node_Sub20_Sub10.method15262(null, 1928117026), (short) 11196);
    ...
    public static void method15420() {
        try {
            ...
            if (Class148.anInt1730 == 1) {
                i_1 = Class148.aNode_Sub15_Sub2_1735.method15123(-1985280884);
                if (i_1 > 0 && Class148.aNode_Sub15_Sub2_1735.method15103(1537744639)) {
            ...
            if (Class148.anInt1730 == 3) {
                i_1 = Class148.aNode_Sub15_Sub2_1735.method15123(-2016232970);
                if (i_1 < Class158_Sub2_Sub3.anInt10243 && Class148.aNode_Sub15_Sub2_1735.method15103(1772482571)) {
            ...
            Class148.aNode_Sub15_Sub2_1735.method15101((short) -2196);
