        ...
        if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048)) {
            ...
            if (Class393.preferences.characterShadows.method12966((byte) -110) == 1) {
                ...
                if (renderanimdefs_8.aBool2787 && (-977770149 * this.playerAppearance.anInt2928 * 232890067 == -1 || IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928 * 232890067 * -977770149).aBool4912)) {
                    ...
                    MeshRasterizer meshrasterizer_11 = SongReference.method1969(graphicalrenderer_1, i_5, -35614997 * this.anInt10322 * 2085530051, this.anInt10323 * 884618779 * -1768311789, -628205413 * this.anInt10363 * -1453470317, 1, this.aMeshRasterizerArray10372[0], 0, 0, 160, 240, class456_sub3_10 != null ? class456_sub3_10 : animation_9);
                ...
                for (i_18 = client.HINT_ARROWS.length - 1; i_18 >= 0; --i_18) {
                    ...
                    if (class180_25 != null && 1869984395 * class180_25.modelId * -669014749 != -1) {
                        ...
                        if (-379447335 * class180_25.targetType * -860161943 == 1) {
                            StringNode class282_sub47_26 = (StringNode) client.NPCS.get(1505135749 * class180_25.targetIndex * -1443656627);
                            if (class282_sub47_26 != null) {
                                ...
                                this.method16136(graphicalrenderer_1, matrix44var_2, this.aMeshRasterizerArray10372[0], i_13, i_14, 1869984395 * class180_25.modelId * -669014749, 92160000L);
                            }
                        }
                        ...
                        if (-379447335 * class180_25.targetType * -860161943 == 10 && 1505135749 * class180_25.targetIndex * -1443656627 >= 0 && 1505135749 * class180_25.targetIndex * -1443656627 < client.players.length) {
                            ...
                            if (player_28 != null) {
                                ...
                                this.method16136(graphicalrenderer_1, matrix44var_2, this.aMeshRasterizerArray10372[0], i_23, i_13, class180_25.modelId * -669014749 * 1869984395, 92160000L);
                            }
                        }
                    }
                }
        ...
        if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048)) {
            ...
            if (Class393.preferences.characterShadows.method12966((byte) -35) == 1) {
                ...
                if (renderanimdefs_9.aBool2787 && (this.playerAppearance.anInt2928 == -1 || IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928).aBool4912)) {
                    ...
                    MeshRasterizer meshrasterizer_12 = SongReference.method1969(graphicalrenderer_1, i_6, this.anInt10322, this.anInt10323, this.anInt10363, 1, this.aMeshRasterizerArray10372[0], 0, 0, 160, 240, class456_sub3_11 != null ? class456_sub3_11 : animation_10);
                    if (meshrasterizer_12 != null) {
                ...
                for (i_19 = client.HINT_ARROWS.length - 1; i_19 >= 0; --i_19) {
                    ...
                    if (class180_26 != null && class180_26.modelId != -1) {
                        ...
                        if (class180_26.targetType == 1) {
                            StringNode class282_sub47_27 = (StringNode) client.NPCS.get(class180_26.targetIndex);
                            if (class282_sub47_27 != null) {
                                ...
                                this.method16136(graphicalrenderer_1, matrix44var_3, this.aMeshRasterizerArray10372[0], i_14, i_15, class180_26.modelId, 92160000L);
                            }
                        }
                        ...
                        if (class180_26.targetType == 10 && class180_26.targetIndex >= 0 && class180_26.targetIndex < client.players.length) {
                            ...
                            if (player_29 != null) {
                                ...
                                this.method16136(graphicalrenderer_1, matrix44var_3, this.aMeshRasterizerArray10372[0], i_24, i_14, class180_26.modelId, 92160000L);
                            }
                        }
                    }
                }
