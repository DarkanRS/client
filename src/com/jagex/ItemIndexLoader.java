...
public class ItemIndexLoader implements IndexLoader {
    ...
    public ItemDefinitions getItemDefinitions(int i_1) {
        ...
        synchronized (this.cache) {
            itemdefinitions_3 = (ItemDefinitions) this.cache.get(i_1);
        }
        ...
        if (itemdefinitions_3 != null) {
            ...
            itemdefinitions_3.groundOptions = this.defaultGroundOptions.clone();
            itemdefinitions_3.inventoryOptions = this.defaultInventoryOptions.clone();
            if (bytes_12 != null) {
            ...
            synchronized (this.cache) {
                this.cache.put(itemdefinitions_3, i_1);
                return itemdefinitions_3;
            }
        }
    }
