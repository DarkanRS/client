...
public class RenderAnimIndexLoader {
    ...
    public BASDefinitions getBASDefs(int i_1, byte b_2) {
        ...
        synchronized (this.renderAnimCache) {
            renderanimdefs_3 = (BASDefinitions) this.renderAnimCache.get(i_1);
        }
        if (renderanimdefs_3 != null) {
            ...
            synchronized (this.renderAnimCache) {
                this.renderAnimCache.put(renderanimdefs_3, i_1);
                return renderanimdefs_3;
            }
        }
    }
    ...
    static final void method3629(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8) {
        if (!MovingAnimation.isInterfaceLoaded(i_0, null, -1707980188)) {
            if (i_7 != -1) {
            ...
            GroundDecoration.method16094(CustomCursorsPreference.INTERFACES[i_0].method1616(2127300382), -1, i_1, i_2, i_3, i_4, i_5, i_6, i_7, i_7 < 0);
        }
    }
