...
public class InventoriesIndexLoader implements IndexLoader {
    ...
    public ItemContainerDefinitions getInventoryDef(int i_1) {
        ...
        synchronized (this.cached) {
            inventorydef_3 = (ItemContainerDefinitions) this.cached.get(i_1);
        }
        if (inventorydef_3 != null) {
            ...
            synchronized (this.cached) {
                this.cached.put(inventorydef_3, i_1);
                return inventorydef_3;
            }
        }
    }

    static void renderAreaText(GraphicalRenderer graphicalrenderer_0, Node_Sub36 class282_sub36_1, MapAreaDefinitions worldmapareadefs_2, int i_3, int i_4, int i_5, int i_6, Class194 class194_7) {
        int i_9 = i_4 - i_6 / 2 - 5;
        int i_10 = i_5 + 2;
