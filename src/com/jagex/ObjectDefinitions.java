...
public class ObjectDefinitions {
    ...
    public int method7963(int i_1, int i_2, int i_3) {
        if (this.aClass465_5668 == null) {
            ...
            IntNode class282_sub38_4 = (IntNode) this.aClass465_5668.get(i_1);
        ...
        if (opcode == 1) {
            ...
            if (opcode == 78) {
                ...
                for (i_5 = 0; i_5 < i_4; i_5++) {
                    ...
                    this.aClass465_5668.put((Node) obj_8, i_7);
                }
            }
        } else {
    ...
    MeshRasterizer method7971(GraphicalRenderer class505, int i, int i_35_, int i_36_, Class476 class476, int i_37_) {
        int i_38_ = 64 + this.ambient;
        int i_39_ = 850 + this.contrast;
        int i_40_ = i;
        boolean bool = inverted || i_35_ == (SceneObjectType.WALL_WHOLE_CORNER.type) && i_36_ > 3;
        if (bool)
            i |= 0x10;
        if (0 == i_36_) {
            if (128 != this.scaleX || 0 != this.offsetX)
                i |= 0x1;
            if (128 != this.scaleZ || this.offsetZ != 0)
                i |= 0x4;
        } else
            i |= 0xd;
        if (this.scaleY != 128 || this.offsetY != 0)
            i |= 0x2;
        ...
        if (types != null) {
            ...
            if (-1 == i_41_)
                return null;
            int[] is = ((null != class476 && null != class476.anIntArray5626) ? class476.anIntArray5626 : modelIds[i_41_]);
            int i_43_ = is.length;
            if (i_43_ > 0) {
                long l = class505.rendererId;
                for (int i_44_ = 0; i_44_ < i_43_; i_44_++)
                    l = (long) is[i_44_] + 67783L * l;
                synchronized (this.loader.aClass229_5614) {
                    class528 = ((MeshRasterizer) this.loader.aClass229_5614.get(l));
                }
                if (null != class528) {
                    if (i_38_ != class528.c())
                        i |= 0x1000;
                ...
                if (class528 == null || class505.method8452(class528.m(), i) != 0) {
                    ...
                    synchronized (this.loader.aClass157Array5616) {
                        for (int i_46_ = 0; i_46_ < i_43_; i_46_++) {
                            synchronized (this.loader.meshIndex) {
                                class157 = RSMesh.decodeMesh((this.loader.meshIndex), is[i_46_]);
                            }
                            if (null == class157) {
                            ...
                            if (class157.version < 13)
                                class157.upscale();
                            if (i_43_ > 1)
                                this.loader.aClass157Array5616[i_46_] = class157;
                        }
                        if (i_43_ > 1)
                            class157 = new RSMesh((this.loader.aClass157Array5616), i_43_);
                    }
                    class528 = class505.createMeshRasterizer(class157, i_45_, (this.loader.anInt5617), i_38_, i_39_);
                    synchronized (this.loader.aClass229_5614) {
                        this.loader.aClass229_5614.put(class528, l);
                    }
                }
            }
        }
        ...
        if (null != this.originalColors) {
            ...
            if (class476 != null && class476.aShortArray5628 != null)
                ...
                is = modifiedColors;
            for (int i_49_ = 0; i_49_ < this.originalColors.length; i_49_++) {
                if (null != this.aByteArray5641 && i_49_ < this.aByteArray5641.length)
                    class528_48_.X(this.originalColors[i_49_], (aShortArray5691[(this.aByteArray5641[i_49_] & 0xff)]));
                else
                    class528_48_.X(this.originalColors[i_49_], is[i_49_]);
            }
        }
        if (null != this.originalTextures) {
            short[] is;
            if (class476 != null && null != class476.aShortArray5625)
                is = class476.aShortArray5625;
            else
                is = modifiedTextures;
            for (int i_50_ = 0; i_50_ < this.originalTextures.length; i_50_++)
                class528_48_.W(this.originalTextures[i_50_], is[i_50_]);
        }
        if (this.aByte5634 != 0)
            class528_48_.PA(this.aByte5644, this.aByte5642, this.aByte5646, this.aByte5634 & 0xff);
        if (this.scaleX != 128 || 128 != this.scaleY || 128 != this.scaleZ)
            class528_48_.oa(this.scaleX, this.scaleY, this.scaleZ);
        if (this.offsetX != 0 || this.offsetY != 0 || this.offsetZ != 0)
            class528_48_.ia(this.offsetX, this.offsetY, this.offsetZ);
    ...
    public String method7973(int i_1, String string_2) {
        if (this.aClass465_5668 == null) {
            ...
            StringNode class282_sub47_4 = (StringNode) this.aClass465_5668.get(i_1);
    ...
    public final synchronized Class452 method8010(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, Ground class390_5, Ground class390_6, int i_7, int i_8, int i_9, boolean bool_10, Class476 class476_11, int i_12) {
        ...
        long long_13 = (i_3 << 3) + i_4 + (this.id << 10);
