...
public class Class141_Sub2 extends Class141 {
	...
	void method2397(boolean bool_1) {
		...
		if (this.aBool9037 && class137_sub2_2 != null) {
			...
			this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass136_9042.aClass137_Sub4_1638);
			...
			OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_3, "sunDir"), -this.aGraphicalRenderer_Sub1_1664.aFloatArray8426[0], -this.aGraphicalRenderer_Sub1_1664.aFloatArray8426[1], -this.aGraphicalRenderer_Sub1_1664.aFloatArray8426[2]);
			OpenGL.glUniform4f(OpenGL.glGetUniformLocation(i_3, "sunColour"), this.aGraphicalRenderer_Sub1_1664.aFloat8429, this.aGraphicalRenderer_Sub1_1664.aFloat8430, this.aGraphicalRenderer_Sub1_1664.aFloat8431, 1.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_3, "sunExponent"), 96.0F + Math.abs(this.aGraphicalRenderer_Sub1_1664.aFloatArray8426[1]) * 928.0F);
			this.aBool9040 = true;
		}
	...
	Class141_Sub2(OpenGLGraphicalRenderer class505_sub1_1, Class136 class136_2) {
		...
		if (this.aClass136_9042.aClass137_Sub4_1638 != null && this.aGraphicalRenderer_Sub1_1664.aBool8485 && this.aGraphicalRenderer_Sub1_1664.aBool8365) {
			...
			this.aClass128_9041 = Class128.method2174(this.aGraphicalRenderer_Sub1_1664, new Class140[] { class140_3, class140_4 });
	...
	void method2399(int i_1, int i_2) {
		if (this.aBool9040) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7, "time"), (float) (this.aGraphicalRenderer_Sub1_1664.anInt8368 * i_3 % 40000) / 40000.0F);
	...
	void method2409(int i_1, int i_2) {
		if (this.aBool9040) {
			...
			float f_6 = (float) (i_2 >> 16 & 0x3) / 8.0F;
			int i_7 = this.aClass128_9041.anInt1583;
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7, "time"), (float) (i_3 * this.aGraphicalRenderer_Sub1_1664.anInt8368 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7, "scale"), f_4);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7, "breakWaterDepth"), (float) i_5);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7, "breakWaterOffset"), f_6);
		}
