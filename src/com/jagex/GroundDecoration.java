...
public class GroundDecoration extends SceneObjectNode implements SceneObject {
    ...
    boolean method12983(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
        ...
        return meshrasterizer_5 != null && meshrasterizer_5.method11270(i_2, i_3, this.method11168(), false, 0);
    }
    ...
    boolean method13020(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
        ...
        return meshrasterizer_4 != null && meshrasterizer_4.method11270(i_2, i_3, this.method11168(), false, 0);
    }
                ...
                if (!client.method11651(inter)) {
                    ...
                    if (i_17 < i_19 && i_18 < i_20) {
                        ...
                        if (inter.type == ComponentType.CONTAINER) {
                            ...
                            IFSubNode class282_sub44_33 = (IFSubNode) client.OPEN_INTERFACES.get(inter.idHash);
                                ...
                                if (inter.type == ComponentType.TEXT) {
                                    ...
                                    if (fontrenderer_43 == null) {
                                        ...
                                        if (inter.textAntiMacro) {
                                            fontrenderer_43.method367(string_35, drawX, drawY, inter.width, inter.height, 255 - (i_16 & 0xff) << 24 | i_22, inter.shadow ? 255 - (i_16 & 0xff) << 24 : -1, inter.textHorizontalAli, inter.textVerticalAli, client.aRandom7260, Class455_Sub3.anInt9079, client.anIntArray7438, Class182.aNativeSpriteArray2261, null, 1113506161);
                                        } else {
                                        ...
                                        if (inter.containerItemId != -1) {
                                            ...
                                            if (inter.modelType == ModelType.PLAYER_HEAD) {
                                                ...
                                                if (i_24 >= 0 && i_24 < 2048) {
                                                    player_37 = client.players[i_24];
                                                    if (player_37 != null && (i_24 == client.myPlayerIndex || Class272.stringToInt(player_37.displayName) == inter.anInt1339)) {
                                                        meshRasterizer = player_37.playerAppearance.method3998(Renderers.SOFTWARE_RENDERER, i_22, IndexLoaders.RENDER_ANIM_LOADER, IndexLoaders.IDENTIKIT_LOADER, IndexLoaders.NPC_INDEX_LOADER, IndexLoaders.ITEM_LOADER, IndexLoaders.ANIMATION_LOADER, Class158_Sub1.PLAYER_VAR_PROVIDER, inter.anim, null, null, null, 0, LinkedNodeList.EQUIPMENT_DEFAULTS, (short) -10357);
                                                    }
                                                }
                                                ...
                                                if (inter.anim != null && inter.anim.hasDefs()) {
                                                    ...
                                                    meshRasterizer = inter.method2002(Renderers.SOFTWARE_RENDERER, i_22, IndexLoaders.RENDER_ANIM_LOADER, IndexLoaders.IDENTIKIT_LOADER, IndexLoaders.NPC_INDEX_LOADER, IndexLoaders.ITEM_LOADER, IndexLoaders.ANIMATION_LOADER, Class158_Sub1.PLAYER_VAR_PROVIDER, null, VertexNormal.MY_PLAYER.playerAppearance);
                                                    if (meshRasterizer == null && IComponentDefinitions.aBool1399) {
                                                        Class109.redrawComponent(inter);
                                                    }
                                                }
