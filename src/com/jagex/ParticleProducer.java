...
public class ParticleProducer {
            ...
            if (this.current.centerX != i_29 || this.current.centerZ != i_8 || this.current.centerY != i_9 || !this.aBool7118) {
                ...
                while (true) {
                    if (this.anInt7108 <= 32767 && this.anInt7111 <= 32767 && this.anInt7112 <= 32767 && this.anInt7108 >= -32767 && this.anInt7111 >= -32767 && this.anInt7112 >= -32767) {
                        i_16 = (int) Math.sqrt(this.anInt7112 * this.anInt7112 + this.anInt7111 * this.anInt7111 + this.anInt7108 * this.anInt7108);
                        if (i_16 <= 0) {
                            i_16 = 1;
                        }
                        ...
                        if (this.definition.maximumAngleH > 0 || this.definition.maximumAngleV > 0) {
                            i_17 = (int) (Math.atan2(this.anInt7112, this.anInt7108) * 2607.5945876176133D);
                            i_18 = (int) (Math.atan2(this.anInt7111, Math.sqrt(this.anInt7108 * this.anInt7108 + this.anInt7112 * this.anInt7112)) * 2607.5945876176133D);
    ...
    ParticleProducer(GraphicalRenderer graphicalrenderer_1, ParticleEmitterConfig class87_2, ParticleSystem class539_3, long long_4) {
