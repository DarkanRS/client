...
public class Class141_Sub4 extends Class141 {
    ...
    void method2403(boolean bool_1) {
        ...
        this.aGraphicalRenderer_Sub1_1664.method13654(this.aClass137_Sub1_9071);
        this.aGraphicalRenderer_Sub1_1664.method13717(34165, 7681);
        this.aGraphicalRenderer_Sub1_1664.method13595(0, 34166, 768);
        this.aGraphicalRenderer_Sub1_1664.method13595(2, 5890, 770);
    ...
    void method14427() {
        Matrix44Arr matrix44arr_1 = this.aGraphicalRenderer_Sub1_1664.aClass384_8348;
        if (this.aBool9069) {
            OpenGL.glBindProgramARB(34336, this.aGraphicalRenderer_Sub1_1664.anInt8450 == Integer.MAX_VALUE ? this.aClass133_9067.anInt1596 : this.aClass133_9072.anInt1596);
        } else {
            OpenGL.glBindProgramARB(34336, this.aGraphicalRenderer_Sub1_1664.anInt8450 == Integer.MAX_VALUE ? this.aClass133_9075.anInt1596 : this.aClass133_9074.anInt1596);
        }

        float f_2 = (float) this.aGraphicalRenderer_Sub1_1664.anInt8450;
    ...
    void method14428() {
        if (this.aBool9068) {
            float f_1 = this.aGraphicalRenderer_Sub1_1664.aFloat8404;
            float f_2 = this.aGraphicalRenderer_Sub1_1664.aFloat8403;
            float f_3 = f_1 - (f_1 - f_2) * 0.125F;
            float f_4 = f_1 - (f_1 - f_2) * 0.25F;
            OpenGL.glProgramLocalParameter4fARB(34336, 0, f_4, f_3, 256.0F / (float) this.aGraphicalRenderer_Sub1_1664.aClass90_8423.scale, (float) this.aGraphicalRenderer_Sub1_1664.aClass90_8423.intensity / 255.0F);
            this.aGraphicalRenderer_Sub1_1664.method13610(1);
            this.aGraphicalRenderer_Sub1_1664.method13617(this.aGraphicalRenderer_Sub1_1664.aClass90_8423.color);
            this.aGraphicalRenderer_Sub1_1664.method13610(0);
        }
    ...
    void method2400(Class137 class137_1, int i_2) {
        if (class137_1 == null) {
            if (!this.aBool9073) {
                ...
                this.aGraphicalRenderer_Sub1_1664.method13612(1);
