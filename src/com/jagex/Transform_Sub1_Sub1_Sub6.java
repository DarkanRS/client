...
public class Transform_Sub1_Sub1_Sub6 extends Transform_Sub1_Sub1 implements SceneObject {
    ...
    boolean method12987(int i_1) {
        return this.aMeshRasterizer_10535 != null && this.aMeshRasterizer_10535.i();
    }
    ...
    Class452 method16117(GraphicalRenderer graphicalrenderer_1, int i_2, boolean bool_3) {
        ...
        return objectdefinitions_5.method8010(graphicalrenderer_1, i_2, this.aByte10539 != SceneObjectType.GROUND_INTERACT.type ? this.aByte10539 : SceneObjectType.SCENERY_INTERACT.type, SceneObjectType.GROUND_INTERACT.type == this.aByte10539 ? this.aByte10540 + 4 : this.aByte10540, class390_6, class390_7, (int) vector3_8.x, (int) vector3_8.y, (int) vector3_8.z, bool_3, null, -333836235);
    }
    ...
    public void method88(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -117);
        }
    }
    ...
    public void method93(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -21);
        }
    }
    ...
    public void method83(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -17);
        }
    }
    ...
    public void method97(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -47);
        }
    }
    ...
    public void method98(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) 98);
        }
    }

    boolean method12999() {
        return this.aMeshRasterizer_10535 == null || !this.aMeshRasterizer_10535.u();
    }
    ...
    public void method87(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_6 = this.method11166().coords;
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -9);
        }
    }
