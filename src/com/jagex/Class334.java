...
public class Class334 {
    ...
    boolean method5938(int i_1, int i_2, int i_3, int i_4) {
        ...
        if (!this.aBool3900) {
            ...
            this.anInt3897 = (int) Math.sqrt(i_5 * i_5 + i_6 * i_6 + i_7 * i_7);
            if (this.anInt3897 == 0) {
                this.anInt3897 = 1;
            }
        ...
        if (this.anInt3899 < 8) {
            ...
            this.anInt3911 = (int) (Math.asin((float) i_6 / 256.0F) * 2607.5945876176133D) & 0x3fff;
            this.anInt3896 = (int) (Math.atan2(i_5, -i_7) * 2607.5945876176133D) & 0x3fff;
            this.aNativeSprite_3910 = null;
            return true;
        }
    }
    ...
    void method5944(GraphicalRenderer graphicalrenderer_1, Class334 class334_2) {
        ...
        int i_8;
        if (this.anInt3911 != 0) {
            i_6 = Class382.SINE[this.anInt3911];
            i_7 = Class382.COSINE[this.anInt3911];
        ...
        if (this.anInt3896 != 0) {
            i_6 = Class382.SINE[this.anInt3896];
            i_7 = Class382.COSINE[this.anInt3896];
