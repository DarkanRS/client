...
public class SoftwareItemRender implements Interface18 {
    ...
    public boolean method132(Interface18 interface18_1) {
        if (!(interface18_1 instanceof SoftwareItemRender)) {
            ...
            return softwareitemrender_2.rendererId * 785163709 * 362003861 == this.rendererId * 785163709 * 362003861 && (-2122717931 * softwareitemrender_2.itemId * 412172861 == -2122717931 * this.itemId * 412172861 && (softwareitemrender_2.itemAmount * -1802585529 * 716754807 == 716754807 * this.itemAmount * -1802585529 && (this.outlineSize * -1113099245 * -1886226917 == -1886226917 * softwareitemrender_2.outlineSize * -1113099245 && (442868743 * softwareitemrender_2.shadowColor * -621770313 == this.shadowColor * -621770313 * 442868743 && (softwareitemrender_2.renderStack * -190647633 * -1317952433 == -1317952433 * this.renderStack * -190647633 && softwareitemrender_2.hasPlayerAppearance == this.hasPlayerAppearance)))));
        }
    }
    ...
    public boolean method131(Interface18 interface18_1) {
        if (!(interface18_1 instanceof SoftwareItemRender)) {
            ...
            SoftwareItemRender softwareitemrender_2 = (SoftwareItemRender) interface18_1;
            return softwareitemrender_2.rendererId == this.rendererId && (softwareitemrender_2.itemId == this.itemId && (softwareitemrender_2.itemAmount == this.itemAmount && (this.outlineSize == softwareitemrender_2.outlineSize && (softwareitemrender_2.shadowColor == this.shadowColor && (softwareitemrender_2.renderStack == this.renderStack && softwareitemrender_2.hasPlayerAppearance == this.hasPlayerAppearance)))));
        }
    }
