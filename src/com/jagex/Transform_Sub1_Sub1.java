...
public abstract class Transform_Sub1_Sub1 extends Transform_Sub1 {
    ...
    int method13024(Node_Sub24[] arr_1) {
        ...
        int i_9;
        label115:
        for (i_3 = this.aShort9458; i_3 <= this.localX; i_3++) {
            label113:
            for (i_4 = this.aShort9456; i_4 <= this.localY; i_4++) {
    ...
    int method13036(Node_Sub24[] arr_1) {
        ...
        int i_10;
        label115:
        for (i_4 = this.aShort9458; i_4 <= this.localX; i_4++) {
            label113:
            for (i_5 = this.aShort9456; i_5 <= this.localY; i_5++) {
