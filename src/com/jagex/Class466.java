...
public enum Class466 implements Identifiable {
    ...
    static void method7776() {
        TCPPacket tcpmessage_1 = Class271.createPacket(ClientProt.TRANSMITVAR_VERIFYID, client.GAME_CONNECTION_CONTEXT.isaac);
    ...
    public static void method7777() {
        if (client.gameState == 0 && !JS5CacheFile.method3360() && !Class85.method1466()) {
