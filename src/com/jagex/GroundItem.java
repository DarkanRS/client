...
public class GroundItem extends Transform_Sub1_Sub2 {
    ...
    boolean method12983(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
        ...
        MeshRasterizer meshrasterizer_6 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10423).method7084(graphicalrenderer_1, 131072, this.anInt10416, null, null, 0, 0, 0, 0);
        if (meshrasterizer_6 != null && meshrasterizer_6.method11270(i_2, i_3, matrix44var_5, true, 0)) {
            return true;
        } else {
            if (this.anInt10411 != -1) {
                meshrasterizer_6 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10411).method7084(graphicalrenderer_1, 131072, this.anInt10414, null, null, 0, 0, 0, 0);
                if (meshrasterizer_6 != null && meshrasterizer_6.method11270(i_2, i_3, matrix44var_5, true, 0)) {
                    return true;
                }
            }
            ...
            if (this.anInt10415 != -1) {
                meshrasterizer_6 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10415).method7084(graphicalrenderer_1, 131072, this.anInt10412, null, null, 0, 0, 0, 0);
    ...
    Class285 method13009(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class208_3 != null && class208_3.aTransform_Sub1_Sub1_2659.aBool9459) {
            i_5 = class208_3.aTransform_Sub1_Sub1_2659.method12995(21913800);
        }
        ...
        if (this.anInt10422 * -460947901 * 1327971947 == 0) {
            ...
            Ground class390_10 = this.aClass206_7970.aGroundArray2591[this.collisionPlane];
    ...
    int method12996() {
        ItemDefinitions itemdefinitions_2 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10423);
        int i_3 = itemdefinitions_2.pickSizeShift;
        ItemDefinitions itemdefinitions_4;
        if (this.anInt10411 != -1) {
            itemdefinitions_4 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10411);
        ...
        if (this.anInt10415 != -1) {
            itemdefinitions_4 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10415);
            if (itemdefinitions_4.pickSizeShift > i_3) {
                i_3 = itemdefinitions_4.pickSizeShift;
            }
        }
    ...
    Class285 method13010(GraphicalRenderer graphicalrenderer_1) {
        ...
        int i_5 = 0;
        if (class208_3 != null && class208_3.aTransform_Sub1_Sub1_2659.aBool9459) {
            i_5 = class208_3.aTransform_Sub1_Sub1_2659.method12995(-2077263748);
        }
    ...
    Class285 method12989(GraphicalRenderer graphicalrenderer_1) {
        ...
        int i_5 = 0;
        if (class208_3 != null && class208_3.aTransform_Sub1_Sub1_2659.aBool9459) {
            i_5 = class208_3.aTransform_Sub1_Sub1_2659.method12995(-1830209037);
        }
    ...
    boolean method13020(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
        ...
        MeshRasterizer meshrasterizer_5 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10423 * -1511570479 * -876219087).method7084(graphicalrenderer_1, 131072, this.anInt10416 * 1423185937 * 513267953, null, null, 0, 0, 0, 0);
        if (meshrasterizer_5 != null && meshrasterizer_5.method11270(i_2, i_3, matrix44var_4, true, 0)) {
            return true;
        } else {
            if (this.anInt10411 * -1841858001 * 313920719 != -1) {
                meshrasterizer_5 = IndexLoaders.ITEM_LOADER.getItemDefinitions(313920719 * this.anInt10411 * -1841858001).method7084(graphicalrenderer_1, 131072, 1089437631 * this.anInt10414 * 1305767999, null, null, 0, 0, 0, 0);
                if (meshrasterizer_5 != null && meshrasterizer_5.method11270(i_2, i_3, matrix44var_4, true, 0)) {
                    return true;
                }
            }
            ...
            if (this.anInt10415 * 100349465 * -503986647 != -1) {
                meshrasterizer_5 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10415 * 100349465 * -503986647).method7084(graphicalrenderer_1, 131072, this.anInt10412 * -1052106625 * -931815553, null, null, 0, 0, 0, 0);
    ...
    Class285 method12990(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class208_4 != null && class208_4.aTransform_Sub1_Sub1_2659.aBool9459) {
            i_6 = class208_4.aTransform_Sub1_Sub1_2659.method12995(-1954899292);
        }
        ...
        if (this.anInt10422 == 0) {
            ...
            Ground class390_11 = this.aClass206_7970.aGroundArray2591[this.collisionPlane];
        ...
        if (this.anInt10415 != -1) {
            meshrasterizer_33 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10415).method7084(graphicalrenderer_1, 526336, this.anInt10412, null, null, this.anInt10420, this.anInt10421, this.anInt10413, this.anInt10417);
        ...
        if (this.anInt10411 != -1) {
            meshrasterizer_33 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10411).method7084(graphicalrenderer_1, 526336, this.anInt10414, null, null, this.anInt10420, this.anInt10421, this.anInt10413, this.anInt10417);
            if (meshrasterizer_33 != null) {
        ...
        meshrasterizer_33 = IndexLoaders.ITEM_LOADER.getItemDefinitions(this.anInt10423).method7084(graphicalrenderer_1, 526336, this.anInt10416, null, null, this.anInt10420, this.anInt10421, this.anInt10413, this.anInt10417);
        if (meshrasterizer_33 != null) {
