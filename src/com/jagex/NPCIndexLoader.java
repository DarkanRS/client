...
public class NPCIndexLoader {
    ...
    LRUCache aClass229_4843 = new LRUCache(5);
    ...
    public NPCType getNPCType(int i_1) {
        LRUCache softcache_4 = aClass229_4841;
        NPCType npcdefinitions_3;
        synchronized (aClass229_4841) {
            npcdefinitions_3 = (NPCType) aClass229_4841.get(i_1);
        }
    ...
    public void method6829(int i_1) {
        ...
        softcache_3 = aClass229_4843;
        synchronized (aClass229_4843) {
            aClass229_4843.method3859();
        }
    }
