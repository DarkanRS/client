...
public class ObjectNode extends Node<Object> {
    ...
    static void method13409(AbstractRenderer graphicalrenderer_0) {
        graphicalrenderer_0.r(0, 0, Class349.BASE_WINDOW_WIDTH, 350);
        graphicalrenderer_0.B(0, 0, Class349.BASE_WINDOW_WIDTH, 350, Class179.anInt2221 << 24 | 0x332277, 1);
        ...
        if (Class179.anInt2227 > 0) {
            ...
            graphicalrenderer_0.B(Class349.BASE_WINDOW_WIDTH - 16, i_5, 12, i_4, Class179.anInt2221 << 24 | 0x332277, 2);
            for (int i_6 = Class179.anInt2223; i_6 < i_2 + Class179.anInt2223 && i_6 < Class179.anInt2227; i_6++) {
                ...
                int i_8 = (Class349.BASE_WINDOW_WIDTH - 8 - 16) / arr_7.length;
        ...
        Renderers.FONT_RENDERER.drawText("727 1", Class349.BASE_WINDOW_WIDTH - 25, 330, -1, -16777216);
        graphicalrenderer_0.r(0, 0, Class349.BASE_WINDOW_WIDTH, 350);
        graphicalrenderer_0.method8659(0, 350 - Class179.anInt2230, Class349.BASE_WINDOW_WIDTH, -1);
