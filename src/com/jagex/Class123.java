...
public class Class123 {
	...
	void method2119(GraphicalRenderer graphicalrenderer_1, MeshRasterizer meshrasterizer_2, Matrix44Var matrix44var_3, int i_4, int i_5, int i_6, int i_7, boolean bool_8, int i_9) {
		...
		if ((this.aClass539_1538 == null || this.aClass539_1538.aBool7132) && (arr_10 != null || arr_11 != null)) {
			...
			if (objectdefinitions_12.transformTo != null) {
				objectdefinitions_12 = objectdefinitions_12.getTransformed((VarProvider) (client.anInt7341 == 4 ? Class86.anInterface42_832 : Class158_Sub1.PLAYER_VAR_PROVIDER));
			}
	...
	void method2124(boolean bool_1, int i_2, int i_3) {
		...
		if (i_2 == -1) {
			...
			if (objectdefinitions_7.transformTo != null) {
				objectdefinitions_7 = objectdefinitions_7.getTransformed((VarProvider) (client.anInt7341 == 4 ? Class86.anInterface42_832 : Class158_Sub1.PLAYER_VAR_PROVIDER));
			}
	...
	final MeshRasterizer method2132(GraphicalRenderer graphicalrenderer_1, int i_2, boolean bool_3, boolean bool_4) {
		...
		if (objectdefinitions_6.transformTo != null) {
			objectdefinitions_6 = objectdefinitions_6.getTransformed((VarProvider) (client.anInt7341 == 4 ? Class86.anInterface42_832 : Class158_Sub1.PLAYER_VAR_PROVIDER));
		}
