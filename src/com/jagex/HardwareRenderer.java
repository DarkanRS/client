...
public class HardwareRenderer extends GraphicalRenderer {
    ...
    int[] method14359(int i) {
        ...
        synchronized (this.aClass229_9006) {
            class282_sub27 = ((Node_Sub27) this.aClass229_9006.get((long) i | ~0x7fffffffffffffffL));
            if (class282_sub27 == null) {
                ...
                int i_29_ = (class169.isHalfSize || this.aBool8997 ? 64 : this.anInt9005);
                class282_sub27 = (new Node_Sub27(i, i_29_, anInterface22_5834.method141(i, i_29_, i_29_, true, 1334254083), 1 != class169.blendType));
                this.aClass229_9006.put(class282_sub27, (long) i | ~0x7fffffffffffffffL);
            }
        }
    ...
    void method14371(boolean bool_1, boolean bool_2, PointEntity class275_sub1_sub1_4, int i_5, int i_6, float f_7, int i_8) {
        ...
        if (i_9 == -1) {
            ...
            if (i_9 != this.anInt9015) {
                NativeSprite nativesprite_11 = (NativeSprite) this.aClass229_9013.get(i_9);
                if (nativesprite_11 == null) {
                    ...
                    this.aClass229_9013.put(nativesprite_11, i_9);
                }
        ...
        if (i_7 != 0 && i_8 != 0) {
            if (i_9 != 65535) {
                ...
                if (!class169_13.isGroundMesh) {
                    if (i_9 != this.anInt9015) {
                        NativeSprite nativesprite_14 = (NativeSprite) this.aClass229_9013.get(i_9);
                        if (nativesprite_14 == null) {
                            ...
                            this.aClass229_9013.put(nativesprite_14, i_9);
                        }
