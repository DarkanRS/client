...
public class Transform_Sub1_Sub4_Sub1 extends Transform_Sub1_Sub4 implements SceneObject {
    ...
    boolean method12986(int i_1) {
        return this.aMeshRasterizer_10483 == null || !this.aMeshRasterizer_10483.u();
    }

    boolean method12987(int i_1) {
        return this.aMeshRasterizer_10483 != null && this.aMeshRasterizer_10483.i();
    }
    ...
    Class452 method16069(GraphicalRenderer graphicalrenderer_1, int i_2, boolean bool_3, int i_4) {
        ...
        return objectdefinitions_5.method8010(graphicalrenderer_1, i_2, this.aByte10485, this.aByte10487, class390_6, class390_7, (int) vector3_8.x, (int) vector3_8.y, (int) vector3_8.z, bool_3, null, 921813682);
    }
    ...
    Class285 method12990(GraphicalRenderer graphicalrenderer_1) {
        if (this.aMeshRasterizer_10483 == null) {
            ...
            matrix44var_3.method5219(this.aShort9611, 0.0F, this.aShort9612);
    ...
    Class285 method12989(GraphicalRenderer graphicalrenderer_1) {
        if (this.aMeshRasterizer_10483 == null) {
            ...
            matrix44var_2.method5219(this.aShort9611, 0.0F, this.aShort9612);
    ...
    public void method87(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -33);
        }
    ...
    public void method88(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_6 = this.method11166().coords;
        if (class282_sub50_sub17_4 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_4, this.collisionPlane, (int) vector3_6.x, (int) vector3_6.z, null, (byte) -18);
        }
    ...
    public void method93(GraphicalRenderer graphicalrenderer_1) {
        ...
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -19);
        }
    ...
    public void method83(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3426(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -64);
        }
    ...
    public void method97(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) 44);
        }
    ...
    public void method98(GraphicalRenderer graphicalrenderer_1) {
        ...
        Vector3 vector3_5 = this.method11166().coords;
        if (class282_sub50_sub17_3 != null) {
            this.aClass206_7970.method3427(class282_sub50_sub17_3, this.collisionPlane, (int) vector3_5.x, (int) vector3_5.z, null, (byte) -74);
        }
                ...
                if (i_8 != -1 && i_9 != -1) {
                    if (client.aBool7344 && (Class506.USE_OPTIONS_FLAGS & 0x40) != 0) {
                        ...
                        if (icomponentdefinitions_30 != null) {
                            PlayerAppearance.method4032(client.aString7275, " " + "->" + " ", Defaults8Loader.anInt5932, 59, -1, 0L, i_8, i_9, true, false, i_8 << 32 | i_9, true, -1546030291);
                        } else {
                            Class60.method1170();
                        }
                    } else {
                        if (CutsceneAction_Sub6.SHOW_FACE_HERE) {
                            PlayerAppearance.method4032(Message.FACE_HERE.translate(Class223.CURRENT_LANGUAGE), "", -1, 60, -1, 0L, i_8, i_9, true, false, i_8 << 32 | i_9, true, -1333249112);
                        }

                        PlayerAppearance.method4032(Class85.aString817, "", client.anInt7311, 23, -1, 0L, i_8, i_9, true, false, i_8 << 32 | i_9, true, -1883599124);
                    }
                }
            }
            ...
            while (true) {
                    ...
                    do {
                        do {
                                ...
                                while (true) {
                                    ...
                                    while (true) {
                                        ...
                                        if ((i_49 & 0x1) == 0 && ((int) vector3_36.x & 0x1ff) == 0 && ((int) vector3_36.z & 0x1ff) == 0 || (i_49 & 0x1) == 1 && ((int) vector3_36.x & 0x1ff) == 256 && ((int) vector3_36.z & 0x1ff) == 256) {
                                            ...
                                            for (i_51 = 0; i_51 < client.NPC_UPDATE_INDEX; i_51++) {
                                                StringNode class282_sub47_24 = (StringNode) client.NPCS.get(client.NPC_UPDATE_INDICES[i_51]);
                                    ...
                                    if ((npc_59.definitions.size & 0x1) == 0 && ((int) vector3_56.x & 0x1ff) == 0 && ((int) vector3_56.z & 0x1ff) == 0 || (npc_59.definitions.size & 0x1) == 1 && ((int) vector3_56.x & 0x1ff) == 256 && ((int) vector3_56.z & 0x1ff) == 256) {
                                        ...
                                        for (i_22 = 0; i_22 < client.NPC_UPDATE_INDEX; i_22++) {
                                            StringNode class282_sub47_37 = (StringNode) client.NPCS.get(client.NPC_UPDATE_INDICES[i_22]);
                                        ...
                                        for (GroundItemNode class282_sub34_39 = (GroundItemNode) class282_sub29_61.aClass482_7708.method8065(-2081006953); class282_sub34_39 != null; i_21++) {
                                            ...
                                            if (client.aBool7344 && class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
                                                ...
                                                if ((Class506.USE_OPTIONS_FLAGS & 0x1) != 0 && (attributedefault_68 == null || itemdefinitions_65.getCS2Integer(CutsceneAction_Sub12.USE_INTERFACE_ID, attributedefault_68.defaultInt) != attributedefault_68.defaultInt)) {
                                                    PlayerAppearance.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Utils.rgbToColHexShortcut(i_38) + itemdefinitions_65.name, Defaults8Loader.anInt5932, 17, -1, class282_sub34_39.id, i_46, i_47, true, false, i_21, false, -1634636602);
                                                }
                                            }
                                            ...
                                            if (class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
                                                ...
                                                for (i_42 = arr_69.length - 1; i_42 >= 0; --i_42) {
                                                    if (arr_69[i_42] != null) {
                                                        ...
                                                        PlayerAppearance.method4032(arr_69[i_42], Utils.rgbToColHexShortcut(i_38) + itemdefinitions_65.name, i_28, s_70, -1, class282_sub34_39.id, i_46, i_47, true, false, i_21, false, -1528903882);
                                                    }
                                                }
                                            }
                            ...
                            if (objectdefinitions_57.transformTo != null) {
                                objectdefinitions_57 = objectdefinitions_57.getTransformed(Class158_Sub1.PLAYER_VAR_PROVIDER);
                            }
                        ...
                        if (client.aBool7344 && class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
                            ...
                            if ((Class506.USE_OPTIONS_FLAGS & 0x4) != 0 && (attributedefault_62 == null || objectdefinitions_57.method7963(CutsceneAction_Sub12.USE_INTERFACE_ID, attributedefault_62.defaultInt, -2052450472) != attributedefault_62.defaultInt)) {
                                PlayerAppearance.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Utils.rgbToColHexShortcut(65535) + objectdefinitions_57.name, Defaults8Loader.anInt5932, 2, -1, Class329.method5905(sceneobject_60, i_46, i_47, (byte) -79), i_46, i_47, true, false, sceneobject_60.hashCode(), false, -2015227666);
                            }
                        }
                ...
                for (i_21 = arr_63.length - 1; i_21 >= 0; --i_21) {
                    if (arr_63[i_21] != null) {
                        ...
                        PlayerAppearance.method4032(arr_63[i_21], Utils.rgbToColHexShortcut(65535) + objectdefinitions_57.name, i_51, s_52, -1, Class329.method5905(sceneobject_60, i_46, i_47, (byte) -98), i_46, i_47, true, false, sceneobject_60.hashCode(), false, -1344607256);
                    }
                }
            }
        }
