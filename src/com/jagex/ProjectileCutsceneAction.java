...
public class ProjectileCutsceneAction extends CutsceneAction {
    ...
    public void method1592() {
        ...
        int i_7 = anInt9399 << 2;
        ProjectileAnimation class521_sub1_sub1_sub3_12 = new ProjectileAnimation(IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(), anInt9410, i_4, i_4, i_2, i_3, anInt9405 << 2, client.cycles, anInt9409 + client.cycles, anInt9412, i_7, anInt9402 + 1, anInt9400 + 1, anInt9413 << 2, false, 0);
        class521_sub1_sub1_sub3_12.start(i_5, i_6, anInt9413 << 2, anInt9409 + client.cycles);
    ...
    public void method1601() {
        ...
        ProjectileAnimation class521_sub1_sub1_sub3_11 = new ProjectileAnimation(IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(), anInt9410 * 2035189521 * 899631601, i_3, i_3, i_1, i_2, anInt9405 * 2127134041 * -1118504215 << 2, client.cycles * 1968179203 * -1809259861, -1809259861 * client.cycles * 1968179203 + anInt9409 * -229470439 * -511484631, anInt9412 * -1446164009 * 1829419495, i_6, 1 + anInt9402 * -37939787 * -772738915, anInt9400 * 857868507 * 1060287315 + 1, -209777139 * anInt9413 * 885452997 << 2, false, 0);
        class521_sub1_sub1_sub3_11.start(i_4, i_5, -209777139 * anInt9413 * 885452997 << 2, -511484631 * anInt9409 * -229470439 + client.cycles * 1968179203 * -1809259861);
