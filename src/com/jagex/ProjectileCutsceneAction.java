...
public class ProjectileCutsceneAction extends CutsceneAction {
	...
	public void method1592() {
		...
		if (this.anInt9403 >= 0) {
			...
			Entity animable_9 = Class82.CUTSCENE_ENTITIES[this.anInt9402].method1342((byte) 70);
		...
		if (this.anInt9404 >= 0) {
			...
			Entity animable_11 = Class82.CUTSCENE_ENTITIES[this.anInt9400].method1342((byte) 21);
		...
		Projectile class521_sub1_sub1_sub3_12 = new Projectile(IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(), this.anInt9410, i_4, i_4, i_2, i_3, this.anInt9405 << 2, client.cycles, this.anInt9409 + client.cycles, this.anInt9412, i_7, this.anInt9402 + 1, this.anInt9400 + 1, this.anInt9413 << 2, false, 0);
		class521_sub1_sub1_sub3_12.start(i_5, i_6, this.anInt9413 << 2, this.anInt9409 + client.cycles);
	...
	public void method1601() {
		...
		if (this.anInt9403 * -895580983 * 1708709241 >= 0) {
			...
			Entity animable_8 = Class82.CUTSCENE_ENTITIES[-772738915 * this.anInt9402 * -37939787].method1342((byte) 45);
		...
		if (this.anInt9404 * -943784947 * -316427579 >= 0) {
			...
			Entity animable_10 = Class82.CUTSCENE_ENTITIES[this.anInt9400 * 857868507 * 1060287315].method1342((byte) 42);
		...
		Projectile class521_sub1_sub1_sub3_11 = new Projectile(IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(), this.anInt9410 * 2035189521 * 899631601, i_3, i_3, i_1, i_2, this.anInt9405 * 2127134041 * -1118504215 << 2, client.cycles * 1968179203 * -1809259861, -1809259861 * client.cycles * 1968179203 + this.anInt9409 * -229470439 * -511484631, this.anInt9412 * -1446164009 * 1829419495, i_6, 1 + this.anInt9402 * -37939787 * -772738915, this.anInt9400 * 857868507 * 1060287315 + 1, -209777139 * this.anInt9413 * 885452997 << 2, false, 0);
		class521_sub1_sub1_sub3_11.start(i_4, i_5, -209777139 * this.anInt9413 * 885452997 << 2, -511484631 * this.anInt9409 * -229470439 + client.cycles * 1968179203 * -1809259861);
		client.PROJECTILES.append(new ProjectileNode(class521_sub1_sub1_sub3_11));
	}

	boolean method1599() {
		SpotAnimDefinitions spotanimdefinitions_2 = IndexLoaders.SPOT_ANIM_LOADER.getSpotAnimDefs(this.anInt9410, (byte) 46);
		boolean bool_3 = spotanimdefinitions_2.method11230(-583697397);
		AnimationDefinitions animationdefinitions_4 = IndexLoaders.ANIMATION_LOADER.getAnimDefs(spotanimdefinitions_2.animationId, (byte) 7);
