...
public abstract class Entity extends Transform_Sub1_Sub1 {
    ...
    void method15799(GraphicalRenderer graphicalrenderer_1, MeshRasterizer[] arr_2, Matrix44Var matrix44var_3, boolean bool_4, byte b_5) {
        if (!bool_4) {
            ...
            if (this.aClass539_10369 != null) {
                ...
                this.aClass539_10369.method11511(graphicalrenderer_1, client.cycles, arr_15, arr_17);
                this.aBool10370 = true;
            }
        } else if (this.aClass539_10369 != null) {
            this.aClass539_10369.method11512(client.cycles);
        }
    ...
    boolean initInterface(int i_1) {
        if (this.loadedInterfaceId == i_1) {
            ...
            this.inter = SkyboxIndexLoader.getInterface(i_1, null, null, true, (byte) -56);
            if (this.inter == null) {
                return false;
            } else {
    ...
    void method15895(int i_1, int i_2, int i_3, int i_4, int i_5) {
        ...
        this.anInt10322 = (int) (Math.atan2(i_32 - i_33, i_3) * 2607.5945876176133D) & 0x3fff;
        this.anInt10323 = (int) (Math.atan2(i_35 - i_34, i_2) * 2607.5945876176133D) & 0x3fff;
        int i_36;
    ...
    boolean initInterface() {
        return this.interfaceIdToLoad != -1 && this.initInterface(this.interfaceIdToLoad);
    }
