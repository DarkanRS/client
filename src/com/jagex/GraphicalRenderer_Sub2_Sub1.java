...
public final class GraphicalRenderer_Sub2_Sub1 extends GraphicalRenderer_Sub2 {
    ...
    GraphicalRenderer_Sub2_Sub1(OpenGL opengl_1, Canvas canvas_2, long long_3, Interface22 interface22_5, Index index_6, int i_7) {
                ...
                if (arr_10.length >= 2) {
                    ...
                    if (this.anInt10196 < 12) {
                        ...
                        if (this.anInt8825 < 2) {
                            ...
                            this.method8411(canvas_2, new Class158_Sub2_Sub2_Sub1(this, canvas_2, long_3));
                            this.method8412(canvas_2);
    ...
    Interface6 method14145(Class150 class150_1, int i_2, int i_3, boolean bool_4, float[] floats_5, int i_6, int i_7) {
        if (!this.aBool10197 && (!CutsceneAction_Sub9.method14585(i_2) || !CutsceneAction_Sub9.method14585(i_3))) {
            if (this.aBool10194) {
    ...
    void method13953() {
        ...
        for (i_1 = 0; i_1 < this.anInt8773; i_1++) {
            ...
            this.aFloatArray10172[1] = (float) class282_sub24_2.method12369();
            ...
            OpenGL.glLightf(i_4, 4617, 1.0F / (float) (class282_sub24_2.method12370() * class282_sub24_2.method12370()));
            OpenGL.glEnable(i_4);
        }
    ...
    Interface29 method14064(Class150 class150_1, Class76 class76_2, int i_3, int i_4) {
        return !this.aBool10197 && (!CutsceneAction_Sub9.method14585(i_3) || !CutsceneAction_Sub9.method14585(i_4)) ? (this.aBool10194 ? new Class319_Sub3(this, class150_1, class76_2, i_3, i_4) : new Class319_Sub2(this, class150_1, class76_2, Utils.nextPowerOfTwo(i_3), Utils.nextPowerOfTwo(i_4))) : new Class319_Sub2(this, class150_1, class76_2, i_3, i_4);
    }
    ...
    public final synchronized void method8398(int i_1) {
        ...
        Node node_5;
        while (!this.aClass473_10178.method7861()) {
            node_5 = this.aClass473_10178.popTail();
            OpenGL.glDeleteProgram((int) node_5.data);
        }

        while (!this.aClass473_10179.method7861()) {
    ...
    Interface6 method14008(int i_1, int i_2, boolean bool_3, int[] ints_4, int i_5, int i_6) {
        if (!this.aBool10197 && (!CutsceneAction_Sub9.method14585(i_1) || !CutsceneAction_Sub9.method14585(i_2))) {
            if (this.aBool10194) {
