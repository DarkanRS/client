...
public class ObjectIndexLoader {
    ...
    public ObjectDefinitions getObjectDefinitions(int i_1) {
        ...
        synchronized (this.softCache) {
            objectdefinitions_3 = (ObjectDefinitions) this.softCache.get(i_1);
        }
        if (objectdefinitions_3 != null) {
            ...
            objectdefinitions_3.options = this.defaultOptions.clone();
            if (bytes_9 != null) {
            ...
            synchronized (this.softCache) {
                this.softCache.put(objectdefinitions_3, i_1);
                return objectdefinitions_3;
            }
        }
    }
    ...
    public void method7895(byte b_1) {
        ...
        this.aClass452_5620 = new Class452(null, null);
    }
