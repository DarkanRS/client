    ...
    final MeshRasterizer method12429(GraphicalRenderer graphicalrenderer_1, int i_2, Animation animation_3, int i_4, boolean female, PlayerAppearance playerappearance_6) {
        ...
        if (meshrasterizer_8 == null || graphicalrenderer_1.method8452(meshrasterizer_8.m(), i_9) != 0) {
            ...
            for (int i_16 = 0; i_16 < ints_11.length; i_16++) {
                if (ints_11[i_16] != -1 && !IndexLoaders.ITEM_LOADER.getItemDefinitions(ints_11[i_16]).bodyMeshesReady(female, null, -763899504)) {
                    bool_15 = true;
                }
            }
            ...
            for (i_17 = 0; i_17 < ints_11.length; i_17++) {
                if (ints_11[i_17] != -1) {
                    arr_27[i_17] = IndexLoaders.ITEM_LOADER.getItemDefinitions(ints_11[i_17]).getBodyMesh(female, null, 2085001887);
                }
            }
