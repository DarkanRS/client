...
public class Class201 {
    ...
    public void method3262(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
        if (i_1 != 8 && i_1 != 16) {
            ...
            if (i_1 == 8) {
                ...
                i_11 = this.aClass206_2546.aGroundArray2607[i_2].getHeight(i_3, i_4);
                i_12 = this.aClass206_2546.aGroundArray2607[i_2].getHeight(i_3 + 1, i_4 + 1);
                ...
                i_9 = i_4 << this.aClass206_2546.anInt2592;
                i_10 = this.aClass206_2546.anInt2593 + i_9;
                i_11 = this.aClass206_2546.aGroundArray2607[i_2].getHeight(i_3 + 1, i_4);
                i_12 = this.aClass206_2546.aGroundArray2607[i_2].getHeight(i_3, i_4 + 1);
                this.aClass231Array2557[this.anInt2556++] = new Class231(this.aClass206_2546, i_1, i_2, i_13, i_8, i_8, i_13, i_11, i_12, i_12 - i_5, i_11 - i_5, i_9, i_10, i_10, i_9);
            }
        }
        ...
        if (this.aBool2552 && this.aBool2542) {
            if (this.aClass205_2547.anInt2588 < 102) {
                ...
                if (i_4 == -this.aClass206_2546.anInt2609) {
                    ...
                    if (this.method3277(i_5 + 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2, i_3), i_6 + 1, this.aClass206_2546.anInt2593 + i_5 - 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2 + 1, i_3 + 1), this.aClass206_2546.anInt2593 + i_6 - 1, i_5 + 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2, i_3 + 1), this.aClass206_2546.anInt2593 + i_6 - 1) && this.method3277(i_5 + 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2, i_3), i_6 + 1, this.aClass206_2546.anInt2593 + i_5 - 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2 + 1, i_3), i_6 + 1, this.aClass206_2546.anInt2593 + i_5 - 1, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2 + 1, i_3 + 1), this.aClass206_2546.anInt2593 + i_6 - 1)) {
    ...
    boolean method3273(int i_1, int i_2, int i_3, int i_4) {
        if (this.aBool2552 && this.aBool2542) {
            if (this.aClass205_2547.anInt2588 < 102) {
                ...
                int i_5 = i_2 << this.aClass206_2546.anInt2592;
                int i_6 = i_3 << this.aClass206_2546.anInt2592;
                return this.method3276(i_5, this.aClass206_2546.aGroundArray2591[i_1].getHeight(i_2, i_3), i_6, this.aClass206_2546.anInt2593, i_4, this.aClass206_2546.anInt2593);
            }
        } else {
            return false;
        }
    ...
    boolean method3274(int i_1, int i_2, int i_3, int i_4, int i_5, Class200 class200_6) {
        if (this.aBool2552 && this.aBool2542) {
            if (this.aClass205_2547.anInt2588 < 102) {
                ...
                return this.method3271(i_1, i_2, i_4) && this.method3299(class200_6);
            } else {
                ...
                return this.method3299(class200_6);
            }
        } else {
            return false;
        }
    ...
    final boolean method3276(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
        ...
        if (!this.method3277(i_1, i_8, i_3, i_7, i_8, i_9, i_1, i_8, i_9)) {
            ...
            if (i_3 < this.aClass206_2546.anInt2650) {
                ...
                return this.method3277(i_1, i_2, i_3, i_7, i_2, i_3, i_7, i_8, i_3);
            } else {
                if (!this.method3277(i_1, i_2, i_9, i_7, i_8, i_9, i_1, i_8, i_9)) {
                    return false;
                }

                return this.method3277(i_1, i_2, i_9, i_7, i_2, i_9, i_7, i_8, i_9);
            }
        }
    }
    ...
    final boolean method3299(Class200 class200_1) {
        return class200_1 != null && this.method3276(class200_1.anInt2535, class200_1.anInt2537, class200_1.anInt2539, class200_1.anInt2536 - class200_1.anInt2535, class200_1.anInt2538 - class200_1.anInt2537, class200_1.anInt2531 - class200_1.anInt2539);
    }
    ...
    Class201(SceneObjectManager sceneobjectmanager_1) {
        ...
        this.aBool2552 = !(this.aClass206_2546.aGraphicalRenderer_2596 instanceof ja);
                ...
                for (i_3 = 0; i_3 < this.aClass206_2546.sizeY; i_3++) {
                    ...
                    if (class293_4 != null) {
                        ...
                        if (class293_4.aShort3508 < 0) {
                            ...
                            for (i_11 = this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_2); i_6 > 0 && class293_10 != null && class293_10.aShort3508 < 0 && class293_10.aShort3508 == class293_4.aShort3508 && class293_10.aShort3501 == class293_4.aShort3501 && i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_6 - 1) && (i_6 - 1 <= 0 || i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_6 - 2)) && i_7 - i_6 <= 10; class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_3][i_6 - 1]) {
                                --i_6;
                            }

                            for (class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_3][i_7 + 1]; i_7 < this.aClass206_2546.sizeY && class293_10 != null && class293_10.aShort3508 < 0 && class293_10.aShort3508 == class293_4.aShort3508 && class293_10.aShort3501 == class293_4.aShort3501 && i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_7 + 1) && (i_7 + 1 >= this.aClass206_2546.sizeY || i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_7 + 2)) && i_7 - i_6 <= 10; class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_3][i_7 + 1]) {
                                ++i_7;
                            }

                            i_12 = i_1 - i_1 + 1;
                            i_13 = this.aClass206_2546.aGroundArray2607[bool_5 ? i_1 + 1 : i_1].getHeight(i_3, i_6);
                            i_14 = i_13 + i_12 * class293_4.aShort3508;
                            i_15 = this.aClass206_2546.aGroundArray2607[bool_5 ? i_1 + 1 : i_1].getHeight(i_3, i_7 + 1);
                        ...
                        if (class293_4.aShort3510 < 0) {
                            ...
                            for (i_11 = this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_3, i_2); i_6 > 0 && class293_10 != null && class293_10.aShort3510 < 0 && class293_10.aShort3510 == class293_4.aShort3510 && class293_10.aShort3511 == class293_4.aShort3511 && i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_6 - 1, i_2) && (i_6 - 1 <= 0 || i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_6 - 2, i_2)) && i_7 - i_6 <= 10; class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_6 - 1][i_2]) {
                                --i_6;
                            }

                            for (class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_7 + 1][i_2]; i_7 < this.aClass206_2546.sizeX && class293_10 != null && class293_10.aShort3510 < 0 && class293_10.aShort3510 == class293_4.aShort3510 && class293_10.aShort3511 == class293_4.aShort3511 && i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_7 + 1, i_2) && (i_7 + 1 >= this.aClass206_2546.sizeX || i_11 == this.aClass206_2546.aGroundArray2607[i_1].getHeight(i_7 + 2, i_2)) && i_7 - i_6 <= 10; class293_10 = this.aClass206_2546.aClass293ArrayArrayArray2604[i_1][i_7 + 1][i_2]) {
                                ++i_7;
                            }

                            i_12 = i_1 - i_1 + 1;
                            i_13 = this.aClass206_2546.aGroundArray2607[bool_5 ? i_1 + 1 : i_1].getHeight(i_6, i_2);
                            i_14 = i_13 + i_12 * class293_4.aShort3510;
                            i_15 = this.aClass206_2546.aGroundArray2607[bool_5 ? i_1 + 1 : i_1].getHeight(i_7 + 1, i_2);
