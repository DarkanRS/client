...
public class ia extends FontRenderer implements Interface40 {
    ...
    ia(ja ja_1, ba ba_2, FontMetrics fontmetrics_3, SpriteDefinitions[] arr_4, NativeSprite[] arr_5) {
        ...
        this.EA(ja_1, ba_2, bytes_6, arr_4[0].pallete, ints_7, ints_8, ints_9, ints_10);
    }
    ...
    void method362(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
        this.GA(var_1, i_2, i_3, i_4, bool_5, class455_6, i_7, i_8);
    }
