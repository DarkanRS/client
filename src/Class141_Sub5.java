...
public class Class141_Sub5 extends Class141 {
	...
	void method2409(int i_1, int i_2) {
		...
		aFloatArray9084[2] = 0.0F;
		aFloatArray9084[3] = (float) this.aClass505_Sub1_1664.anInt8368 * f_3 % 1.0F;
		OpenGL.glTexGenfv(8193, 9474, aFloatArray9084, 0);
		if (!this.aClass136_9080.aBool1631) {
			int i_7 = (int) (f_4 * (float) this.aClass505_Sub1_1664.anInt8368 * 16.0F);
			this.aClass505_Sub1_1664.method13654(this.aClass136_9080.aClass137_Sub1Array1634[i_7 % 16]);
		} else {
			aFloatArray9084[0] = 0.0F;
			aFloatArray9084[1] = 0.0F;
			aFloatArray9084[2] = 0.0F;
			aFloatArray9084[3] = (float) this.aClass505_Sub1_1664.anInt8368 * f_4 % 1.0F;
	...
	void method2397(boolean bool_1) {
		...
		if (this.aClass136_9080.aBool1631) {
			this.aClass505_Sub1_1664.method13610(1);
			this.aClass505_Sub1_1664.method13654(this.aClass136_9080.aClass137_Sub4_1636);
			this.aClass505_Sub1_1664.method13610(0);
		}
	...
	Class141_Sub5(Class505_Sub1 class505_sub1_1, Class136 class136_2) {
