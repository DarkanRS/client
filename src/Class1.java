...
public class Class1 {
	...
	public static void method252(Class397 class397, int i, int i_0_, Animable class521_sub1_sub1_sub2, int i_1_, int i_2_) {
		...
		((CS2Executor) class527).animable = class521_sub1_sub1_sub2;
		((CS2Executor) class527).anInt7004 = 2000547059 * i_1_;
		Class107.method1834(class397, i, i_0_, class527, (byte) 104);
		((CS2Executor) class527).animable = null;
	...
	static final void method254(CS2Executor class527, byte i) {
		...
		int i_5_ = (((CS2Executor) class527).intStack[1942118537 * ((CS2Executor) class527).anInt7012 + 1]);
		int[] is = ((CS2Executor) class527).intStack;
		int i_6_ = (((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1;
		int i_7_;
