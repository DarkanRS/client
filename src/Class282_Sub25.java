...
public class Class282_Sub25 extends Node {
	...
	static void method12400(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, Class282_Sub50_Sub7 class282_sub50_sub7, FontRenderer class8, FontMetrics class414, int i_7_, int i_8_, int i_9_) {
		...
		if (((Class282_Sub50_Sub7) class282_sub50_sub7).aBool9577)
			Exception_Sub1.aClass160_10075.method2752(5 + i_2_ + class414.getWidthNoSprites(string, -1967833701), i_6_ - class414.anInt4978 * 397683159);
	}

	static final void method12401(IComponentDefinitions class118, Interface class98, CS2Executor class527, int i) {
		...
		if (class118.anInt1288 * 1924549737 == -1 && !class98.aBool999)
			Class92.method1565(-1952846363 * class118.idHash, -2001727659);
	}
