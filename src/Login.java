        ...
        if (Class9.loginStage != 2 && Class9.loginStage != 105) {
            try {
                ...
                if (Class9.loginStage == 18) {
                    if (Class9.lobbyStage == 273) {
                        Class9.aClass184_73.method3050(SunDefinitions.createAsyncConnection(Class159.GAME_CONNECTION_INFO.createSocket((byte) 91), 15000, -215151896), Class159.GAME_CONNECTION_INFO.host, (byte) -112);
                    } else {
                        Class9.aClass184_73.method3050(SunDefinitions.createAsyncConnection(Class448.lobbyConnectionInfo.createSocket((byte) 75), 15000, 1248559901), Class448.lobbyConnectionInfo.host, (byte) -64);
                    }
