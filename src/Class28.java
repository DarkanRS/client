...
public class Class28 implements Interface2 {
	...
	static final void method773(CS2Executor class527, int i) {
		...
		int i_10_ = (class527.intStack[1942118537 * class527.intStackPtr]);
		int i_11_ = (class527.intStack[class527.intStackPtr * 1942118537 + 1]);
	...
	static final void method774(IComponentDefinitions class118, Interface class98, CS2Executor class527, int i) {
		class118.aBool1351 = ((class527.intStack[(class527.intStackPtr -= 141891001) * 1942118537]) == 1);
	...
	static final void method776(IComponentDefinitions class118, byte i) {
		if (1422794759 * IComponentDefinitions.anInt1266 == 1449989045 * class118.anInt1290) {
			if (Class84.myPlayer.displayName == null) {
				...
				class118.anInt1336 = ((int) (Math.sin((double) (-1809259861 * client.cycles) / 40.0) * 256.0) & 0x7ff) * -140036259;
				class118.anInt1329 = -1346216911;
				class118.anInt1330 = client.anInt7315 * -1183558903;
				class118.anInt1339 = Class272.method4840((Class84.myPlayer.displayName), (byte) 15) * 207030057;
