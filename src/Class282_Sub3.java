...
public class Class282_Sub3 extends Node {
	...
	void method12085(int[] ints_1, int i_2) {
		int i_3 = 0;
		Class282_Sub35_Sub1 class282_sub35_sub1_4 = this.aClass505_Sub1_7494.aClass282_Sub35_Sub1_8499;
	...
	void method12092(int i_1) {
		this.aNativeHeapBuffer7495 = this.aClass505_Sub1_7494.aNativeHeap8445.method759(i_1 * 4, true);
