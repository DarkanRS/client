public class Class8_Sub1 extends FontRenderer {
	...
	void UA(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		if (this.aClass505_Sub3_8513.anIntArray8979 != null) {
			...
			int i_8 = this.aClass505_Sub3_8513.anInt8980;
			int i_9 = i_3 * i_8 + i_2;
			int i_10 = i_8 - i_6;
			int i_11 = 0;
			int i_12 = 0;
			int i_13;
			if (i_3 < this.aClass505_Sub3_8513.anInt9009) {
				i_13 = this.aClass505_Sub3_8513.anInt9009 - i_3;
				i_7 -= i_13;
				i_3 = this.aClass505_Sub3_8513.anInt9009;
				i_12 += i_6 * i_13;
				i_9 += i_8 * i_13;
			}

			if (i_3 + i_7 > this.aClass505_Sub3_8513.anInt8986) {
				i_7 -= i_3 + i_7 - this.aClass505_Sub3_8513.anInt8986;
			}

			if (i_2 < this.aClass505_Sub3_8513.anInt8983) {
				i_13 = this.aClass505_Sub3_8513.anInt8983 - i_2;
				i_6 -= i_13;
				i_2 = this.aClass505_Sub3_8513.anInt8983;
				i_12 += i_13;
				i_9 += i_13;
				i_11 += i_13;
				i_10 += i_13;
			...
			if (i_6 + i_2 > this.aClass505_Sub3_8513.anInt9002) {
				i_13 = i_6 + i_2 - this.aClass505_Sub3_8513.anInt9002;
				i_6 -= i_13;
				i_11 += i_13;
				i_10 += i_13;
			}
			...
			if (i_6 > 0 && i_7 > 0) {
				if ((i_4 & ~0xffffff) == -16777216) {
					this.method13771(this.aByteArrayArray8509[var_1], this.aClass505_Sub3_8513.anIntArray8979, i_4, i_12, i_9, i_6, i_7, i_10, i_11);
				} else if ((i_4 & ~0xffffff) != 0) {
					this.method13772(this.aByteArrayArray8509[var_1], this.aClass505_Sub3_8513.anIntArray8979, i_4, i_12, i_9, i_6, i_7, i_10, i_11);
				}
			}
		}
	...
	Class8_Sub1(HardwareRenderer hardwarerenderer_1, FontMetrics fontmetrics_2, Class91[] arr_3, int[] ints_4, int[] ints_5) {
		super(hardwarerenderer_1, fontmetrics_2);
		this.aClass505_Sub3_8513 = hardwarerenderer_1;
		...
		for (int i_6 = 0; i_6 < arr_3.length; i_6++) {
			this.aByteArrayArray8509[i_6] = arr_3[i_6].aByteArray960;
			this.anIntArray8510[i_6] = arr_3[i_6].anInt959;
			this.anIntArray8514[i_6] = arr_3[i_6].anInt956;
		}
	...
	void method374(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
		if (this.aClass505_Sub3_8513.anIntArray8979 != null) {
			if (class455_6 == null) {
				...
				int i_11 = this.aClass505_Sub3_8513.anInt8980;
				...
				int i_16;
				if (i_3 < this.aClass505_Sub3_8513.anInt9009) {
					i_16 = this.aClass505_Sub3_8513.anInt9009 - i_3;
					i_10 -= i_16;
					i_3 = this.aClass505_Sub3_8513.anInt9009;
					i_15 += i_9 * i_16;
					i_12 += i_11 * i_16;
				...
				if (i_3 + i_10 > this.aClass505_Sub3_8513.anInt8986) {
					i_10 -= i_3 + i_10 - this.aClass505_Sub3_8513.anInt8986;
				}

				if (i_2 < this.aClass505_Sub3_8513.anInt8983) {
					i_16 = this.aClass505_Sub3_8513.anInt8983 - i_2;
					i_9 -= i_16;
					i_2 = this.aClass505_Sub3_8513.anInt8983;
					i_15 += i_16;
					i_12 += i_16;
				...
				if (i_9 + i_2 > this.aClass505_Sub3_8513.anInt9002) {
					i_16 = i_9 + i_2 - this.aClass505_Sub3_8513.anInt9002;
					i_9 -= i_16;
					i_14 += i_16;
					i_13 += i_16;
				}
				...
				if (i_9 > 0 && i_10 > 0) {
					if ((i_4 & ~0xffffff) == -16777216) {
						this.method13773(this.aByteArrayArray8509[var_1], this.aClass505_Sub3_8513.anIntArray8979, i_4, i_15, i_12, i_9, i_10, i_13, i_14, i_2, i_3, this.anIntArray8511[var_1], class455_6, i_7, i_8);
					} else {
						this.method13774(this.aByteArrayArray8509[var_1], this.aClass505_Sub3_8513.anIntArray8979, i_4, i_15, i_12, i_9, i_10, i_13, i_14, i_2, i_3, this.anIntArray8511[var_1], class455_6, i_7, i_8);
					}
				}
			}
		}
	...
	void method13773(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
		...
		if (i_15 > i_11) {
			i_19 = i_15;
			i_5 += this.aClass505_Sub3_8513.anInt8980 * (i_15 - i_11);
			i_4 += (i_15 - i_11) * i_12;
		}
	...
	void method13774(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
		...
		int[] ints_17 = packetsdecoder_16.anIntArray9077;
		int[] ints_18 = packetsdecoder_16.anIntArray9078;
		int i_19 = i_10 - this.aClass505_Sub3_8513.anInt8983;
		int i_20 = i_11;
		if (i_15 > i_11) {
			i_20 = i_15;
			i_5 += this.aClass505_Sub3_8513.anInt8980 * (i_15 - i_11);
	...
	void method362(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
		if (this.aClass505_Sub3_8513.anIntArray8979 != null) {
			if (class455_6 == null) {
				...
				int i_9 = this.anIntArray8511[var_1];
				int i_10 = this.anIntArray8512[var_1];
				int i_11 = 444800403 * this.aClass505_Sub3_8513.anInt8980 * 299731099;
				int i_12 = i_2 + i_11 * i_3;
				int i_13 = i_11 - i_9;
				int i_14 = 0;
				int i_15 = 0;
				int i_16;
				if (i_3 < 1516535457 * this.aClass505_Sub3_8513.anInt9009 * 1457972577) {
					i_16 = this.aClass505_Sub3_8513.anInt9009 * 1457972577 * 1516535457 - i_3;
					i_10 -= i_16;
					i_3 = 1516535457 * this.aClass505_Sub3_8513.anInt9009 * 1457972577;
					i_15 += i_9 * i_16;
					i_12 += i_11 * i_16;
				}

				if (i_10 + i_3 > this.aClass505_Sub3_8513.anInt8986 * 760194793 * 1383960921) {
					i_10 -= i_3 + i_10 - 1383960921 * this.aClass505_Sub3_8513.anInt8986 * 760194793;
				}

				if (i_2 < 72550989 * this.aClass505_Sub3_8513.anInt8983 * -363774331) {
					i_16 = 72550989 * this.aClass505_Sub3_8513.anInt8983 * -363774331 - i_2;
					i_9 -= i_16;
					i_2 = 72550989 * this.aClass505_Sub3_8513.anInt8983 * -363774331;
					i_15 += i_16;
					i_12 += i_16;
					i_14 += i_16;
					i_13 += i_16;
				...
				if (i_9 + i_2 > this.aClass505_Sub3_8513.anInt9002 * 1714763515 * -1710988237) {
					i_16 = i_2 + i_9 - -1710988237 * this.aClass505_Sub3_8513.anInt9002 * 1714763515;
					i_9 -= i_16;
					i_14 += i_16;
					i_13 += i_16;
				}
	...
	void c(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		if (this.aClass505_Sub3_8513.anIntArray8979 != null) {
			...
			int i_6 = this.anIntArray8511[var_1];
			int i_7 = this.anIntArray8512[var_1];
			int i_8 = 444800403 * this.aClass505_Sub3_8513.anInt8980 * 299731099;
			int i_9 = i_2 + i_8 * i_3;
			int i_10 = i_8 - i_6;
			int i_11 = 0;
			int i_12 = 0;
			int i_13;
			if (i_3 < 1516535457 * this.aClass505_Sub3_8513.anInt9009 * 1457972577) {
				i_13 = this.aClass505_Sub3_8513.anInt9009 * 1457972577 * 1516535457 - i_3;
				i_7 -= i_13;
				i_3 = 1516535457 * this.aClass505_Sub3_8513.anInt9009 * 1457972577;
				i_12 += i_6 * i_13;
				i_9 += i_8 * i_13;
			...
			if (i_3 + i_7 > this.aClass505_Sub3_8513.anInt8986 * 760194793 * 1383960921) {
				i_7 -= i_3 + i_7 - 1383960921 * this.aClass505_Sub3_8513.anInt8986 * 760194793;
			}

			if (i_2 < 72550989 * this.aClass505_Sub3_8513.anInt8983 * -363774331) {
				i_13 = this.aClass505_Sub3_8513.anInt8983 * -363774331 * 72550989 - i_2;
				i_6 -= i_13;
				i_2 = this.aClass505_Sub3_8513.anInt8983 * -363774331 * 72550989;
				i_12 += i_13;
				i_9 += i_13;
				i_11 += i_13;
				i_10 += i_13;
			...
			if (i_2 + i_6 > this.aClass505_Sub3_8513.anInt9002 * 1714763515 * -1710988237) {
				i_13 = i_2 + i_6 - -1710988237 * this.aClass505_Sub3_8513.anInt9002 * 1714763515;
				i_6 -= i_13;
				i_11 += i_13;
				i_10 += i_13;
			}
