public abstract class NativeSprite implements Sprite {
	...
	public abstract void method2751(int var1, int var2, int var3);

	public final void method2752(int i_1, int i_2) {
		this.method2742(i_1, i_2, 1, 0, 1);
	}
	...
	public final void method2754(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
		this.method2755(i_1, i_2, i_3, i_4, i_5, i_6, i_7, 1);
	}

	abstract void method2755(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8);

	public final void method2756(int i_1, int i_2, int i_3, int i_4) {
		this.method2772(i_1, i_2, i_3, i_4, 1, 0, 1);
	}
	...
	final void method2760(float f_1, float f_2, float f_3, float f_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		if (i_5 != 0) {
			...
			float f_13 = (float) Math.cos(d_10) * (float) i_5;
			float f_14 = (-f_3 * f_13 + -f_4 * f_12) / 4096.0F + f_1;
			float f_15 = (--f_3 * f_12 + -f_4 * f_13) / 4096.0F + f_2;
			float f_16 = (((float) this.method228() - f_3) * f_13 + -f_4 * f_12) / 4096.0F + f_1;
	...
	public final void method2761(float f_1, float f_2, int i_3, int i_4, Class455 class455_5, int i_6, int i_7) {
		this.method2762(f_1, f_2, (float) this.method228() / 2.0F, (float) this.method2748() / 2.0F, i_3, i_4, class455_5, i_6, i_7);
	}

	public final void method2762(float f_1, float f_2, float f_3, float f_4, int i_5, int i_6, Class455 class455_7, int i_8, int i_9) {
		if (i_5 != 0) {
			double d_10 = (double) (i_6 & 0xffff) * 9.587379924285257E-5D;
			float f_12 = (float) Math.sin(d_10) * (float) i_5;
			float f_13 = (float) Math.cos(d_10) * (float) i_5;
			...
			float f_18 = (-f_3 * f_13 + ((float) this.method2748() - f_4) * f_12) / 4096.0F + f_1;
			float f_19 = (--f_3 * f_12 + ((float) this.method2748() - f_4) * f_13) / 4096.0F + f_2;
			this.method2797(f_14, f_15, f_16, f_17, f_18, f_19, class455_7, i_8, i_9);
		}

	}

	public final void method2763(float f_1, float f_2, float f_3, float f_4, float f_5, float f_6, int i_7, int i_8, int i_9) {
		this.method2764(f_1, f_2, f_3, f_4, f_5, f_6, i_7, i_8, i_9, 1);
	}

	abstract void method2764(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int var9, int var10);
	...
	public final void method2789(int i_1, int i_2, int i_3, int i_4) {
		this.method2755(i_1, i_2, i_3, i_4, 1, 0, 1, 1);
	}

	public abstract int method225();

	public final void method2790(float f_1, float f_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
		this.method2760(f_1, f_2, (float) this.method228() / 2.0F, (float) this.method2748() / 2.0F, i_3, i_4, i_5, i_6, i_7);
	}
	...
	final void method2797(float f_1, float f_2, float f_3, float f_4, float f_5, float f_6, Class455 class455_7, int i_8, int i_9) {
		this.method2766(f_1, f_2, f_3, f_4, f_5, f_6, 1, class455_7, i_8, i_9);
	}
