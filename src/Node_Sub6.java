...
public class Node_Sub6 extends Node {
	...
	GraphicalRenderer_Sub2 aGraphicalRenderer_Sub2_7518;
	int anInt7510;
	float aFloat7511;
	...
	Node_Sub6(HardwareGround class390_sub1_1, int i_2, int i_3, HDWaterTile class90_4) {
		this.aGround_Sub1_7509 = class390_sub1_1;
		this.aGraphicalRenderer_Sub2_7518 = this.aGround_Sub1_7509.aGraphicalRenderer_Sub2_8528;
		this.anInt7510 = i_2;
		this.aFloat7511 = (float) i_3;
		this.hdWaterTile = class90_4;
		this.anIntArray7515 = new int[this.aGround_Sub1_7509.width * this.aGround_Sub1_7509.length];
		byte b_5 = 10;
		if (i_2 >= 0) {
			TextureDetails class169_6 = this.aGraphicalRenderer_Sub2_7518.anInterface22_5834.method144(i_2);
			if (class169_6.effectId > 0) {
				b_5 = class169_6.effectId;
			}
		}

		this.aGraphicalRenderer_Sub2_7518.method13896(b_5);
		this.aGraphicalRenderer_Sub2_7518.method13896(3);
	}
	...
	void method12145(int i_1, int i_2, int i_3, float f_4) {
		...
		int i_7;
		if (this.anInt7510 != -1) {
			TextureDetails class169_5 = this.aGraphicalRenderer_Sub2_7518.anInterface22_5834.method144(this.anInt7510);
		...
		if (this.aGraphicalRenderer_Sub2_7518.anInt8824 == 0) {
	...
	void method12146(int i_1) {
		...
		this.anInterface4_7516 = this.aGraphicalRenderer_Sub2_7518.method13994(false);
	...
	void method12147(int[] ints_1, int i_2) {
		...
		ByteBuffer bytebuffer_3 = this.aGraphicalRenderer_Sub2_7518.aByteBuffer8838;

		label49: for (int i_4 = 0; i_4 < i_2; i_4++) {
			int i_5 = ints_1[i_4];
			short[] shorts_6 = this.aGround_Sub1_7509.aShortArrayArray8534[i_5];
	...
	void method12150(int i_1) {
		this.aNativeHeapBuffer7520 = this.aGraphicalRenderer_Sub2_7518.method13910(i_1 * 4, true);
		this.aStream7513 = new Stream(this.aNativeHeapBuffer7520, i_1 * 4);
	}

	void method12152(int i_1, int i_2, int i_3) {
		this.anIntArray7515[i_2 * this.aGround_Sub1_7509.width + i_1] |= 1 << i_3;
		++this.anInt7508;
	}
