...
public class Class84 {
	...
	static final void method1463(CS2Executor class527, int i) {
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = Class393.aClass282_Sub54_4783.aClass468_Sub7_8210.method12666(2085478304);
	}
	...
	static final void method1464(int i) {
		...
		for (Class282_Sub50_Sub12 class282_sub50_sub12 = ObjectDefinitions.method8022(-54255165); class282_sub50_sub12 != null; class282_sub50_sub12 = ObjectDefinitions.method8022(153366181)) {
			...
			if (1 == i_5_) {
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 54);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 57);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 70);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 59);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 106);
				if (class118.anInt1264 * -795991475 != i_13_) {
					class118.anInt1264 = i_13_ * -1774983547;
					Class109.method1858(class118, (byte) 85);
				}
			} else if (i_5_ == 7) {
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 66);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 73);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 121);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 4);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 61);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 13);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 39);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 127);
				class118.aBool1356 = 1 == (((Class282_Sub50_Sub12) class282_sub50_sub12).anInt9668) * 492007;
			} else if (21 == i_5_) {
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 114);
				class118.aBool1328 = 1 == (((Class282_Sub50_Sub12) class282_sub50_sub12).anInt9668) * 492007;
			} else if (i_5_ == 17) {
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 82);
				class118.anInt1435 = (((Class282_Sub50_Sub12) class282_sub50_sub12).anInt9668 * -1713155233);
			} else if (18 == i_5_) {
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 125);
				int i_15_ = (int) (l >> 32);
				...
				IComponentDefinitions class118 = Class117.method1981((int) l, (byte) 16);
				int i_16_ = (int) (l >> 32);
