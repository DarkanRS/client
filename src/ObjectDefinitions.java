    ...
    MeshRasterizer method7971(GraphicalRenderer class505, int i, int i_35_, int i_36_, Class476 class476, int i_37_) {
        ...
        if (types != null) {
            ...
            if (i_43_ > 0) {
                ...
                for (int i_44_ = 0; i_44_ < i_43_; i_44_++) l = (long) is[i_44_] + 67783L * l;
        ...
        if (null != ((ObjectDefinitions) this).originalTextures) {
            ...
            if (class476 != null && null != ((Class476) class476).aShortArray5625)
                ...
                is = modifiedTextures;
            for (int i_50_ = 0; i_50_ < ((ObjectDefinitions) this).originalTextures.length; i_50_++) class528_48_.W(((ObjectDefinitions) this).originalTextures[i_50_], is[i_50_]);
        }
