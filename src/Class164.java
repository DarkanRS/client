...
public class Class164 {
	...
	OpenGLGraphicalRenderer aGraphicalRenderer_Sub1_2033;

	boolean method2847() {
		if (this.aGraphicalRenderer_Sub1_2033.aBool8472 && this.aGraphicalRenderer_Sub1_2033.aBool8365 && this.aClass128_2032 == null) {
			Class140 class140_1 = Class140.method2393(this.aGraphicalRenderer_Sub1_2033, 35632, "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n");
			if (class140_1 != null) {
				this.aClass128_2032 = Class128.method2174(this.aGraphicalRenderer_Sub1_2033, new Class140[] { class140_1 });
			}
		}
	...
	boolean method2848(Class137_Sub4 class137_sub4_1, Class137_Sub4 class137_sub4_2) {
		if (!this.method2847()) {
			...
			Class158_Sub1_Sub4 class158_sub1_sub4_4 = this.aGraphicalRenderer_Sub1_2033.aClass158_Sub1_Sub4_8493;
			CacheableNode_Sub19 class282_sub50_sub19_5 = new CacheableNode_Sub19(this.aGraphicalRenderer_Sub1_2033, Class150.aClass150_1949, Class76.aClass76_751, class137_sub4_1.anInt9116, class137_sub4_1.anInt9117);
			boolean bool_6 = false;
			this.aGraphicalRenderer_Sub1_2033.method8637(class158_sub1_sub4_4, 1347401334);
			...
			if (class158_sub1_sub4_4.method13764()) {
				...
				for (int i_7 = 0; i_7 < class137_sub4_1.anInt9118; i_7++) {
					...
					this.aGraphicalRenderer_Sub1_2033.method13654(class137_sub4_2);
					OpenGL.glBegin(7);
			...
			this.aGraphicalRenderer_Sub1_2033.method8416(class158_sub1_sub4_4, (byte) -74);
			return bool_6;
		}
	}

	Class164(OpenGLGraphicalRenderer class505_sub1_1) {
		this.aGraphicalRenderer_Sub1_2033 = class505_sub1_1;
	}
