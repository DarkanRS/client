	...
	static void method8209(GraphicalRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int i_5, byte b_6) {
		...
		if (Class354.aClass160_4110 != null && ParamDefinitions.aClass160_5339 != null && Class125.aClass160_1571 != null) {
			...
			for (int i_9 = 0; i_9 < i_8; i_9++) {
				...
				HitbarIndexLoader.aClass160_3452.method2752(i_3 + i_1 - HitbarIndexLoader.aClass160_3452.method2747(), i_5 + i_2 + i_9 * ParamDefinitions.aClass160_5339.method2793());
			}
