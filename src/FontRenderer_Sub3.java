...
public class FontRenderer_Sub3 extends FontRenderer {
	...
	void UA(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		if (this.aGraphicalRenderer_Sub3_8968.anIntArray8979 != null) {
			...
			int i_8 = this.aGraphicalRenderer_Sub3_8968.anInt8980;
			int i_9 = i_2 + i_3 * i_8;
			int i_10 = i_8 - i_6;
			int i_11 = 0;
			int i_12 = 0;
			int i_13;
			if (i_3 < this.aGraphicalRenderer_Sub3_8968.anInt9009) {
				i_13 = this.aGraphicalRenderer_Sub3_8968.anInt9009 - i_3;
				i_7 -= i_13;
				i_3 = this.aGraphicalRenderer_Sub3_8968.anInt9009;
				i_12 += i_13 * i_6;
				i_9 += i_13 * i_8;
			}
			if (i_3 + i_7 > this.aGraphicalRenderer_Sub3_8968.anInt8986) {
				i_7 -= i_3 + i_7 - this.aGraphicalRenderer_Sub3_8968.anInt8986;
			}
			if (i_2 < this.aGraphicalRenderer_Sub3_8968.anInt8983) {
				i_13 = this.aGraphicalRenderer_Sub3_8968.anInt8983 - i_2;
				i_6 -= i_13;
				i_2 = this.aGraphicalRenderer_Sub3_8968.anInt8983;
				i_12 += i_13;
				i_9 += i_13;
				i_11 += i_13;
				i_10 += i_13;
			}
			if (i_6 + i_2 > this.aGraphicalRenderer_Sub3_8968.anInt9002) {
				i_13 = i_6 + i_2 - this.aGraphicalRenderer_Sub3_8968.anInt9002;
				i_6 -= i_13;
				i_11 += i_13;
				i_10 += i_13;
			}
			if (i_6 > 0 && i_7 > 0) {
				if (bool_5) {
					this.method14325(this.aByteArrayArray8967[var_1], this.aGraphicalRenderer_Sub3_8968.anIntArray8979, i_4, i_12, i_9, i_6, i_7, i_10, i_11);
				} else {
					this.method14334(this.aByteArrayArray8967[var_1], this.aGraphicalRenderer_Sub3_8968.anIntArray8979, this.anIntArray8970, i_12, i_9, i_6, i_7, i_10, i_11);
				}
			}
		}
	}
	...
	void method374(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
		if (this.aGraphicalRenderer_Sub3_8968.anIntArray8979 != null) {
			if (class455_6 == null) {
				...
				int i_11 = this.aGraphicalRenderer_Sub3_8968.anInt8980;
				...
				int i_16;
				if (i_3 < this.aGraphicalRenderer_Sub3_8968.anInt9009) {
					i_16 = this.aGraphicalRenderer_Sub3_8968.anInt9009 - i_3;
					i_10 -= i_16;
					i_3 = this.aGraphicalRenderer_Sub3_8968.anInt9009;
					i_15 += i_9 * i_16;
					i_12 += i_16 * i_11;
				}
				if (i_3 + i_10 > this.aGraphicalRenderer_Sub3_8968.anInt8986) {
					i_10 -= i_3 + i_10 - this.aGraphicalRenderer_Sub3_8968.anInt8986;
				}
				if (i_2 < this.aGraphicalRenderer_Sub3_8968.anInt8983) {
					i_16 = this.aGraphicalRenderer_Sub3_8968.anInt8983 - i_2;
					i_9 -= i_16;
					i_2 = this.aGraphicalRenderer_Sub3_8968.anInt8983;
					i_15 += i_16;
					i_12 += i_16;
				...
				if (i_9 + i_2 > this.aGraphicalRenderer_Sub3_8968.anInt9002) {
					i_16 = i_9 + i_2 - this.aGraphicalRenderer_Sub3_8968.anInt9002;
					i_9 -= i_16;
					i_14 += i_16;
					i_13 += i_16;
				}
				if (i_9 > 0 && i_10 > 0) {
					if (bool_5) {
						this.method14327(this.aByteArrayArray8967[var_1], this.aGraphicalRenderer_Sub3_8968.anIntArray8979, i_4, i_15, i_12, i_9, i_10, i_13, i_14, i_2, i_3, this.anIntArray8969[var_1], class455_6, i_7, i_8);
					} else {
						this.method14326(this.aByteArrayArray8967[var_1], this.aGraphicalRenderer_Sub3_8968.anIntArray8979, this.anIntArray8970, i_4, i_15, i_12, i_9, i_10, i_13, i_14, i_2, i_3, this.anIntArray8969[var_1], class455_6, i_7, i_8);
					}
				}
			}
		}
	...
	void method14326(byte[] bytes_1, int[] ints_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, Class455 class455_14, int i_15, int i_16) {
		...
		if (i_16 > i_12) {
			i_21 = i_16;
			i_6 += (i_16 - i_12) * this.aGraphicalRenderer_Sub3_8968.anInt8980;
			i_5 += i_13 * (i_16 - i_12);
		}
	...
	void method14327(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
		...
		if (i_15 > i_11) {
			i_20 = i_15;
			i_5 += this.aGraphicalRenderer_Sub3_8968.anInt8980 * (i_15 - i_11);
			i_4 += (i_15 - i_11) * i_12;
		}
	...
	void method362(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
		if (this.aGraphicalRenderer_Sub3_8968.anIntArray8979 != null) {
			if (class455_6 == null) {
				...
				int i_9 = this.anIntArray8969[var_1];
				int i_10 = this.anIntArray8971[var_1];
				int i_11 = this.aGraphicalRenderer_Sub3_8968.anInt8980 * 299731099 * 444800403;
				int i_12 = i_2 + i_3 * i_11;
				int i_13 = i_11 - i_9;
				int i_14 = 0;
				int i_15 = 0;
				int i_16;
				if (i_3 < 1516535457 * this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577) {
					i_16 = 1516535457 * this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577 - i_3;
					i_10 -= i_16;
					i_3 = this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577 * 1516535457;
					i_15 += i_9 * i_16;
					i_12 += i_16 * i_11;
				}
				if (i_10 + i_3 > 1383960921 * this.aGraphicalRenderer_Sub3_8968.anInt8986 * 760194793) {
					i_10 -= i_3 + i_10 - 1383960921 * this.aGraphicalRenderer_Sub3_8968.anInt8986 * 760194793;
				}
				if (i_2 < this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331 * 72550989) {
					i_16 = this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331 * 72550989 - i_2;
					i_9 -= i_16;
					i_2 = 72550989 * this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331;
					i_15 += i_16;
					i_12 += i_16;
					i_14 += i_16;
					i_13 += i_16;
				}
				if (i_2 + i_9 > -1710988237 * this.aGraphicalRenderer_Sub3_8968.anInt9002 * 1714763515) {
					i_16 = i_9 + i_2 - this.aGraphicalRenderer_Sub3_8968.anInt9002 * 1714763515 * -1710988237;
					i_9 -= i_16;
					i_14 += i_16;
					i_13 += i_16;
				}
	...
	void c(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		if (this.aGraphicalRenderer_Sub3_8968.anIntArray8979 != null) {
			...
			int i_6 = this.anIntArray8969[var_1];
			int i_7 = this.anIntArray8971[var_1];
			int i_8 = 444800403 * this.aGraphicalRenderer_Sub3_8968.anInt8980 * 299731099;
			int i_9 = i_3 * i_8 + i_2;
			int i_10 = i_8 - i_6;
			int i_11 = 0;
			int i_12 = 0;
			int i_13;
			if (i_3 < 1516535457 * this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577) {
				i_13 = 1516535457 * this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577 - i_3;
				i_7 -= i_13;
				i_3 = 1516535457 * this.aGraphicalRenderer_Sub3_8968.anInt9009 * 1457972577;
				i_12 += i_13 * i_6;
				i_9 += i_13 * i_8;
			}
			if (i_7 + i_3 > this.aGraphicalRenderer_Sub3_8968.anInt8986 * 760194793 * 1383960921) {
				i_7 -= i_3 + i_7 - this.aGraphicalRenderer_Sub3_8968.anInt8986 * 760194793 * 1383960921;
			}
			if (i_2 < 72550989 * this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331) {
				i_13 = 72550989 * this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331 - i_2;
				i_6 -= i_13;
				i_2 = 72550989 * this.aGraphicalRenderer_Sub3_8968.anInt8983 * -363774331;
				i_12 += i_13;
				i_9 += i_13;
			...
			if (i_2 + i_6 > -1710988237 * this.aGraphicalRenderer_Sub3_8968.anInt9002 * 1714763515) {
				i_13 = i_2 + i_6 - -1710988237 * this.aGraphicalRenderer_Sub3_8968.anInt9002 * 1714763515;
				i_6 -= i_13;
				i_11 += i_13;
				i_10 += i_13;
			}
	...
	FontRenderer_Sub3(HardwareRenderer hardwarerenderer_1, FontMetrics fontmetrics_2, SpriteDefinitions[] arr_3, int[] ints_4, int[] ints_5) {
		...
		this.aGraphicalRenderer_Sub3_8968 = hardwarerenderer_1;
		this.aGraphicalRenderer_Sub3_8968 = hardwarerenderer_1;
		...
		for (int i_6 = 0; i_6 < arr_3.length; i_6++) {
			this.aByteArrayArray8967[i_6] = arr_3[i_6].pixels;
			this.anIntArray8972[i_6] = arr_3[i_6].minY;
			this.anIntArray8973[i_6] = arr_3[i_6].minX;
		}
		this.anIntArray8970 = arr_3[0].pallete;
	}
	...
	static final void method14336(Transform_Sub1 class521_sub1_0, int i_1, boolean bool_2, int i_3) {
		int i_4;
		int i_5;
		if (class521_sub1_0 instanceof Transform_Sub1_Sub1 && class521_sub1_0 instanceof SceneObject) {
			Transform_Sub1_Sub1 class521_sub1_sub1_9 = (Transform_Sub1_Sub1) class521_sub1_0;
