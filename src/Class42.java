public class Class42 implements Interface2 {
	...
	public static void method890(int i_0, int i_1, int i_2, byte b_3) {
		if (Class260.aClass116_3229 != null && Class260.aClass116_3229.method1956(1160218565) && i_0 == Class260.aClass116_3229.anInt1254) {
			...
			TCPMessage tcpmessage_4 = Class271.method4828(OutgoingPacket.aClass379_4531, client.aClass184_7475.isaac, -228003010);
			tcpmessage_4.buffer.writeInt(-1);
			client.aClass184_7475.method3049(tcpmessage_4, 1617512289);
		} else {
			i_1 = i_1 * Class393.aClass282_Sub54_4783.aClass468_Sub13_8228.method12714(-1100344734) >> 8;
	...
	static final void method892(CS2Executor cs2executor_0, int i_1) {
