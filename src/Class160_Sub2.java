...
public class Class160_Sub2 extends NativeSprite {
	...
	void method2791(float f_1, float f_2, float f_3, float f_4, float f_5, float f_6, int i_7, int i_8, int i_9, int i_10) {
		...
		this.aClass505_Sub1_9032.method13612(i_7);
	...
	public void method2767(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		if (this.aClass505_Sub1_9032.aBool8456) {
			int[] ints_7 = this.aClass505_Sub1_9032.ab(i_5, i_6, i_3, i_4);
			if (ints_7 != null) {
	...
	public void method2772(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
		...
		this.aClass505_Sub1_9032.method13612(i_5);
	...
	void method14415() {
		this.aClass505_Sub1_9032.method13610(1);
	...
	public void method2773(int i_1, int i_2, Class455 class455_3, int i_4, int i_5) {
		...
		this.aClass505_Sub1_9032.method13637();
		this.aClass505_Sub1_9032.method13654(this.aClass137_Sub1_Sub1_9033);
		this.aClass505_Sub1_9032.method13612(1);
		this.aClass505_Sub1_9032.method13610(1);
		this.aClass505_Sub1_9032.method13654(class137_sub1_sub1_7);
		this.aClass505_Sub1_9032.method13717(7681, 8448);
		this.aClass505_Sub1_9032.method13595(0, 34168, 768);
		this.aClass505_Sub1_9032.method13624(1);
		i_1 += this.anInt9030;
		i_2 += this.anInt9034;
		...
		OpenGL.glVertex2i(this.aClass137_Sub1_Sub1_9033.anInt10136 + i_1, i_2);
		OpenGL.glEnd();
		this.aClass505_Sub1_9032.method13595(0, 5890, 768);
		this.aClass505_Sub1_9032.method13612(0);
		this.aClass505_Sub1_9032.method13654((Class137) null);
		this.aClass505_Sub1_9032.method13610(0);
	}
	...
	void method2800(float f_1, float f_2, float f_3, float f_4, float f_5, float f_6, int i_7, Class455 class455_8, int i_9, int i_10) {
		...
		this.aClass505_Sub1_9032.method13612(1);
		this.aClass505_Sub1_9032.method13610(1);
		this.aClass505_Sub1_9032.method13654(class137_sub1_sub1_11);
		this.aClass505_Sub1_9032.method13717(7681, 8448);
		this.aClass505_Sub1_9032.method13595(0, 34168, 768);
		this.aClass505_Sub1_9032.method13624(1);
	...
	void method14419(int i_1) {
		...
		this.aClass505_Sub1_9032.method13595(1, 34166, 768);
		if (this.anInt9031 == 0) {
			this.aClass505_Sub1_9032.method13635(1.0F, 0.5F, 0.5F, 0.0F);
		} else if (this.anInt9031 == 1) {
			this.aClass505_Sub1_9032.method13635(0.5F, 1.0F, 0.5F, 0.0F);
		} else if (this.anInt9031 == 2) {
			this.aClass505_Sub1_9032.method13635(0.5F, 0.5F, 1.0F, 0.0F);
		} else if (this.anInt9031 == 3) {
			this.aClass505_Sub1_9032.method13635(128.5F, 128.5F, 128.5F, 0.0F);
		}
