...
public final class VarNPCMap {
	...
	public static Class268 playSoundSynth(int i_0, int i_1, int i_2, int i_3, int sampleRate) {
		if (Class393.preferences.aPreference_Sub13_8225.method12714() != 0 && i_1 != 0 && Class260.anInt3219 < 50 && i_0 != -1) {
			Class268 class268_6 = new Class268((byte) 1, i_0, i_1, i_2, i_3, 0, sampleRate, (Transform_Sub1) null);
