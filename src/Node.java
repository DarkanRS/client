...
public class Node {
	...
	static final void method5001(Class118 class118, CS2Executor class527, int i) {
		...
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = point.x;
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = point.y;
	}
	...
	static final void method5003(CS2Executor class527, byte i) {
		...
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = i_2_ & 0x3fff;
	}
