...
public class Class528_Sub3 extends MeshRasterizer {
	...
	Class528_Sub3(Class505_Sub2 class505_sub2_1, RSMesh rsmesh_2, int i_3, int i_4, int i_5, int i_6) {
			...
			if (rsmesh_2.isolatedVertexNormals != null) {
				...
				for (i_19 = 0; i_19 < rsmesh_2.isolatedVertexNormals.length; i_19++) {
					...
					if (i_12 == class84_73.anInt809) {
						BillboardDefinitions class347_77 = Class417.getBillboardDefinitions(class84_73.anInt812);
		...
		if (rsmesh_2.isolatedVertexNormals != null) {
			...
			for (i_12 = 0; i_12 < this.anInt8951; i_12++) {
				...
				BillboardDefinitions class347_66 = Class417.getBillboardDefinitions(class84_111.anInt812);
				i_112 = -1;
	...
	void method14278(Matrix44Var matrix44var_1) {
		if (this.anInt8963 != 0 && this.method14279() && this.method14271()) {
			...
			if (this.aClass505_Sub2_8917.aBool8779) {
				HDWaterTile class90_3 = this.aClass505_Sub2_8917.method13898();
			...
			if ((this.anInt8896 & 0x37) == 0) {
				...
				for (int i_12 = 0; i_12 < this.anIntArray8952.length; i_12++) {
					...
					if (i_6 != 65535) {
						...
						TextureDetails class169_8 = this.aClass505_Sub2_8917.anInterface22_5834.method144(i_6);
				...
				for (i_5 = 0; i_5 < this.anIntArray8952.length; i_5++) {
					...
					if (i_15 != 65535) {
						...
						TextureDetails class169_10 = this.aClass505_Sub2_8917.anInterface22_5834.method144(i_15);
					...
					case 5:
						if (!this.aClass505_Sub2_8917.aBool8692) {
							...
							TextureDetails class169_11 = this.aClass505_Sub2_8917.anInterface22_5834.method144(i_15);
	...
	int method14282(int i_1, short s_2, int i_3) {
		...
		if (s_2 != -1) {
			TextureDetails class169_5 = this.aClass505_Sub2_8917.anInterface22_5834.method144(s_2 & 0xffff);
