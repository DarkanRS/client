public class Class282_Sub7 extends Node {
	...
	static Class282_Sub7 method12164(Index index_0, int i_1, int i_2) {
		byte[] bytes_3 = index_0.getFile(i_1, i_2);
		return bytes_3 == null ? null : new Class282_Sub7(new RsByteBuffer(bytes_3));
	}

	Class282_Sub7(RsByteBuffer rsbytebuffer_1) {
		...
		label228: for (int i_60 = 0; i_60 < i_2; i_60++) {
