public class NPCIndexLoader {
	...
	public NPCDefinitions getNPCDefinitions(int i_1, byte b_2) {
		...
		if (npcdefinitions_3 != null) {
			...
			synchronized (this.aClass317_4839) {
				bytes_10 = this.aClass317_4839.getFile(SharedConfigsType.aClass120_1467.containerId(i_1), SharedConfigsType.aClass120_1467.fileId(i_1));
			}
	...
	static final void method6851(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		IComponentDefinitions icomponentdefinitions_3 = Class117.method1981(i_2, (byte) 27);
		Class96_Sub10.method14605(icomponentdefinitions_3, cs2executor_0, (byte) -34);
	}
