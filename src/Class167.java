public class Class167 {
	...
	Class137_Sub1 method2857(int i_1, int i_2) {
		...
		if (object_3 != null) {
			...
			Class169 class169_4 = this.anInterface22_2043.method144(i_1, -2078681696);
			if (i_2 == -1) {
				i_2 = class169_4.aBool2065 ? 64 : this.aClass505_Sub1_2042.anInt8349;
			}
			...
			class137_sub1_5.method14445(class169_4.aBool2086, class169_4.aBool2059);
