...
public class Class511 {
	...
	static final void method8749(CS2Executor class527, int i) {
		...
		if ((((CS2Executor) class527).intStack[1942118537 * ((CS2Executor) class527).anInt7012]) < (((CS2Executor) class527).intStack[1942118537 * ((CS2Executor) class527).anInt7012 + 1]))
	...
	static final void method8753(CS2Executor class527, byte i) {
		...
		AttributeDefault class437 = Class125.aClass424_1573.get(i_9_, (byte) 0);
	...
	static final void method8754(Class118 class118, Class98 class98, CS2Executor class527, int i) {
		class118.aBool1316 = ((((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 -= 141891001) * 1942118537]) == 1);
	...
	static final void method8756(CS2Executor class527, int i) {
		...
		if (client.aString7426 != null && i_11_ < -1772444859 * Class459.anInt5534)
			((CS2Executor) class527).intStack[((((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1)] = Class467.aClass173Array5575[i_11_].aByte2126;
		else
	...
	static final void method8757(CS2Executor class527, int i) {
		...
		if (null != is)
			i_13_ = is.length;
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = i_13_;
	}
	...
	static final void method8758(CS2Executor class527, int i) {
		...
		AttributeDefault class437 = Class125.aClass424_1573.get(i_15_, (byte) 0);
