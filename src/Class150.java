			...
			if (-1 != (class521_sub1_sub1_sub2.aClass161Array10339[i_4_].anInt2012 * 378836105)) {
				...
				if (class456.method7573(1176831971)) {
					...
					if (class525.aBool6968) {
						...
						} else if (1 == class518.anInt5920 * -1113882773 && (class521_sub1_sub1_sub2.anInt10367 * 41504957) > 0 && ((403949281 * class521_sub1_sub1_sub2.anInt10342) <= -1809259861 * client.cycles) && ((1277328401 * class521_sub1_sub1_sub2.anInt10345) < -1809259861 * client.cycles))
							continue;
					}
				}
