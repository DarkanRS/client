...
public class Class383 implements Interface41 {
	...
	public static AreadSound method6509(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5) {
		if (Class393.preferences.aPreference_Sub13_8225.method12714() != 0 && i_1 != 0 && Class260.SOUNDS_SIZE < 50 && i_0 != -1) {
			AreadSound class268_7 = new AreadSound((byte) 1, i_0, i_1, i_2, i_3, i_4, i_5, (Transform_Sub1) null);
	...
	public static int method6513(int i_0, int i_1, int i_2) {
		if (QuickchatFiller.ENTITY_DEFAULTS.profilingModel == -1) {
			...
			try {
				...
				long long_14 = (long) (i_10 * 1000) / (Utils.time() - long_6);
				Renderers.SOFTWARE_RENDERER.ba(3, 0);
				int i_3 = (int) long_14;
				return i_3;
	...
	static final void method6514(int i_0, int i_1, int i_2) {
		if (MovingAnimation.isInterfaceLoaded(i_0, (int[]) null, -1336109157)) {
			Class151.method2591(CustomCursorsPreference.INTERFACES[i_0].components, i_1, (byte) -17);
		}
	}
