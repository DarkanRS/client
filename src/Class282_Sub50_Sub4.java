	...
	void method14747(RsByteBuffer class282_sub35, int i, byte i_0_) {
		if (249 == i) {
			...
			if (((Class282_Sub50_Sub4) this).aClass465_9518 == null) {
				...
				((Class282_Sub50_Sub4) this).aClass465_9518 = new IterableNodeMap(i_2_);
			}
	...
	void method14754(RsByteBuffer class282_sub35, int i) {
		if (249 == i) {
			...
			if (((Class282_Sub50_Sub4) this).aClass465_9518 == null) {
				...
				((Class282_Sub50_Sub4) this).aClass465_9518 = new IterableNodeMap(i_10_);
			}
	...
	void method14755(RsByteBuffer class282_sub35, int i) {
		if (249 == i) {
			...
			if (((Class282_Sub50_Sub4) this).aClass465_9518 == null) {
				...
				((Class282_Sub50_Sub4) this).aClass465_9518 = new IterableNodeMap(i_14_);
			}
	...
	void method14759(RsByteBuffer class282_sub35, int i) {
		if (249 == i) {
			...
			if (((Class282_Sub50_Sub4) this).aClass465_9518 == null) {
				...
				((Class282_Sub50_Sub4) this).aClass465_9518 = new IterableNodeMap(i_20_);
			}
