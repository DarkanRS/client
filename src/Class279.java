		...
		if (Class182.ITEMS.size() != 0) {
			...
			if (Class393.preferences.currentToolkit.getValue(1853603888) == 0) {
				...
				if (Class182.HARDWARE_RENDERER == null) {
					...
					Class182.aClass8_2259 = Class182.HARDWARE_RENDERER.createFont(Class94.getFontMetrics(IndexLoaders.FONT_METRICS_INDEX, Class16.p11FullIndex, 2062772930), SpriteDefinitions.method1514(IndexLoaders.SPRITES_INDEX, Class16.p11FullIndex), true);
				}
