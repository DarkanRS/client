			...
			if (client.cycles > class521_sub1_sub1_sub3_2.endTime) {
				...
				if (class521_sub1_sub1_sub3_2.entityLockOn > 0) {
					if (client.anInt7341 == 4) {
						Entity animable_3 = Class82.aClass75Array804[class521_sub1_sub1_sub3_2.entityLockOn - 1].method1342((byte) 22);
						if (animable_3 != null) {
							...
							if ((int) vector3_4.x >= 0 && (int) vector3_4.x < IndexLoaders.MAP_REGION_DECODER.getSizeX() * 512 && (int) vector3_4.z >= 0 && (int) vector3_4.z < IndexLoaders.MAP_REGION_DECODER.getSizeY() * 512) {
								class521_sub1_sub1_sub3_2.method15904((int) vector3_4.x, (int) vector3_4.z, Class504.getTerrainHeightAtPos((int) vector3_4.x, (int) vector3_4.z, animable_3.plane, (byte) 107) - class521_sub1_sub1_sub3_2.endHeight, client.cycles);
							}
						}
					} else {
						StringNode class282_sub47_7 = (StringNode) client.NPCS.get((long) (class521_sub1_sub1_sub3_2.entityLockOn - 1));
						if (class282_sub47_7 != null) {
							...
							if ((int) vector3_5.x >= 0 && (int) vector3_5.x < IndexLoaders.MAP_REGION_DECODER.getSizeX() * 512 && (int) vector3_5.z >= 0 && (int) vector3_5.z < IndexLoaders.MAP_REGION_DECODER.getSizeY() * 512) {
								class521_sub1_sub1_sub3_2.method15904((int) vector3_5.x, (int) vector3_5.z, Class504.getTerrainHeightAtPos((int) vector3_5.x, (int) vector3_5.z, class521_sub1_sub1_sub3_2.plane, (byte) 124) - class521_sub1_sub1_sub3_2.endHeight, client.cycles);
							}
						}
					}
				}
				if (class521_sub1_sub1_sub3_2.entityLockOn < 0) {
					...
					if (player_9 != null) {
						...
						if ((int) vector3_5.x >= 0 && (int) vector3_5.x < IndexLoaders.MAP_REGION_DECODER.getSizeX() * 512 && (int) vector3_5.z >= 0 && (int) vector3_5.z < IndexLoaders.MAP_REGION_DECODER.getSizeY() * 512) {
							class521_sub1_sub1_sub3_2.method15904((int) vector3_5.x, (int) vector3_5.z, Class504.getTerrainHeightAtPos((int) vector3_5.x, (int) vector3_5.z, class521_sub1_sub1_sub3_2.plane, (byte) 88) - class521_sub1_sub1_sub3_2.endHeight, client.cycles);
						}
					}
				}
