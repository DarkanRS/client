public class Class57 {
	...
	static final void method1134(CS2Executor cs2executor_0, byte b_1) {
		...
		if (attributedefault_5.method7319(1933175608)) {
			cs2executor_0.stringStack[++cs2executor_0.stringStackPtr - 1] = icomponentdefinitions_3.method1998(i_4, attributedefault_5.typeName, 69406966);
		} else {
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = icomponentdefinitions_3.method1997(i_4, attributedefault_5.defaultInt, 1468810127);
		}
