...
public final class client extends Engine {
	...
	public static Class184 aClass184_7218 = new Class184();
	public static Class184 aClass184_7475 = new Class184();
		...
		if (this.method4665((byte) 80)) {
			...
			for (int i_3 = 0; i_3 < arr_2.length; i_3++) {
				...
				if (string_7 != null) {
					...
					case 1:
						if (string_7 != null) {
							aByteArray7152 = Class378.method6436(Class75.method1353(string_7, -808427320), -634179594);
					...
					case 5:
						...
						Class448.aClass450_5424.aString5433 = string_7;
						break;
					case 6:
					...
					case 7:
						...
						break;
					case 8:
						CURRENT_GAME = IncomingPacket.method6376(Integer.parseInt(string_7), 265812512);
						break;
					case 9:
						if (string_7.equalsIgnoreCase("true")) {
							aBool7310 = true;
					...
					case 14:
						...
						Class448.aClass450_5424.worldId = Integer.parseInt(string_7);
						break;
					case 15:
					...
					case 23:
						...
						break;
					case 24:
						Class90.aClass496_952 = (Class496) Class386.method6672(Class496.method8299(1459523387), Integer.parseInt(string_7), -1573621925);
			...
			this.method4655(class274_6, CURRENT_GAME.aString5748, string_8, i_5, Class123.method2149(957345803), 727, 1, aBool7161, 1114711538);
		}
	...
	static final void method11619() {
		...
		for (int i_3 = 0; i_3 < i_2; i_3++) {
			Object obj_4;
			if (anInt7341 == 4) {
				Class75 class75_5 = Class82.aClass75Array804[i_3];
				if (!class75_5.aBool742) {
					continue;
				}
			...
			int i_7 = ((Animable) obj_4).getSize(828768449);
			...
			IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-2126118936).method3397((Class521_Sub1_Sub1) obj_4, true, -622341859);
		}
	...
	void method11622(int i_1) {
		boolean bool_2 = Class119.JS5_STANDARD_REQUESTER.method5521((byte) 81);
		if (!bool_2) {
			this.method11623(1298538523);
		}

	}

	void method11623(int i_1) {
			...
			if (!player_5.hasAppearance((byte) 123)) {
				...
				if (player_5.aShort9458 >= 0 && player_5.aShort9456 >= 0 && player_5.localX < IndexLoaders.MAP_REGION_DECODER.getSizeX(-1249546922) && player_5.localY < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1946809228)) {
					...
					if (player_5 == Class84.myPlayer) {
						...
						i_8 += 5 - player_5.getSize(828768449) << 2;
	...
	static final void method11628(int i_0) {
		...
		for (int i_6 = 0; i_6 < i_5; i_6++) {
			Object obj_7;
			if (anInt7341 == 4) {
				Class75 class75_8 = Class82.aClass75Array804[i_6];
			...
			int i_17 = ((Animable) obj_7).getSize(828768449);
	...
	static final void method11629(int i_0) {
		...
		for (int i_6 = 0; i_6 < i_5; i_6++) {
			...
			IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-1468321038).method3397((Class521_Sub1_Sub1) obj_7, true, -1200990157);
		}
	...
	static IComponentDefinitions method11634(IComponentDefinitions icomponentdefinitions_0) {
		...
		if (class282_sub10_1.bit23Enabled()) {
			...
			if (i_2 == 0) {
				...
				for (int i_3 = 0; i_3 < i_2; i_3++) {
					icomponentdefinitions_0 = Class96_Sub23.method14682(Class96.method1605(icomponentdefinitions_0.idHash, (byte) -8), icomponentdefinitions_0, -838454718);
	...
	final void method4686() {
		...
		if (Class496.aClass496_5813 == Class90.aClass496_952) {
			...
			Class448.aClass450_5424.anInt5434 = Class448.aClass450_5424.worldId * -1933199413 * -58916693 + 1140744768;
			Class448.aClass450_5420.anInt5437 = (-1441381029 * Class448.aClass450_5420.worldId * -1933199413 + 1250363344) * -1637999045;
			Class448.aClass450_5424.anInt5437 = (Class448.aClass450_5424.worldId * -1933199413 * -1441381029 + 1250363344) * -1637999045;
		} else if (Class496.aClass496_5810 == Class90.aClass496_952) {
			Class448.aClass450_5420.aString5433 = "127.0.0.1";
			Class448.aClass450_5424.aString5433 = "127.0.0.1";
			Class448.aClass450_5420.anInt5434 = -58916693 * Class448.aClass450_5420.worldId * -1933199413 + 1140744768;
			Class448.aClass450_5424.anInt5434 = -58916693 * Class448.aClass450_5424.worldId * -1933199413 + 1140744768;
			Class448.aClass450_5420.anInt5437 = (-1441381029 * Class448.aClass450_5420.worldId * -1933199413 + 1250363344) * -1637999045;
			Class448.aClass450_5424.anInt5437 = (-1441381029 * Class448.aClass450_5424.worldId * -1933199413 + 1250363344) * -1637999045;
		}
	...
	static boolean method11651(IComponentDefinitions icomponentdefinitions_0) {
		...
		return icomponentdefinitions_0.aBool1306;
	}
	...
	static final void method11750() {
		...
		for (int i_0 = 0; i_0 < anInt7211; i_0++) {
			...
			if (npc_1.aBool10318 && npc_1.method15899(1588256325) != -1) {
				...
				Animable animable_6 = Class155.method2640(npc_1.plane, i_4, i_5, 1096362951);
				if (animable_6 != null) {
					int i_7 = animable_6.anInt10314;
					...
					anIntArray7287[anInt7304] = i_7;
					anIntArray7288[anInt7304] = npc_1.anInt10314 + 2048;
					++anInt7304;
					++animable_6.anInt10319;
				}
			}
	...
	public static final void method11768(Interface interface_0, IComponentDefinitions[] arr_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10) {
		for (int i_11 = 0; i_11 < arr_1.length; i_11++) {
			...
			if (icomponentdefinitions_12 != null && i_2 == icomponentdefinitions_12.anInt1305) {
				...
				if (icomponentdefinitions_12.anInt1268 != 0 && !icomponentdefinitions_12.aBool1384 && method11633(icomponentdefinitions_12).settings == 0 && icomponentdefinitions_12 != aClass118_7247 && icomponentdefinitions_12.anInt1290 != IComponentDefinitions.anInt1269 && icomponentdefinitions_12.anInt1290 != IComponentDefinitions.anInt1374 && icomponentdefinitions_12.anInt1290 != IComponentDefinitions.anInt1372 && icomponentdefinitions_12.anInt1290 != IComponentDefinitions.anInt1436) {
					...
					if (icomponentdefinitions_12.aBool1424 || i_15 < i_17 && i_16 < i_18) {
						if (icomponentdefinitions_12.aBool1291 && i_9 >= i_15 && i_10 >= i_16 && i_9 < i_17 && i_10 < i_18) {
						...
						if (!aBool7344 && bool_48) {
							...
							} else if (icomponentdefinitions_12.aBool1291) {
								anInt7427 = -1;
							}
						}

						if (!Class20.aBool161 && bool_48 && !interface_0.aBool999) {
							Class455.method7553(icomponentdefinitions_12, i_9 - i_13, i_10 - i_14, 1085541534);
						}
						...
						if (icomponentdefinitions_12.aBool1424 && !Class521_Sub1_Sub3_Sub1.method16081(16711935)) {
						...
						if (icomponentdefinitions_12.aBool1384 || icomponentdefinitions_12.anInt1290 != 0) {
							...
							if (bool_48 && anInt7191 != 0 && icomponentdefinitions_12.anObjectArray1412 != null) {
								...
								aClass482_7402.append(hookrequest_53, 1731325963);
							}

							if (aClass118_7257 != null) {
								bool_49 = false;
								bool_38 = false;
							} else if (Class20.aBool161 || icomponentdefinitions_12.anInt1290 != IComponentDefinitions.anInt1313 && anInt7184 > 0) {
								bool_49 = false;
								bool_38 = false;
								bool_48 = false;
							}
							...
							if (icomponentdefinitions_12.anInt1290 != 0) {
								...
								if (icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1372 || icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1436) {
									...
									if (icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1372 && !Class20.aBool161 && i_9 >= i_15 && i_10 >= i_16 && i_9 < i_17 && i_10 < i_18) {
										Class521_Sub1_Sub4_Sub1.method16073(Renderers.SOFTWARE_RENDERER, i_9, i_10, -170435576);

										for (Class275_Sub2 class275_sub2_57 = (Class275_Sub2) aClass457_7290.method7659(301908602); class275_sub2_57 != null; class275_sub2_57 = (Class275_Sub2) aClass457_7290.method7650((byte) 102)) {
											if (i_9 >= class275_sub2_57.anInt7742 && i_9 < class275_sub2_57.anInt7744 && i_10 >= class275_sub2_57.anInt7743 && i_10 < class275_sub2_57.anInt7740) {
												HitsplatDefinitions.method3851(-402153223);
												Class463.method7724(class275_sub2_57.aClass521_Sub1_Sub1_Sub2_7739, -196909236);
											}
										}
									}
									...
									for (i_27 = 0; i_27 < i_25; i_27++) {
										...
										if (player_55 != null) {
											Class1.method252(Class397.aClass397_4806, -1, -1, player_55, ints_46[i_27], 1912850737);
								...
								if (icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1269) {
									...
									if (NativeLibraryLoader.anInt3240 == 4) {
										...
										int i_45 = (Class84.myPlayer.getSize(828768449) - 1) * 256;
								...
								if (icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1313) {
									...
									if (bool_49) {
										...
										i_26 = i_24 + Class291.anInt3472 + Class427.anInt5123;
									...
									if (anInt7184 > 0 && !aBool7374) {
										if ((anInt7339 == 1 || JS5GrabWorker.method12562(-1506814013)) && Class20.anInt169 > 2) {
											Class242.method4164(anInt7361, anInt7362, -1135712207);
										} else if (Class216.method3677(116247147)) {
											Class242.method4164(anInt7361, anInt7362, -603230978);
										}
									}
								...
								if (icomponentdefinitions_12.anInt1290 == IComponentDefinitions.anInt1374) {
							...
							if (!icomponentdefinitions_12.aBool1286 && bool_49) {
								...
								if (icomponentdefinitions_12.anObjectArray1386 != null) {
									...
									aClass482_7402.append(hookrequest_53, 2000718310);
								}
							}
							...
							if (icomponentdefinitions_12.anObjectArray1409 != null) {
								...
								aClass482_7233.append(hookrequest_53, 2120828664);
							}
							...
							if (icomponentdefinitions_12.anObjectArray1403 != null && anInt7368 > icomponentdefinitions_12.anInt1446) {
								if (icomponentdefinitions_12.anIntArray1315 != null && anInt7368 - icomponentdefinitions_12.anInt1446 <= 32) {
									label969: for (i_24 = icomponentdefinitions_12.anInt1446; i_24 < anInt7368; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1315.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1315[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, -1583416035);
												break label969;
											}
										}
									}
									...
									aClass482_7402.append(hookrequest_53, 1882589106);
								}
							...
							if (icomponentdefinitions_12.anObjectArray1405 != null && anInt7388 > icomponentdefinitions_12.anInt1447) {
								if (icomponentdefinitions_12.anIntArray1406 != null && anInt7388 - icomponentdefinitions_12.anInt1447 <= 32) {
									label945: for (i_24 = icomponentdefinitions_12.anInt1447; i_24 < anInt7388; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1406.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1406[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, 1083916278);
												break label945;
											}
										}
									}
									...
									aClass482_7402.append(hookrequest_53, -1542519735);
								}
							...
							if (icomponentdefinitions_12.anObjectArray1397 != null && anInt7453 > icomponentdefinitions_12.anInt1443) {
								if (icomponentdefinitions_12.anIntArray1401 != null && anInt7453 - icomponentdefinitions_12.anInt1443 <= 32) {
									label921: for (i_24 = icomponentdefinitions_12.anInt1443; i_24 < anInt7453; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1401.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1401[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, 747112081);
												break label921;
											}
										}
									}
									...
									aClass482_7402.append(hookrequest_53, 2105416157);
								}
							...
							if (icomponentdefinitions_12.anObjectArray1342 != null && anInt7382 > icomponentdefinitions_12.anInt1444) {
								if (icomponentdefinitions_12.anIntArray1398 != null && anInt7382 - icomponentdefinitions_12.anInt1444 <= 32) {
									label897: for (i_24 = icomponentdefinitions_12.anInt1444; i_24 < anInt7382; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1398.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1398[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, -1099284632);
												break label897;
											}
										}
									}
									...
									aClass482_7402.append(hookrequest_53, 24525168);
								}
							...
							if (icomponentdefinitions_12.anObjectArray1387 != null && anInt7384 > icomponentdefinitions_12.anInt1445) {
								if (icomponentdefinitions_12.anIntArray1402 != null && anInt7384 - icomponentdefinitions_12.anInt1445 <= 32) {
									label873: for (i_24 = icomponentdefinitions_12.anInt1445; i_24 < anInt7384; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1402.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1402[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, -587383315);
												break label873;
											}
										}
									}
									...
									aClass482_7402.append(hookrequest_53, -1118574570);
								}
									...
									label849: for (i_24 = icomponentdefinitions_12.anInt1448; i_24 < anInt7390; i_24++) {
										...
										for (i_26 = 0; i_26 < icomponentdefinitions_12.anIntArray1408.length; i_26++) {
											if (i_25 == icomponentdefinitions_12.anIntArray1408[i_26]) {
												...
												aClass482_7402.append(hookrequest_54, -591564519);
												break label849;
											}
										}
									}
							...
							if (anInt7391 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1413 != null) {
								...
								aClass482_7402.append(hookrequest_53, -1950466919);
							}
							...
							if (anInt7386 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1415 != null) {
								...
								aClass482_7402.append(hookrequest_53, 375255808);
							}
							...
							if (anInt7179 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1416 != null) {
								...
								aClass482_7402.append(hookrequest_53, 588293762);
							}
							...
							if (anInt7192 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1383 != null) {
								...
								aClass482_7402.append(hookrequest_53, -1230143136);
							}
							...
							if (anInt7395 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1418 != null) {
								...
								aClass482_7402.append(hookrequest_53, -881378125);
							}
							...
							if (anInt7320 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1361 != null) {
								...
								aClass482_7402.append(hookrequest_53, -483889363);
							}
							...
							if (anInt7397 > icomponentdefinitions_12.anInt1442 && icomponentdefinitions_12.anObjectArray1419 != null) {
								...
								aClass482_7402.append(hookrequest_53, -2054972027);
							}
							...
							if (aBool7355 && icomponentdefinitions_12.anObjectArray1353 != null) {
								...
								aClass482_7402.append(hookrequest_53, 993442497);
							}
						}
						...
						if (icomponentdefinitions_12.anInt1268 == 0) {
							...
							if (class282_sub44_58 != null) {
								...
								Class436.method7313(class282_sub44_58, class282_sub44_58.anInt8063, i_15, i_16, i_17, i_18, i_13, i_14, i_9, i_10, (byte) -89);
							}
						}
					}
				}
		...
		if (this.method4665((byte) 92)) {
			...
			for (int i_3 = 0; i_3 < arr_2.length; i_3++) {
				...
				if (string_7 != null) {
					...
					case 1:
						if (string_7 != null) {
							aByteArray7152 = Class378.method6436(Class75.method1353(string_7, -808427320), -1465976305);
							if (aByteArray7152.length < 16) {
								aByteArray7152 = null;
							}
						}
					...
					case 14:
						...
						Class448.aClass450_5424.worldId = Integer.parseInt(string_7) * -1933199413 * -87869981;
						break;
					case 15:
					...
					case 23:
						...
						break;
					case 24:
						Class90.aClass496_952 = (Class496) Class386.method6672(Class496.method8299(1459523387), Integer.parseInt(string_7), -1375315920);
						if (Class496.aClass496_5810 == Class90.aClass496_952) {
							Class90.aClass496_952 = Class496.aClass496_5807;
			...
			this.method4655(class274_6, CURRENT_GAME.aString5748, string_8, i_5, Class123.method2149(957345803), 727, 1, aBool7161, 1826658639);
		}
	...
	final void method4676(byte b_1) {
	...
	final void method12044(short s_1) {
		...
		if (gameState == 0 && !JS5CacheFile.method3360((byte) -61) || gameState == 7 && Class9.anInt106 == 42 || gameState == 3) {
			...
			for (i_2 = 0; i_2 < 100 && Class8_Sub3.method14338(aClass184_7218, (byte) 2); i_2++) {
				;
			}
		}
				...
				if ((b_4 & 0x1) != 0) {
					...
					if ((b_4 & 0x2) != 0 && npc_3.anInt10355 == 0 && Math.random() * 1000.0D < 10.0D) {
						...
						if (i_6 != 0 || i_7 != 0) {
							...
							int i_10 = Class112.findRoute(npc_3.regionBaseX[0], npc_3.regionBaseY[0], i_5, Class190.method3150(i_8, i_9, i_5, i_5, 0, (byte) 55), IndexLoaders.MAP_REGION_DECODER.getClipMap(npc_3.plane, 1801793645), true, walkStepsX, walkStepsY, -22174447);
							if (i_10 > 0) {
								if (i_10 > 9) {
									i_10 = 9;
								}
										...
										if (hookrequest_13 == null) {
											...
											for (Class275_Sub4 class275_sub4_17 = (Class275_Sub4) aClass457_7350.method7659(301908602); class275_sub4_17 != null; class275_sub4_17 = (Class275_Sub4) aClass457_7350.method7650((byte) 99)) {
												if ((long) class275_sub4_17.anInt7838 < Class169.time() / 1000L - 5L) {
													...
													class275_sub4_17.method4887((byte) -82);
												}
											}
		...
		if (this.method4665((byte) 79)) {
			...
			for (int i_3 = 0; i_3 < arr_2.length; i_3++) {
				...
				if (string_7 != null) {
					...
					case 1:
						if (string_7 != null) {
							aByteArray7152 = Class378.method6436(Class75.method1353(string_7, -808427320), -2067601059);
							if (aByteArray7152.length < 16) {
								aByteArray7152 = null;
							}
						}
					...
					case 23:
						...
						break;
					case 24:
						Class90.aClass496_952 = (Class496) Class386.method6672(Class496.method8299(1459523387), Integer.parseInt(string_7), -1989115689);
						if (Class496.aClass496_5810 == Class90.aClass496_952) {
							Class90.aClass496_952 = Class496.aClass496_5807;
			...
			this.method4655(class274_6, CURRENT_GAME.aString5748, string_8, i_5, Class123.method2149(957345803), 727, 1, aBool7161, -187113750);
		}
	...
	static final void method12073(int i_0, int i_1, int i_2) {
		if (Game.stellarDawn != CURRENT_GAME) {
			if (!MapRegion.routeTo(i_0, i_1, false, Class371.method6352(i_0, i_1, 1, 1, -1423689712), 928803696)) {
				MapRegion.routeTo(i_0, i_1, false, Class344.method6115(i_0, i_1, 1, 1, 0, 971339209), 1252373974);
			}
		} else if (!MapRegion.routeTo(i_0, i_1, false, Class344.method6115(i_0, i_1, 1, 1, 0, 971339209), 1016386097)) {
			MapRegion.routeTo(i_0, i_1, false, Class371.method6352(i_0, i_1, 1, 1, -1013496612), 1340706039);
		}
