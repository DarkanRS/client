...
public class Class365 implements Interface3 {
	...
	public static Class365 method6293(RsByteBuffer class282_sub35) {
		...
		int i_6_ = class282_sub35.readInt();
	...
	public static Class365 method6295(RsByteBuffer class282_sub35) {
		...
		int i_27_ = class282_sub35.readInt();
		boolean bool = class282_sub35.readUnsignedByte() == 1;
	...
	public static Class365 method6296(RsByteBuffer class282_sub35) {
		...
		int i_32_ = class282_sub35.readInt();
		int i_33_ = class282_sub35.readInt();
	...
	public static Class365 method6297(RsByteBuffer class282_sub35) {
		...
		int i_39_ = class282_sub35.readInt();
		int i_40_ = class282_sub35.readInt();
		int i_41_ = class282_sub35.readInt();
		boolean bool = class282_sub35.readUnsignedByte() == 1;
			...
			if (bool != bool_43_) {
				if (bool) {
					...
					if (Class393.aClass282_Sub54_4783.aClass468_Sub13_8229.method12714(-1591414492) != 0) {
						Class339.method6047(2, IndexLoaders.MUSIC_INDEX, 1712678171 * Class260.anInt3228, 0, Class393.aClass282_Sub54_4783.aClass468_Sub13_8229.method12714(695261258), false, 500361678);
