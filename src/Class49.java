public class Class49 {
	...
	static void method968() {
		...
		if (anObject482 == null) {
			...
			bytes_1 = class370_sub1_sub1_0.method15431(128, 128, 16);
			anObject482 = JS5Manager.method5493(bytes_1, false, (byte) 97);
		}

		if (anObject477 == null) {
			Class370_Sub2_Sub1 class370_sub2_sub1_2 = new Class370_Sub2_Sub1();
			bytes_1 = class370_sub2_sub1_2.method15442(128, 128, 16);
			anObject477 = JS5Manager.method5493(bytes_1, false, (byte) 80);
		}
	...
	public boolean method969() {
		if (!this.aClass505_Sub2_481.aBool8827) {
			...
			if (this.anInterface1_480 == null) {
				byte[] bytes_1;
				if (anObject483 == null) {
					bytes_1 = Class264.method4782(128, 128, 16, 8, new Class261_Sub1(419684), 4.0F, 4.0F, 16.0F, 0.5F, 0.6F);
					anObject483 = JS5Manager.method5493(bytes_1, false, (byte) 40);
				}

				bytes_1 = Class346.method6154(anObject483, false, (byte) 1);
				...
				this.anInterface1_480 = this.aClass505_Sub2_481.method13962(Class150.aClass150_1949, 128, 128, 16, true, bytes_2);
			}
		...
		if (this.aBool474 || this.aClass505_Sub2_481.method13954(Class150.aClass150_1952, Class76.aClass76_751)) {
			...
			if (!this.aBool474) {
				...
				for (i_2 = 0; i_2 < 16; i_2++) {
					bytes_3 = Class282_Sub17_Sub5.method15410(anObject482, i_2 * 32768, 32768, -232784177);
				...
				for (i_2 = 0; i_2 < 16; i_2++) {
					bytes_3 = Class282_Sub17_Sub5.method15410(anObject477, i_2 * 32768, 32768, -560964822);
					this.anInterface6Array478[i_2] = this.aClass505_Sub2_481.method13957(Class150.aClass150_1952, 128, 128, true, bytes_3);
				}
			} else {
				byte[] bytes_4 = Class346.method6154(anObject482, false, (byte) 1);
				this.anInterface1_475 = this.aClass505_Sub2_481.method13962(Class150.aClass150_1952, 128, 128, 16, true, bytes_4);
				bytes_4 = Class346.method6154(anObject477, false, (byte) 1);
				this.anInterface1_479 = this.aClass505_Sub2_481.method13962(Class150.aClass150_1952, 128, 128, 16, true, bytes_4);
			}
		}
