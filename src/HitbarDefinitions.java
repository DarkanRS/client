public class HitbarDefinitions {
	...
	void method3211(GraphicalRenderer graphicalrenderer_1, byte b_2) {
		...
		if (this.anInt2444 >= 0 && this.aClass290_2437.aClass229_3447.get((long) this.anInt2444) == null && index_3.loadFile(this.anInt2444)) {
		...
		if (this.anInt2445 >= 0 && this.aClass290_2437.aClass229_3447.get((long) this.anInt2445) == null && index_3.loadFile(this.anInt2445)) {
		...
		if (this.anInt2441 >= 0 && this.aClass290_2437.aClass229_3447.get((long) this.anInt2441) == null && index_3.loadFile(this.anInt2441)) {
		...
		if (this.anInt2447 >= 0 && this.aClass290_2437.aClass229_3447.get((long) this.anInt2447) == null && index_3.loadFile(this.anInt2447)) {
		...
		if (IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager() == null) {
			...
			if (bool_7) {
				...
				if (NativeLibraryLoader.anInt3240 == 2) {
					...
					LoadingStage.method6683(Class11.anInt122, Class504.getTerrainHeightAtPos((int) vector3_6.x, (int) vector3_6.z, Class4.anInt35, (byte) 13) - 200, Class266.anInt3289, i_8, i_9, (i_8 >> 3) * 3 + CAMERA_ZOOM << 2, i_3, 1262873702);
					...
					LoadingStage.method6683(Class11.anInt122, Class504.getTerrainHeightAtPos(client.anInt7262, client.anInt7376, Class4.anInt35, (byte) 101) - 200, Class266.anInt3289, i_8, i_9, (i_8 >> 3) * 3 + CAMERA_ZOOM << 2, i_3, 1318646026);
