...
public abstract class Class202 {
	...
	static final void method3338(Class118 class118, Class98 class98, CS2Executor class527, byte i) {
	...
	static final void method3344(CS2Executor class527, int i) {
		class527.intStack[(class527.anInt7012 += 141891001) * 1942118537 - 1] = (client.anInt7162 * 2080273591 == class527.animable.method15794(-592862572)) ? 1 : 0;
	}

	public static final void method3345(String string, int i) {
		if (!string.equals("")) {
			Class184 class184 = Class468_Sub20.method12807(-1721172592);
			Class282_Sub23 class282_sub23 = Class271.method4828(OutgoingPacket.aClass379_4598, class184.aClass432_2283, 595380659);
			class282_sub23.aClass282_Sub35_Sub2_7682.writeByte(Class108.method1846(string, -1127770384));
	...
	static final void method3346(CS2Executor class527, int i) {
		String string = (String) (class527.objectStack[(class527.anInt7000 -= 1476624725) * 1806726141]);
		class527.anInt7012 -= 283782002;
		int i_18_ = (class527.intStack[class527.anInt7012 * 1942118537]);
		int i_19_ = (class527.intStack[1 + class527.anInt7012 * 1942118537]);
		Class414 class414 = Class94.method1588(IndexLoaders.FONT_METRICS_INDEX, i_19_, 0, 1119085558);
		class527.intStack[(class527.anInt7012 += 141891001) * 1942118537 - 1] = class414.method6949(string, i_18_, Class182.aClass160Array2261, 437013959);
	}
}
