...
public abstract class Class521_Sub1_Sub3 extends Class521_Sub1 {
	...
	boolean method13030(GraphicalRenderer class505) {
		Vector3 class385 = method11166().aClass385_3595;
		return (aClass206_7970.aClass201_2600.method3271(aByte7968, ((int) class385.x >> -1928575293 * aClass206_7970.anInt2592), ((int) class385.z >> -1928575293 * aClass206_7970.anInt2592)));
	}
	...
	boolean method13029(byte i) {
		Vector3 class385 = method11166().aClass385_3595;
		return (((SceneObjectManager) aClass206_7970).aBoolArrayArray2651[(((int) class385.x >> -1928575293 * aClass206_7970.anInt2592) - -527863643 * ((SceneObjectManager) aClass206_7970).anInt2628 + ((SceneObjectManager) aClass206_7970).anInt2652 * 1459994833)][(1459994833 * ((SceneObjectManager) aClass206_7970).anInt2652 + (((int) class385.z >> aClass206_7970.anInt2592 * -1928575293) - 1580412859 * ((SceneObjectManager) aClass206_7970).anInt2629))]);
	}
