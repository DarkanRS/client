...
public class Node_Sub8 extends Node {
	...
	int anInt7530;
	GraphicalRenderer_Sub2 aGraphicalRenderer_Sub2_7533;
	...
	void method12175(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, ByteBuffer bytebuffer_7, ByteBuffer bytebuffer_8) {
		long long_9 = -1L;
		int i_11 = i_5 + (i_3 << this.aGround_Sub1_7524.tileScale);
		int i_12 = (i_4 << this.aGround_Sub1_7524.tileScale) + i_6;
		int i_13 = this.aGround_Sub1_7524.averageHeight(i_11, i_12, -2014795016);
		...
		if (long_9 != -1L) {
			this.aClass453_7537.put(new Node_Sub46(s_14), long_9);
		}
		...
		} else if (i_5 == this.aGround_Sub1_7524.tileUnits && i_6 == 0) {
			f_15 = this.aFloatArrayArray7534[i_1 + 1][i_2];
			f_16 = this.aFloatArrayArray7535[i_1 + 1][i_2];
			f_17 = this.aFloatArrayArray7536[i_1 + 1][i_2];
		} else if (i_5 == this.aGround_Sub1_7524.tileUnits && this.aGround_Sub1_7524.tileUnits == i_6) {
		...
		} else if (i_5 == 0 && this.aGround_Sub1_7524.tileUnits == i_6) {
			f_15 = this.aFloatArrayArray7534[i_1][i_2 + 1];
			f_16 = this.aFloatArrayArray7535[i_1][i_2 + 1];
			f_17 = this.aFloatArrayArray7536[i_1][i_2 + 1];
		} else {
			f_18 = (float) i_5 / (float) this.aGround_Sub1_7524.tileUnits;
			f_19 = (float) i_6 / (float) this.aGround_Sub1_7524.tileUnits;
		...
		f_18 = (float) (this.aNode_Sub24_7528.method12368((byte) 56) - i_11);
		f_19 = (float) (this.aNode_Sub24_7528.method12369() - i_13);
		f_20 = (float) (this.aNode_Sub24_7528.method12394(1552154107) - i_12);
		f_21 = (float) Math.sqrt((double) (f_18 * f_18 + f_19 * f_19 + f_20 * f_20));
		f_22 = 1.0F / f_21;
		f_18 *= f_22;
		f_19 *= f_22;
		f_20 *= f_22;
		f_23 = f_21 / (float) this.aNode_Sub24_7528.method12370();
		f_24 = 1.0F - f_23 * f_23;
		if (f_24 < 0.0F) {
			f_24 = 0.0F;
		}
		...
		int i_27 = this.aNode_Sub24_7528.method12371(-2135048903);
		...
		if (this.aGraphicalRenderer_Sub2_7533.anInt8824 == 0) {
	...
	Node_Sub8(GraphicalRenderer_Sub2 class505_sub2_1, HardwareGround class390_sub1_2, Node_Sub24 class282_sub24_3, int[] ints_4) {
		this.aGraphicalRenderer_Sub2_7533 = class505_sub2_1;
		this.aNode_Sub24_7528 = class282_sub24_3;
		this.aGround_Sub1_7524 = class390_sub1_2;
		int i_5 = this.aNode_Sub24_7528.method12370() - (class390_sub1_2.tileUnits >> 1);
		this.anInt7531 = this.aNode_Sub24_7528.method12368((byte) -45) - i_5 >> class390_sub1_2.tileScale;
		this.anInt7527 = this.aNode_Sub24_7528.method12368((byte) 53) + i_5 >> class390_sub1_2.tileScale;
		this.anInt7526 = this.aNode_Sub24_7528.method12394(1835098637) - i_5 >> class390_sub1_2.tileScale;
		this.anInt7529 = this.aNode_Sub24_7528.method12394(2061552360) + i_5 >> class390_sub1_2.tileScale;
		...
		for (i_8 = 0; i_8 <= i_7; i_8++) {
			...
			if (i_9 > 0 && i_9 < this.aGround_Sub1_7524.length - 1) {
				for (i_21 = 0; i_21 <= i_6; i_21++) {
					i_11 = i_21 + this.anInt7531;
					if (i_11 > 0 && i_11 < this.aGround_Sub1_7524.width - 1) {
		...
		if (this.anInt7532 > 0) {
			...
			ByteBuffer bytebuffer_20 = this.aGraphicalRenderer_Sub2_7533.aByteBuffer8838;
			bytebuffer_20.clear();
			...
			this.anInterface32_7523 = this.aGraphicalRenderer_Sub2_7533.method13993(false);
			this.anInterface32_7523.method208(this.anInt7532);
			this.anInterface4_7525 = this.aGraphicalRenderer_Sub2_7533.method13994(false);
			this.anInterface4_7525.method31(this.anInt7530 * 16, 16);
			this.anInterface4_7525.method42(0, bytebuffer_20.position(), this.aGraphicalRenderer_Sub2_7533.aLong8695);
			this.anInterface32_7523.method42(0, bytebuffer_10.position(), this.aGraphicalRenderer_Sub2_7533.aLong8695 + 2097152L);
		} else {
