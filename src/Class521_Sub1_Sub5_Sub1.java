...
public class Class521_Sub1_Sub5_Sub1 extends Class521_Sub1_Sub5 implements SceneObject {
	...
	public void method88(GraphicalRenderer graphicalrenderer_1, int i_2) {
		...
		if (class282_sub50_sub17_4 != null) {
			this.aClass206_7970.method3427(class282_sub50_sub17_4, this.aByte7968, (int) vector3_6.x, (int) vector3_6.z, (boolean[]) null, (byte) -17);
		}

	}

	boolean method12986(int i_1) {
		return this.aClass528_10513 != null ? !this.aClass528_10513.u() : true;
	}
	...
	public void method83(GraphicalRenderer graphicalrenderer_1) {
		...
		if (class282_sub50_sub17_3 != null) {
			this.aClass206_7970.method3426(class282_sub50_sub17_3, this.aByte7968, (int) vector3_5.x, (int) vector3_5.z, (boolean[]) null, (byte) -128);
		}

	}

	MeshRasterizer method16102(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
		if (this.aClass528_10513 != null && graphicalrenderer_1.method8452(this.aClass528_10513.m(), i_2) == 0) {
	...
	Class285 method12989(GraphicalRenderer graphicalrenderer_1) {
		if (this.aClass528_10513 == null) {
			...
			this.aClass528_10513.method11282(matrix44var_2, this.aClass275_Sub5Array7965[0], 0);
			return class285_3;
		}
	}
	...
	public Class200 method12992(GraphicalRenderer graphicalrenderer_1, byte b_2) {
		...
		if (this.aClass200_10519 == null) {
			this.aClass200_10519 = Class275_Sub2.method12505((int) vector3_3.x, (int) vector3_3.y, (int) vector3_3.z, this.method16102(graphicalrenderer_1, 0, 2053058474), (byte) 82);
		}
	...
	void method13016(GraphicalRenderer graphicalrenderer_1, Class521_Sub1 class521_sub1_2, int i_3, int i_4, int i_5, boolean bool_6) {
		if (class521_sub1_2 instanceof Class521_Sub1_Sub5_Sub1) {
			...
			if (this.aClass528_10513 != null && class521_sub1_sub5_sub1_7.aClass528_10513 != null) {
				this.aClass528_10513.method11269(class521_sub1_sub5_sub1_7.aClass528_10513, i_3, i_4, i_5, bool_6);
			}
			...
			if (this.aClass528_10513 != null && class521_sub1_sub1_sub6_8.aClass528_10535 != null) {
				this.aClass528_10513.method11269(class521_sub1_sub1_sub6_8.aClass528_10535, i_3, i_4, i_5, bool_6);
			}
		}
	...
	public void method93(GraphicalRenderer graphicalrenderer_1) {
		...
		Vector3 vector3_5 = this.method11166().aClass385_3595;
		if (class282_sub50_sub17_3 != null) {
			this.aClass206_7970.method3426(class282_sub50_sub17_3, this.aByte7968, (int) vector3_5.x, (int) vector3_5.z, (boolean[]) null, (byte) -90);
		}
	...
	public void method87(GraphicalRenderer graphicalrenderer_1, int i_2) {
		...
		Vector3 vector3_6 = this.method11166().aClass385_3595;
		if (class282_sub50_sub17_4 != null) {
			this.aClass206_7970.method3426(class282_sub50_sub17_4, this.aByte7968, (int) vector3_6.x, (int) vector3_6.z, (boolean[]) null, (byte) -39);
		}
	...
	boolean method13000() {
		return this.aClass528_10513 != null ? this.aClass528_10513.i() : false;
	}
	...
	public void method97(GraphicalRenderer graphicalrenderer_1) {
		...
		Vector3 vector3_5 = this.method11166().aClass385_3595;
		if (class282_sub50_sub17_3 != null) {
			this.aClass206_7970.method3427(class282_sub50_sub17_3, this.aByte7968, (int) vector3_5.x, (int) vector3_5.z, (boolean[]) null, (byte) 23);
		}
	...
	public void method98(GraphicalRenderer graphicalrenderer_1) {
		...
		Vector3 vector3_5 = this.method11166().aClass385_3595;
		if (class282_sub50_sub17_3 != null) {
			this.aClass206_7970.method3427(class282_sub50_sub17_3, this.aByte7968, (int) vector3_5.x, (int) vector3_5.z, (boolean[]) null, (byte) 45);
		}
	...
	public Class521_Sub1_Sub5_Sub1(SceneObjectManager sceneobjectmanager_1, GraphicalRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinitions objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, boolean bool_13) {
		...
		this.aBool10516 = graphicalrenderer_2.method8402() && objectdefinitions_4.aBool5703 && !this.aBool10525 && Class393.aClass282_Sub54_4783.aClass468_Sub2_8205.method12624((byte) -75) != 0;
		int i_14 = 2048;
		if (this.aBool10524) {
			i_14 |= 0x10000;
		}
		...
		if (class452_15 != null) {
			...
			if (this.aBool10524 || objectdefinitions_4.aBool5711) {
				...
				if (objectdefinitions_4.aBool5711) {
					...
					this.aClass528_10513.PA(class341_16.anInt3992, class341_16.anInt3993, class341_16.anInt3994, class341_16.anInt3995);
				}
			}
		}
	...
	Class285 method12990(GraphicalRenderer graphicalrenderer_1, int i_2) {
		if (this.aClass528_10513 == null) {
			...
			this.aClass528_10513.method11282(matrix44var_3, this.aClass275_Sub5Array7965[0], 0);
			return class285_4;
		}
	}
	...
	void method13013(GraphicalRenderer graphicalrenderer_1, Class521_Sub1 class521_sub1_2, int i_3, int i_4, int i_5, boolean bool_6, int i_7) {
		if (class521_sub1_2 instanceof Class521_Sub1_Sub5_Sub1) {
			...
			if (this.aClass528_10513 != null && class521_sub1_sub5_sub1_8.aClass528_10513 != null) {
				this.aClass528_10513.method11269(class521_sub1_sub5_sub1_8.aClass528_10513, i_3, i_4, i_5, bool_6);
			}
		} else if (class521_sub1_2 instanceof Class521_Sub1_Sub1_Sub6) {
			Class521_Sub1_Sub1_Sub6 class521_sub1_sub1_sub6_9 = (Class521_Sub1_Sub1_Sub6) class521_sub1_2;
			if (this.aClass528_10513 != null && class521_sub1_sub1_sub6_9.aClass528_10535 != null) {
				this.aClass528_10513.method11269(class521_sub1_sub1_sub6_9.aClass528_10535, i_3, i_4, i_5, bool_6);
			}
		}
	...
	public Class200 method13019(GraphicalRenderer graphicalrenderer_1) {
		...
		if (this.aClass200_10519 == null) {
			this.aClass200_10519 = Class275_Sub2.method12505((int) vector3_2.x, (int) vector3_2.y, (int) vector3_2.z, this.method16102(graphicalrenderer_1, 0, 1598187689), (byte) -54);
		}
	...
	public Class200 method13018(GraphicalRenderer graphicalrenderer_1) {
		Vector3 vector3_2 = this.method11166().aClass385_3595;
		if (this.aClass200_10519 == null) {
			this.aClass200_10519 = Class275_Sub2.method12505((int) vector3_2.x, (int) vector3_2.y, (int) vector3_2.z, this.method16102(graphicalrenderer_1, 0, -6951740), (byte) -23);
		}
	...
	public Class200 method12993(GraphicalRenderer graphicalrenderer_1) {
		Vector3 vector3_2 = this.method11166().aClass385_3595;
		if (this.aClass200_10519 == null) {
			this.aClass200_10519 = Class275_Sub2.method12505((int) vector3_2.x, (int) vector3_2.y, (int) vector3_2.z, this.method16102(graphicalrenderer_1, 0, 1171214573), (byte) -10);
		}
		...
		if (Class192.ACCOUNT_CREATION_STAGE != null) {
			try {
				...
				if (Class192.ACCOUNT_CREATION_STAGE == Class1.REQUEST) {
					...
					tcpmessage_2.buffer.writeByte(string_5 == null ? 0 : 1);
					if (string_5 != null) {
				...
				if (Class1.RESPONSE == Class192.ACCOUNT_CREATION_STAGE) {
					if (client.aClass184_7218.method3053((byte) -48) == null) {
						...
						if (AccountCreationResponseOpcodes.CONTINUE != Class96_Sub9.RECIEVED_RESPONSE) {
							...
							client.aClass184_7218.aClass432_2295 = new IsaacCipher(ints_8);
