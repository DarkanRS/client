...
public abstract class Preference {
	...
	public static String method7788(long long_0, int i_2, boolean bool_3, int i_4) {
		...
		return i_2 == 3 ? Class450.method7499(long_0, i_2, bool_3, 1558223183) : Integer.toString(i_6 / 10) + i_6 % 10 + "-" + Class407.aStringArrayArray4849[i_2][i_7] + "-" + i_8 + " " + i_9 / 10 + i_9 % 10 + ":" + i_10 / 10 + i_10 % 10;
	}
