...
public final class Class282_Sub31 extends Node {
	...
	public static void method12521(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		...
		if (null == class282_sub31) {
			...
			if (i_0_ >= 0 && i_1_ >= 0 && i_0_ < IndexLoaders.MAP_REGION_DECODER.getSizeX(1828258754) && i_1_ < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1867433891))
	...
	public static void method12522(int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		...
		if (null == class282_sub31) {
			...
			if (i_7_ >= 0 && i_8_ >= 0 && i_7_ < IndexLoaders.MAP_REGION_DECODER.getSizeX(-1446225799) && i_8_ < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1456094608))
	...
	public static void method12523(int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_) {
		...
		if (null == class282_sub31) {
			...
			if (i_14_ >= 0 && i_15_ >= 0 && i_14_ < IndexLoaders.MAP_REGION_DECODER.getSizeX(-114175837) && i_15_ < IndexLoaders.MAP_REGION_DECODER.getSizeY(-649751223))
	...
	static final void method12531(int i, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_) {
		if (i_34_ >= 1 && i_35_ >= 1 && i_34_ <= IndexLoaders.MAP_REGION_DECODER.getSizeX(102217935) - 2 && i_35_ <= IndexLoaders.MAP_REGION_DECODER.getSizeY(-425131356) - 2) {
			int i_40_ = i;
			if (i_40_ < 3 && IndexLoaders.MAP_REGION_DECODER.method4433(33386298).is0x2(i_34_, i_35_, 1618412511))
				i_40_++;
			if (IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-1311100659) != null) {
				IndexLoaders.MAP_REGION_DECODER.method4441(1508379413).method12475(Renderers.SOFTWARE_RENDERER, i, i_33_, i_34_, i_35_, IndexLoaders.MAP_REGION_DECODER.getClipMap(i, 1801793645), -1304522104);
				if (i_36_ >= 0) {
					...
					IndexLoaders.MAP_REGION_DECODER.method4441(1508379413).method12459(Renderers.SOFTWARE_RENDERER, i_40_, i, i_34_, i_35_, i_36_, i_37_, i_38_, IndexLoaders.MAP_REGION_DECODER.getClipMap(i, 1801793645), i_39_, 432184213);
	...
	static final void method12532(int i, int i_42_, int i_43_, int i_44_, int i_45_, int i_46_, int i_47_, int i_48_) {
		if (i_43_ >= 1 && i_44_ >= 1 && i_43_ <= IndexLoaders.MAP_REGION_DECODER.getSizeX(-178663700) - 2 && i_44_ <= IndexLoaders.MAP_REGION_DECODER.getSizeY(-778221763) - 2) {
			int i_49_ = i;
			if (i_49_ < 3 && IndexLoaders.MAP_REGION_DECODER.method4433(33386298).is0x2(i_43_, i_44_, 1424305959))
				i_49_++;
			if (IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-891625715) != null) {
				IndexLoaders.MAP_REGION_DECODER.method4441(1508379413).method12475(Renderers.SOFTWARE_RENDERER, i, i_42_, i_43_, i_44_, IndexLoaders.MAP_REGION_DECODER.getClipMap(i, 1801793645), -1755317099);
				if (i_45_ >= 0) {
					...
					IndexLoaders.MAP_REGION_DECODER.method4441(1508379413).method12459(Renderers.SOFTWARE_RENDERER, i_49_, i, i_43_, i_44_, i_45_, i_46_, i_47_, IndexLoaders.MAP_REGION_DECODER.getClipMap(i, 1801793645), i_48_, 1321227047);
	...
	static final void method12533(int i, int i_51_, int i_52_, int i_53_, Class476 class476) {
		if (i_52_ >= 1 && i_53_ >= 1 && i_52_ <= IndexLoaders.MAP_REGION_DECODER.getSizeX(252007102) - 2 && i_53_ <= IndexLoaders.MAP_REGION_DECODER.getSizeY(-1924152420) - 2) {
	...
	static final void method12534(int i, int i_54_, int i_55_, int i_56_, Class476 class476) {
		if (i_55_ >= 1 && i_56_ >= 1 && i_55_ <= IndexLoaders.MAP_REGION_DECODER.getSizeX(-430984955) - 2 && i_56_ <= IndexLoaders.MAP_REGION_DECODER.getSizeY(-1449205692) - 2) {
