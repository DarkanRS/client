public class MapAreaDefinitions {
    ...
    public boolean method3719(VarProvider interface42_1, int i_2) {
        int i_3;
        if (this.anInt2745 != -1) {
            i_3 = interface42_1.getVar(this.anInt2745);
        } else {
            if (this.anInt2736 == -1) {
                return true;
            }
            i_3 = interface42_1.getVarBit(this.anInt2736);
        }
        if (i_3 >= this.anInt2734 && i_3 <= this.anInt2735) {
            boolean bool_4 = false;
            int i_5;
            if (this.anInt2741 != -1) {
                i_5 = interface42_1.getVar(this.anInt2741);
            } else {
                if (this.anInt2755 == -1) {
                    return true;
                }
                i_5 = interface42_1.getVarBit(this.anInt2755);
            }
