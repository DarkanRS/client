...
public class Class304 implements Interface27 {
	...
	static final void method5408(CS2Executor cs2executor_0, int i_1) {
		...
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = (i_5 << 14) + i_6 + (b_2 << 28);
	}
	...
	public static void method5409(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2, byte b_3) {
		if (icomponentdefinitions_0 != null) {
			...
			Class109.method1858(icomponentdefinitions_0, (byte) 35);
		}
