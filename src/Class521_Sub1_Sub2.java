...
public abstract class Class521_Sub1_Sub2 extends Class521_Sub1 {
	...
	boolean method13033() {
		Vector3 class385 = method11166().aClass385_3595;
		return (((SceneObjectManager) aClass206_7970).aBoolArrayArray2651[(((int) class385.x >> -1928575293 * aClass206_7970.anInt2592) - ((SceneObjectManager) aClass206_7970).anInt2628 * -527863643 + 1459994833 * ((SceneObjectManager) aClass206_7970).anInt2652)][(1459994833 * ((SceneObjectManager) aClass206_7970).anInt2652 + (((int) class385.z >> aClass206_7970.anInt2592 * -1928575293) - ((SceneObjectManager) aClass206_7970).anInt2629 * 1580412859))]);
	}
	...
	final void method13013(GraphicalRenderer class505, Class521_Sub1 class521_sub1, int i, int i_2_, int i_3_, boolean bool, int i_4_) {
		throw new IllegalStateException();
	}
	...
	int method13024(Class282_Sub24[] class282_sub24s) {
		Vector3 class385 = method11166().aClass385_3595;
		return method13004(((int) class385.x >> aClass206_7970.anInt2592 * -1928575293), ((int) class385.z >> -1928575293 * aClass206_7970.anInt2592), class282_sub24s, 868144561);
	}
