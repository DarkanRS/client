	...
	static void method13409(GraphicalRenderer graphicalrenderer_0) {
		...
		if (Class179.anInt2227 > 0) {
			...
			for (int i_6 = Class179.anInt2223; i_6 < i_2 + Class179.anInt2223 && i_6 < Class179.anInt2227; i_6++) {
				String[] arr_7 = Class456_Sub3.method12681(Class13.aStringArray129[i_6], '\b');
				...
				for (int i_9 = 0; i_9 < arr_7.length; i_9++) {
					...
					Class16.aClass8_144.renderText(Class400.method6793(arr_7[i_9]), i_10, 350 - Class179.anInt2230 - 2 - Class16.aClass414_139.anInt4979 - (i_6 - Class179.anInt2223) * Class179.anInt2222, -1, -16777216);
				}
			}
		}
		...
		Class285.aClass8_3394.renderText("--> " + Class400.method6793(Class179.aString2225), 10, 350 - Class288.aClass414_3438.anInt4979 - 1, -1, -16777216);
		if (Class530.aBool7050) {
			i_3 = -1;
			if (client.cycles % 30 > 15) {
				i_3 = 16777215;
			}
			graphicalrenderer_0.method8428(10 + Class288.aClass414_3438.getWidthNoSprites("--> " + Class400.method6793(Class179.aString2225).substring(0, Class179.anInt2220)), 350 - Class288.aClass414_3438.anInt4979 - 11, 12, i_3);
		}
