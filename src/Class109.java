...
public abstract class Class109 {
	...
	static final void method1852(IComponentDefinitions class118, Interface class98, CS2Executor class527, int i) {
		...
		class118.anInt1311 = 1982656085 * (class527.intStack[1942118537 * class527.intStackPtr]);
		...
		class118.anInt1312 = 771324207 * (class527.intStack[1942118537 * class527.intStackPtr + 1]);
	...
	static final void method1853(CS2Executor class527, int i) {
		...
		EnumDefinitions class431 = IndexLoaders.ENUM_LOADER.method7424(i_1_, (byte) 8);
	...
	static final void method1854(CS2Executor class527, int i) {
		...
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = class414.getWidth(string, Class182.aClass160Array2261);
	}

	static final void method1855(CS2Executor class527, int i) {
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = 214125473 * Class440.anInt5357;
	}

	static final void method1856(CS2Executor class527, int i) {
		String string = (String) (class527.objectStack[(class527.anInt7000 -= 1476624725) * 1806726141]);
		if (string != null)
			class527.intStack[((class527.intStackPtr += 141891001) * 1942118537 - 1)] = string.length();
		else
			class527.intStack[((class527.intStackPtr += 141891001) * 1942118537 - 1)] = 0;
	}

	static final void method1857(CS2Executor class527, int i) {
		Class393.aClass282_Sub54_4783.method13511(Class393.aClass282_Sub54_4783.aClass468_Sub8_8219, ((class527.intStack[(class527.intStackPtr -= 141891001) * 1942118537]) != 0) ? 1 : 0, -123995659);
