public class Class222 implements Interface17 {
	...
	static void method3753(CS2Executor cs2executor_0, int i_1) {
		cs2executor_0.intStack[cs2executor_0.intStackPtr - 1] = IndexLoaders.aClass242_4922.method4156(cs2executor_0.intStack[cs2executor_0.intStackPtr - 1], -1396181317).anInt2973;
	}
			...
			if (i_5 >= 1 && i_5 <= Class78.method1386(class413_1, -1795366239)) {
				...
				for (int i_7 = i_3; i_7 < i_4; i_7++) {
					...
					if (JS5Manager.method5491(var_8, 1531464997)) {
						char var_9 = ItemDefaultsLoader.method7080(var_8, -1416509112);
						if (var_9 != 0) {
	...
	static final void method3755(CS2Executor cs2executor_0, byte b_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		WorldMapAreaDefs worldmapareadefs_3 = IndexLoaders.WORLD_MAP_INDEX_LOADER.getWorldMapDefs(i_2, 262031096);
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = worldmapareadefs_3.anInt2722;
	}
