...
public class Class252 implements Interface43 {
	...
	static final void method4323(Class527 class527, byte i) {
		int i_1_ = (((Class527) class527).anIntArray7018[((Class527) class527).anInt7020 * 301123709]);
	...
	static final void method4324(Class527 class527, byte i) {
		((Class527) class527).anIntArray6999[(((Class527) class527).anInt7012 += 141891001) * 1942118537 - 1] = Class393.aClass282_Sub54_4783.aClass468_Sub11_8217.method12699((byte) -9);
	}
	...
	static void method4326(int i, int i_8_, Class118 class118, int i_9_) {
		...
		if (client.aBool7176) {
			...
			i_11_ += 15;
			int i_18_ = Class316.aClass505_3680.za() / 1024;
