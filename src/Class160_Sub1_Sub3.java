public class Class160_Sub1_Sub3 extends Class160_Sub1 {
	...
	Class160_Sub1_Sub3(HardwareRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, boolean bool_7) {
	...
	Class160_Sub1_Sub3(HardwareRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4) {
	...
	public void method2774(int i_1, int i_2, Class455 class455_3, int i_4, int i_5) {
		if (this.aClass505_Sub3_8875.method14408()) {
			...
			if (ints_6 != null) {
				...
				if (i_9 > 0 && i_10 > 0) {
					PacketsDecoder packetsdecoder_29 = (PacketsDecoder) class455_3;
	...
	Class160_Sub1_Sub3(HardwareRenderer hardwarerenderer_1, int i_2, int i_3) {
		...
		if (ints_4 == null) {
			...
			if (i_3 == 0) {
				for (i_5 = 0; i_5 < this.anInt8867; i_5++) {
					...
					i_7 = (i_2 + i_5) * this.aClass505_Sub3_8875.anInt8980 * 299731099 * 444800403 + i_1;
