...
public class Class232 implements Interface17 {
	...
	static final void method3920(int i, int i_12_) {
		...
		if (i_13_ >= 100) {
			...
			int i_16_ = (1236051449 * AnimationDefinitions.anInt5930 - -109692897 * Class424.anInt5029);
			if (i_16_ > 8192)
				i_16_ -= 16384;
			else if (i_16_ < -8192)
				i_16_ += 16384;
			AnimationDefinitions.anInt5930 = (int) ((float) (-109692897 * Class424.anInt5029) + f * (float) i_16_) * 1898253385;
