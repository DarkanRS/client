public class Class282_Sub54 extends Node {
	...
	public Class282_Sub54(RsByteBuffer rsbytebuffer_1, Game game_2, int i_3) {
		...
		this.aClass468_Sub18_8230 = new Class468_Sub18(i_3, this);
	...
	void method13496(RsByteBuffer rsbytebuffer_1, short s_2) {
		if (rsbytebuffer_1 != null && rsbytebuffer_1.buffer != null) {
			...
			if (i_3 < 23) {
				...
				this.aClass468_Sub15_8203 = new Class468_Sub15(rsbytebuffer_1.readUnsignedByte(), this);
				...
				this.aClass468_Sub18_8230 = new Class468_Sub18(this.aClass468_Sub18_8214.method12776(-958077547), this);
				...
				this.aClass468_Sub5_8221 = new Class468_Sub5(rsbytebuffer_1.readUnsignedByte(), this);
				this.aClass468_Sub11_8217 = new Class468_Sub11(rsbytebuffer_1.readUnsignedByte(), this);
				this.aClass468_Sub25_8206 = new Class468_Sub25(rsbytebuffer_1.readUnsignedByte(), this);
				if (i_3 >= 26) {
	...
	void method13497(boolean bool_1, int i_2) {
		...
		if (bool_1 || this.aClass468_Sub15_8203 == null) {
			this.aClass468_Sub15_8203 = new Class468_Sub15(this);
		}
		...
		if (bool_1 || this.aClass468_Sub18_8230 == null) {
			this.aClass468_Sub18_8230 = new Class468_Sub18(this.aClass468_Sub18_8214.method12776(-1125192103), this);
		}
		...
		if (bool_1 || this.aClass468_Sub5_8221 == null) {
			this.aClass468_Sub5_8221 = new Class468_Sub5(this);
		}
		...
		if (bool_1 || this.aClass468_Sub25_8206 == null) {
			this.aClass468_Sub25_8206 = new Class468_Sub25(this);
		}
	...
	public RsByteBuffer method13499(int i_1) {
		...
		rsbytebuffer_2.writeByte(this.aClass468_Sub15_8203.method12739(-118386335));
		...
		rsbytebuffer_2.writeByte(this.aClass468_Sub18_8214.method12776(-120460114));
		...
		rsbytebuffer_2.writeByte(this.aClass468_Sub5_8221.method12651(1040968302));
		rsbytebuffer_2.writeByte(this.aClass468_Sub11_8217.method12699((byte) -71));
		rsbytebuffer_2.writeByte(this.aClass468_Sub25_8206.method12926((byte) -54));
	...
	void method13502(int i_1) {
		...
		this.aClass468_Sub15_8203.method12741(130294314);
		...
		this.aClass468_Sub18_8230.method12773(-1630198990);
		...
		this.aClass468_Sub5_8221.method12648(2102747953);
		this.aClass468_Sub11_8217.method12698((byte) -36);
		this.aClass468_Sub25_8206.method12928((byte) 32);
	...
	public Class282_Sub54(Game game_1, int i_2) {
		...
		this.aClass468_Sub18_8230 = new Class468_Sub18(i_2, this);
		this.method13497(true, 311350524);
	}

	public void method13511(Class468 class468_1, int i_2, int i_3) {
