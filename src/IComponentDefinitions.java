...
public class IComponentDefinitions {
	...
	static SoftCache aClass229_1303;
	...
	public static SoftCache aClass229_1341;
	...
	void readValues(RsByteBuffer buffer, int i) {
		int i_3_ = buffer.readUnsignedByte();
		if (i_3_ == 255)
			i_3_ = -1;
		anInt1268 = buffer.readUnsignedByte() * 720825663;
		if ((anInt1268 * -2131393857 & 0x80) != 0) {
			anInt1268 = (anInt1268 * -2131393857 & 0x7f) * 720825663;
			aString1285 = buffer.readString();
		}
		anInt1290 = buffer.readUnsignedShort() * -799702371;
		anInt1295 = buffer.readShort(2037728736) * 1302798223;
		...
		if (65535 == anInt1305 * 2110532063)
			...
			anInt1305 = (anInt1305 * 2110532063 + (-1952846363 * idHash & ~0xffff)) * 802345503;
		int i_4_ = buffer.readUnsignedByte();
		aBool1306 = (i_4_ & 0x1) != 0;
		if (i_3_ >= 0)
			aBool1291 = (i_4_ & 0x2) != 0;
		if (0 == anInt1268 * -2131393857) {
			anInt1376 = buffer.readUnsignedShort() * -280394239;
			anInt1314 = buffer.readUnsignedShort() * 1004789833;
			if (i_3_ < 0)
				aBool1291 = buffer.readUnsignedByte() == 1;
		}
		if (-2131393857 * anInt1268 == 5) {
			anInt1320 = buffer.readInt() * -1179842371;
			anInt1423 = buffer.readUnsignedShort() * 1700974355;
			int i_5_ = buffer.readUnsignedByte();
			aBool1322 = 0 != (i_5_ & 0x1);
			aBool1327 = (i_5_ & 0x2) != 0;
			anInt1453 = buffer.readUnsignedByte() * 542423029;
			anInt1323 = buffer.readUnsignedByte() * -848451677;
			anInt1324 = buffer.readInt() * 1596298199;
			aBool1325 = buffer.readUnsignedByte() == 1;
			aBool1351 = buffer.readUnsignedByte() == 1;
			anInt1264 = buffer.readInt() * -1774983547;
			if (i_3_ >= 3)
				aBool1328 = buffer.readUnsignedByte() == 1;
		}
		if (anInt1268 * -2131393857 == 6) {
			anInt1329 = 589750077;
			anInt1330 = buffer.readBigSmart() * -636815827;
			...
			if (bool) {
				anInt1441 = buffer.readShort(1994199659) * 304814545;
				anInt1263 = buffer.readShort(2058193743) * -1208146817;
				anInt1385 = buffer.readUnsignedShort() * 1229969471;
				anInt1336 = buffer.readUnsignedShort() * -140036259;
				anInt1337 = buffer.readUnsignedShort() * -906963849;
				anInt1343 = buffer.readUnsignedShort() * -807852535;
			} else if (aBool1332) {
				anInt1441 = buffer.readShort(2112650056) * 304814545;
				anInt1263 = buffer.readShort(2006881425) * -1208146817;
				anInt1304 = buffer.readShort(1610618567) * 560796533;
				anInt1385 = buffer.readUnsignedShort() * 1229969471;
				anInt1336 = buffer.readUnsignedShort() * -140036259;
				anInt1337 = buffer.readUnsignedShort() * -906963849;
				anInt1343 = buffer.readShort(1816488415) * -807852535;
			}
			anInt1321 = buffer.readBigSmart() * 388683695;
			if (aByte1368 != 0)
				anInt1417 = buffer.readUnsignedShort() * 600966773;
			if (aByte1294 != 0)
				anInt1326 = buffer.readUnsignedShort() * 1500041571;
		}
		if (-2131393857 * anInt1268 == 4) {
			anInt1277 = buffer.readBigSmart() * 204895771;
			if (i_3_ >= 2)
			...
			aBool1420 = buffer.readUnsignedByte() == 1;
			anInt1264 = buffer.readInt() * -1774983547;
			anInt1453 = buffer.readUnsignedByte() * 542423029;
			if (i_3_ >= 0)
				anInt1362 = buffer.readUnsignedByte() * -310295877;
		}
		if (-2131393857 * anInt1268 == 3) {
			anInt1264 = buffer.readInt() * -1774983547;
			aBool1316 = buffer.readUnsignedByte() == 1;
			anInt1453 = buffer.readUnsignedByte() * 542423029;
		}
		if (9 == anInt1268 * -2131393857) {
			anInt1377 = buffer.readUnsignedByte() * -1802729151;
			anInt1264 = buffer.readInt() * -1774983547;
			aBool1357 = buffer.readUnsignedByte() == 1;
		}
		int i_7_ = buffer.read24BitUnsignedInteger();
		...
		if (0 != i_8_) {
			...
			for (/**/; 0 != i_8_; i_8_ = buffer.readUnsignedByte()) {
				int i_9_ = (i_8_ >> 4) - 1;
		...
		if (i_13_ > 0) {
			...
			for (int i_15_ = 0; i_15_ < i_13_; i_15_++)
				aStringArray1352[i_15_] = buffer.readString();
		}
		if (i_14_ > 0) {
			...
			anIntArray1284[i_16_] = buffer.readUnsignedShort();
		}
		if (i_14_ > 1) {
			int i_18_ = buffer.readUnsignedByte();
			anIntArray1284[i_18_] = buffer.readUnsignedShort();
		}
		aString1348 = buffer.readString();
		if (aString1348.equals(""))
			aString1348 = null;
		anInt1380 = buffer.readUnsignedByte() * -1380100089;
		anInt1381 = buffer.readUnsignedByte() * -1326599461;
		anInt1382 = buffer.readUnsignedByte() * -1316583121;
		aString1338 = buffer.readString();
		int i_19_ = -1;
		if (Class96_Sub6.method14502(i_7_, 2089806956) != 0) {
			i_19_ = buffer.readUnsignedShort();
			if (65535 == i_19_)
				i_19_ = -1;
			anInt1307 = buffer.readUnsignedShort() * 1860732359;
			if (anInt1307 * 1432202231 == 65535)
				anInt1307 = -1860732359;
			anInt1310 = buffer.readUnsignedShort() * -1006343589;
			if (65535 == -1751206445 * anInt1310)
				anInt1310 = 1006343589;
		}
		if (i_3_ >= 0) {
			anInt1309 = buffer.readUnsignedShort() * -511891533;
		...
		if (i_3_ >= 0) {
			...
			for (int i_21_ = 0; i_21_ < i_20_; i_21_++) {
				int i_22_ = buffer.read24BitUnsignedInteger();
				int i_23_ = buffer.readInt();
				((IComponentDefinitions) this).aClass465_1365.method7765(new Class282_Sub38(i_23_), (long) i_22_);
			}
			int i_24_ = buffer.readUnsignedByte();
			for (int i_25_ = 0; i_25_ < i_24_; i_25_++) {
				int i_26_ = buffer.read24BitUnsignedInteger();
				String string = buffer.readGJString(162017967);
				((IComponentDefinitions) this).aClass465_1365.method7765(new Class282_Sub47(string), (long) i_26_);
			}
		}
		scriptParams = method1990(buffer, 1419316481);
		anObjectArray1390 = method1990(buffer, 1419316481);
		anObjectArray1392 = method1990(buffer, 1419316481);
		anObjectArray1396 = method1990(buffer, 1419316481);
		anObjectArray1400 = method1990(buffer, 1419316481);
		anObjectArray1397 = method1990(buffer, 1419316481);
		anObjectArray1342 = method1990(buffer, 1419316481);
		anObjectArray1387 = method1990(buffer, 1419316481);
		anObjectArray1409 = method1990(buffer, 1419316481);
		params = method1990(buffer, 1419316481);
		if (i_3_ >= 0)
			anObjectArray1393 = method1990(buffer, 1419316481);
		anObjectArray1278 = method1990(buffer, 1419316481);
		anObjectArray1386 = method1990(buffer, 1419316481);
		anObjectArray1319 = method1990(buffer, 1419316481);
		anObjectArray1302 = method1990(buffer, 1419316481);
		anObjectArray1389 = method1990(buffer, 1419316481);
		anObjectArray1451 = method1990(buffer, 1419316481);
		anObjectArray1394 = method1990(buffer, 1419316481);
		anObjectArray1412 = method1990(buffer, 1419316481);
		anObjectArray1403 = method1990(buffer, 1419316481);
		anObjectArray1405 = method1990(buffer, 1419316481);
		anIntArray1401 = method1986(buffer, 1942118537);
		anIntArray1398 = method1986(buffer, 1942118537);
		anIntArray1402 = method1986(buffer, 1942118537);
		anIntArray1315 = method1986(buffer, 1942118537);
		anIntArray1406 = method1986(buffer, 1942118537);
	}
	...
	int[] method1986(RsByteBuffer class282_sub35, int i) {
		...
		for (int i_28_ = 0; i_28_ < i_27_; i_28_++)
			is[i_28_] = class282_sub35.readInt();
		return is;
	}
	...
	public FontMetrics method1989(Class378 class378, Interface35 interface35, int i) {
		FontMetrics class414 = class378.method6415(interface35, 442725395 * anInt1277, -717286606);
	...
	Object[] method1990(RsByteBuffer class282_sub35, int i) {
		...
		for (int i_30_ = 0; i_30_ < i_29_; i_30_++) {
			...
			if (i_31_ == 0)
				objects[i_30_] = new Integer(class282_sub35.readInt());
			else if (i_31_ == 1)
				objects[i_30_] = class282_sub35.readString();
		}
		aBool1384 = true;
		return objects;
	}

	public void method1991(GraphicalRenderer class505, MeshRasterizer class528, Matrix44Var class294, int i, byte i_32_) {
	...
	public int method1997(int i, int i_37_, int i_38_) {
		if (((IComponentDefinitions) this).aClass465_1365 == null)
			return i_37_;
		Class282_Sub38 class282_sub38 = ((Class282_Sub38) ((IComponentDefinitions) this).aClass465_1365.method7754((long) i));
	...
	public void method1999(int i, int i_40_, int i_41_) {
		if (((IComponentDefinitions) this).aClass465_1365 == null) {
			((IComponentDefinitions) this).aClass465_1365 = new IterableNodeMap(16);
			((IComponentDefinitions) this).aClass465_1365.method7765(new Class282_Sub38(i_40_), (long) i);
		} else {
			Class282_Sub38 class282_sub38 = ((Class282_Sub38) ((IComponentDefinitions) this).aClass465_1365.method7754((long) i));
			if (null == class282_sub38)
				((IComponentDefinitions) this).aClass465_1365.method7765(new Class282_Sub38(i_40_), (long) i);
	...
	public void method2000(int i, String string, int i_42_) {
		if (null == ((IComponentDefinitions) this).aClass465_1365) {
			((IComponentDefinitions) this).aClass465_1365 = new IterableNodeMap(16);
	...
	public MeshRasterizer method2002(GraphicalRenderer class505, int i, Class211 class211, Class31 class31, NPCIndexLoader class406, ItemIndexLoader class426, Class523 class523, Interface42 interface42, Class456 class456, PlayerAppearance class238, int i_44_) {
		...
		if (1 == anInt1329 * 2131324949) {
			...
			if (null != ((IComponentDefinitions) this).aShortArray1347) {
				for (int i_46_ = 0; i_46_ < ((IComponentDefinitions) this).aShortArray1347.length; i_46_++) {
					l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinitions) this).aShortArray1347[i_46_]) >> 8)) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinitions) this).aShortArray1347[i_46_])) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinitions) this).aShortArray1331[i_46_]) >> 8)) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinitions) this).aShortArray1331[i_46_])) & 0xffL)];
				}
				i |= 0x4000;
			}
			if (((IComponentDefinitions) this).aShortArray1349 != null) {
				for (int i_47_ = 0; i_47_ < ((IComponentDefinitions) this).aShortArray1349.length; i_47_++) {
					l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinitions) this).aShortArray1349[i_47_]) >> 8)) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinitions) this).aShortArray1349[i_47_])) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinitions) this).aShortArray1317[i_47_]) >> 8)) & 0xffL)];
					l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinitions) this).aShortArray1317[i_47_])) & 0xffL)];
				}
				i |= 0x8000;
			}
			...
			if (null == class528 || class505.method8452(class528.m(), i) != 0) {
				...
				RSMesh class157 = RSMesh.decodeMesh(Class488.MESH_INDEX, -402732635 * anInt1330, 0);
				if (class157 == null) {
					aBool1399 = true;
					return null;
				}
				...
				if (null != ((IComponentDefinitions) this).aShortArray1347) {
					for (int i_49_ = 0; i_49_ < ((IComponentDefinitions) this).aShortArray1347.length; i_49_++)
						class528.X(((IComponentDefinitions) this).aShortArray1347[i_49_], ((IComponentDefinitions) this).aShortArray1331[i_49_]);
				}
				if (((IComponentDefinitions) this).aShortArray1349 != null) {
					for (int i_50_ = 0; i_50_ < ((IComponentDefinitions) this).aShortArray1349.length; i_50_++)
						class528.W(((IComponentDefinitions) this).aShortArray1349[i_50_], ((IComponentDefinitions) this).aShortArray1317[i_50_]);
				}
				aClass229_1341.put(class528, l_48_);
			}
			if (class456 != null) {
	...
	static {
		...
		aClass229_1280 = new SoftCache(3000000, 200);
		aClass229_1303 = new SoftCache(8);
		aClass229_1282 = new SoftCache(4);
		aClass229_1341 = new SoftCache(50);
		aBool1399 = false;
	}
	...
	public void method2007(int i, short i_59_, short i_60_, int i_61_) {
		if (i < 5) {
			if (null == ((IComponentDefinitions) this).aShortArray1347) {
				((IComponentDefinitions) this).aShortArray1347 = new short[5];
				((IComponentDefinitions) this).aShortArray1331 = new short[5];
			}
			((IComponentDefinitions) this).aShortArray1347[i] = i_59_;
			((IComponentDefinitions) this).aShortArray1331[i] = i_60_;
		}
	}
	...
	public void method2013(int i, short i_69_, short i_70_, byte i_71_) {
		if (i < 5) {
			if (((IComponentDefinitions) this).aShortArray1349 == null) {
				((IComponentDefinitions) this).aShortArray1349 = new short[5];
				((IComponentDefinitions) this).aShortArray1317 = new short[5];
			}
			((IComponentDefinitions) this).aShortArray1349[i] = i_69_;
			((IComponentDefinitions) this).aShortArray1317[i] = i_70_;
		}
	}
	...
	public Class119 method2046(GraphicalRenderer class505, int i) {
		long l = ((long) (-1952846363 * idHash) << 32 | (long) (1924549737 * anInt1288) & 0xffffffffL);
		...
		Class91 class91 = Class91.method1522(Class463.SPRITES_INDEX, 985215637 * anInt1320, 0);
		if (null == class91)
			return null;
	...
	public NativeSprite method2048(GraphicalRenderer class505, int i) {
		...
		if (null != class160)
			return class160;
		Class91 class91 = Class91.method1522(Class463.SPRITES_INDEX, anInt1320 * 985215637, 0);
		if (class91 == null) {
			aBool1399 = true;
			return null;
		}
