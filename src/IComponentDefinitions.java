public class IComponentDefinitions {
	...
	void readValues(RsByteBuffer rsbytebuffer_1, int i_2) {
		...
		if (i_3 >= 0) {
			...
			for (i_12 = 0; i_12 < i_11; i_12++) {
				...
				this.aClass465_1365.method7765(new Class282_Sub38(i_14), (long) i_13);
			}
			...
			for (i_13 = 0; i_13 < i_12; i_13++) {
				...
				this.aClass465_1365.method7765(new Class282_Sub47(string_15), (long) i_14);
			}
		}
	...
	static final void method2071(CS2Executor cs2executor_0, int i_1) {
	...
	static final void method2072(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
