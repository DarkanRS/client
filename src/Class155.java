...
public final class Class155 {
	...
	public void method2623(int i, int i_0_) {
		if (((Class155) this).aClass465_1969 == null)
			((Class155) this).aClass465_1969 = new IterableNodeMap(152314627 * ((Class155) this).anInt1968);
	...
	static final void method2636(byte i) {
		int i_15_ = Class197.NUM_PLAYER_INDICES * -963499271;
		int[] is = Class197.PLAYER_INDICES;
		for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
			Player class521_sub1_sub1_sub2_sub1 = client.players[is[i_16_]];
	...
	static Animable method2640(int i, int i_55_, int i_56_, int i_57_) {
		Class293 class293 = (IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-913455840).aClass293ArrayArrayArray2604[i][i_55_][i_56_]);
		if (class293 == null)
			return null;
