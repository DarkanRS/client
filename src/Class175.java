public class Class175 {
	...
	static final void method2959(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intOpValues[cs2executor_0.instrPtr] >> 16;
		int i_3 = cs2executor_0.intOpValues[cs2executor_0.instrPtr] & 0xffff;
		int i_4 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		if (i_4 >= 0 && i_4 <= 5000) {
			cs2executor_0.globalArrayLengths[i_2] = i_4;
			byte b_5 = -1;
			if (i_3 == 105) {
				b_5 = 0;
			}
			...
			for (int i_6 = 0; i_6 < i_4; i_6++) {
				cs2executor_0.globalArrays[i_2][i_6] = b_5;
			}
	...
	static final void method2961(CS2Executor cs2executor_0, int i_1) {
	...
	static final void method2965(CS2Executor cs2executor_0, byte b_1) {
		...
		Class504.method8387(icomponentdefinitions_4, interface_5, cs2executor_0, 2021162647);
	}
