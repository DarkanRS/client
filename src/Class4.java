...
public class Class4 {
	...
	static float method288(float f, float f_0_, float f_1_, float f_2_, float f_3_, float f_4_, int i, int i_5_) {
		...
		for (/**/; f_6_ < 1.1F; f_6_ += 0.1F) {
			...
			if (i_16_ > 0 && i_17_ > 0 && i_16_ < IndexLoaders.MAP_REGION_DECODER.getSizeX(-964294290) && i_17_ < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1282893956)) {
				int i_18_ = Class84.myPlayer.plane;
				if (i_18_ < 3 && ((IndexLoaders.MAP_REGION_DECODER.method4433(33386298).tileMasks[1][i_16_][i_17_]) & 0x2) != 0)
					i_18_++;
	...
	static final void method289(CS2Executor class527, byte i) {
		...
		IComponentDefinitions class118 = Class117.method1981(i_20_, (byte) 125);
	...
	static final void method290(CS2Executor class527, byte i) {
		...
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = 781329827 * class220.anInt2718;
	}

	static final void method291(CS2Executor class527, int i) {
		class527.intStackPtr -= 283782002;
		int i_22_ = (class527.intStack[1942118537 * class527.intStackPtr]);
		int i_23_ = (class527.intStack[1 + 1942118537 * class527.intStackPtr]);
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = (IndexLoaders.QUICK_CHAT_INDEX_LOADER.method5918(i_22_, -1111901377).aCharArray9745[i_23_]);
	}

	static final void method292(CS2Executor class527, int i) {
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = Class393.aClass282_Sub54_4783.aClass468_Sub27_8208.method12952((byte) 83) == 2 ? 1 : 0;
	}
}
