public class Class282_Sub19 extends Node {
	...
	void method12305(short s_1) {
		if (this.aClass505_Sub1_7650.aBool8467) {
			this.aClass282_Sub35_7655.writeShort(s_1);
		} else {
			this.aClass282_Sub35_7655.writeLEShort(s_1, (byte) -40);
		}
	...
	void method12306(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		...
		if ((i_5 & 0x7f) == 0 || (i_6 & 0x7f) == 0) {
			...
			if (node_29 != null) {
				this.method12305(((Class282_Sub46) node_29).aShort8067);
				return;
			}
		}
		...
		if (long_7 != -1L) {
			this.aClass453_7657.put(new Class282_Sub46(s_12), long_7);
		}
		...
		f_16 = (float) (this.aClass282_Sub24_7641.method12368((byte) 74) - i_9);
		f_17 = (float) (this.aClass282_Sub24_7641.method12369() - i_11);
		f_18 = (float) (this.aClass282_Sub24_7641.method12394(2101145954) - i_10);
		f_19 = (float) Math.sqrt((double) (f_16 * f_16 + f_17 * f_17 + f_18 * f_18));
		f_20 = 1.0F / f_19;
		f_16 *= f_20;
		f_17 *= f_20;
		f_18 *= f_20;
		f_21 = f_19 / (float) this.aClass282_Sub24_7641.method12370();
		f_22 = 1.0F - f_21 * f_21;
		if (f_22 < 0.0F) {
			f_22 = 0.0F;
		}
		...
		int i_25 = this.aClass282_Sub24_7641.method12371(-2137671408);
		...
		if (this.aClass505_Sub1_7650.aBool8467) {
			this.aClass282_Sub35_Sub1_7651.method14688((float) i_9);
			this.aClass282_Sub35_Sub1_7651.method14688((float) i_11);
			this.aClass282_Sub35_Sub1_7651.method14688((float) i_10);
		} else {
			this.aClass282_Sub35_Sub1_7651.method14685((float) i_9);
			this.aClass282_Sub35_Sub1_7651.method14685((float) i_11);
			this.aClass282_Sub35_Sub1_7651.method14685((float) i_10);
		}

		this.aClass282_Sub35_Sub1_7651.writeByte(i_26);
		this.aClass282_Sub35_Sub1_7651.writeByte(i_27);
		this.aClass282_Sub35_Sub1_7651.writeByte(i_28);
		this.aClass282_Sub35_Sub1_7651.writeByte(255);
	...
	Class282_Sub19(OpenGLGraphicalRenderer class505_sub1_1, OpenGLGround class390_sub2_2, Class282_Sub24 class282_sub24_3, int[] ints_4) {
		...
		int i_5 = this.aClass282_Sub24_7641.method12370() - (class390_sub2_2.tileUnits >> 1);
		...
		if (this.anInt7640 > 0) {
			...
			this.aClass453_7657 = new HashTable(ImageIndexLoader.nextPowerOfTwo(this.anInt7640, 1055590190));
			i_9 = 0;
			i_8 = 0;
			...
			this.anInterface15_7639 = this.aClass505_Sub1_7650.method13598(this.aClass282_Sub35_7655.buffer, this.aClass282_Sub35_7655.index, false);
		...
		this.aClass282_Sub35_Sub1_7651 = null;
		this.aClass282_Sub35_7655 = null;
			...
			for (int i_5 = this.anInt7644; i_5 <= this.anInt7656; i_5++) {
				for (int i_6 = this.anInt7642; i_6 <= this.anInt7653; i_6++) {
					...
					if (i_7 > -i_3 && i_7 < i_3 && i_8 > -i_3 && i_8 < i_3 && bools_4[i_3 + i_7][i_3 + i_8]) {
						...
						this.aClass505_Sub1_7650.method13611(this.anInterface15_7639, 0, this.anInt7640);
						return;
					}
				}
			}
