public class Class435 {
	...
	public static Class268 method7300(int i_0, int i_1, int i_2, int i_3, boolean bool_4, int i_5) {
		if ((bool_4 ? Class393.preferences.aClass468_Sub13_8227.method12714() : Class393.preferences.aClass468_Sub13_8225.method12714()) != 0 && i_1 != 0 && Class260.anInt3219 < 50 && i_0 != -1) {
				...
				for (int i_5 = 0; i_5 < arr_3[i_4].length; i_5++) {
					...
					if (class293_6 != null) {
						if (class293_6.aClass521_Sub1_Sub3_3499 instanceof SceneObject) {
							((SceneObject) class293_6.aClass521_Sub1_Sub3_3499).method85();
						}

						if (class293_6.aClass521_Sub1_Sub4_3503 instanceof SceneObject) {
							((SceneObject) class293_6.aClass521_Sub1_Sub4_3503).method85();
						}

						if (class293_6.aClass521_Sub1_Sub4_3500 instanceof SceneObject) {
							((SceneObject) class293_6.aClass521_Sub1_Sub4_3500).method85();
						}

						if (class293_6.aClass521_Sub1_Sub5_3505 instanceof SceneObject) {
							((SceneObject) class293_6.aClass521_Sub1_Sub5_3505).method85();
						}

						if (class293_6.aClass521_Sub1_Sub5_3502 instanceof SceneObject) {
							((SceneObject) class293_6.aClass521_Sub1_Sub5_3502).method85();
						}
	...
	static final void method7302(GraphicalRenderer graphicalrenderer_0, Interface22 interface22_1) {
		if (Class291_Sub1.aClass282_Sub50_Sub6_3491 != null) {
			...
			if (Class291_Sub1.anInt8015 == 10) {
				...
				if (Class291_Sub1.aClass282_Sub50_Sub6_3491.method14778(VertexNormal.myPlayer.plane, ((int) vector3_6.x >> 9) + coordgrid_7.x, ((int) vector3_6.z >> 9) + coordgrid_7.y, ints_3, -1889386276)) {
				...
				IndexLoaders.aClass230_147.method3906(256);
				...
				Class494.aClass194_5794 = new Class194(graphicalrenderer_0, 11, Class351.gameCanvas);
				...
				Class521_Sub1_Sub5_Sub1.aClass194_10527 = new Class194(graphicalrenderer_0, 30, Class351.gameCanvas);
	...
	public static String method7303(Class282_Sub50_Sub7 class282_sub50_sub7_0) {
