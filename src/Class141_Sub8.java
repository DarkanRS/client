...
public class Class141_Sub8 extends Class141 {
	...
	void method2399(int i_1, int i_2) {
		if (this.aBool9095) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_10, "time"), (float) (this.aClass505_Sub1_1664.anInt8368 * i_3 % 40000) / 40000.0F);
	...
	Class141_Sub8(OpenGLGraphicalRenderer class505_sub1_1, Class136 class136_2) {
		...
		if (this.aClass136_9093.aClass137_Sub4_1638 != null && this.aClass505_Sub1_1664.aBool8485 && this.aClass505_Sub1_1664.aBool8365) {
			...
			this.aClass128_9092 = Class128.method2174(this.aClass505_Sub1_1664, new Class140[] { class140_3, class140_4 });
	...
	void method2402(boolean bool_1) {
		...
		if (this.aBool9096 && class137_sub2_2 != null) {
			float f_3 = 1.0F + (1.0F - Math.abs(this.aClass505_Sub1_1664.aFloatArray8426[1])) * 2.0F;
			this.aClass505_Sub1_1664.method13610(1);
			this.aClass505_Sub1_1664.method13654(class137_sub2_2);
			this.aClass505_Sub1_1664.method13610(0);
			this.aClass505_Sub1_1664.method13654(this.aClass136_9093.aClass137_Sub4_1638);
			...
			OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_4, "sunDir"), -this.aClass505_Sub1_1664.aFloatArray8426[0], -this.aClass505_Sub1_1664.aFloatArray8426[1], -this.aClass505_Sub1_1664.aFloatArray8426[2]);
			OpenGL.glUniform4f(OpenGL.glGetUniformLocation(i_4, "sunColour"), this.aClass505_Sub1_1664.aFloat8429 * f_3, this.aClass505_Sub1_1664.aFloat8430 * f_3, this.aClass505_Sub1_1664.aFloat8431 * f_3, 1.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_4, "sunExponent"), 64.0F + Math.abs(this.aClass505_Sub1_1664.aFloatArray8426[1]) * 928.0F);
			this.aBool9095 = true;
		}
	...
	void method2396(int i_1, int i_2) {
		if (this.aBool9095) {
			...
			int i_9 = i_2 >> 27 & 0xf;
			int i_10 = this.aClass128_9092.anInt1583;
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_10, "time"), (float) (i_3 * this.aClass505_Sub1_1664.anInt8368 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_10, "scale"), f_4);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_10, "breakWaterDepth"), (float) i_5);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_10, "breakWaterOffset"), f_6);
			OpenGL.glUniform2f(OpenGL.glGetUniformLocation(i_10, "waveIntensity"), f_8, f_7);
