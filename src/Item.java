		...
		if (class119_5 != null) {
			...
			if (Class187.anInt2363 != 2 && Class187.anInt2363 != 5 && CursorDefintions.aNativeSprite_5004 != null) {
				...
				if (NativeLibraryLoader.anInt3240 == 4) {
					...
					Vector3 vector3_22 = VertexNormal.MY_PLAYER.method11166().aClass385_3595;
				...
				int i_19;
				int i_20;
				for (IntNode class282_sub38_15 = (IntNode) Class187.aClass482_2350.head(); class282_sub38_15 != null; class282_sub38_15 = (IntNode) Class187.aClass482_2350.next(1158642483)) {
