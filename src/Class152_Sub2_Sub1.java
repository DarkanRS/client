public class Class152_Sub2_Sub1 extends Class152_Sub2 {
	...
	Interface31 method14242() {
		if (this.anInterface31_10161 == null) {
			Interface22 interface22_1 = this.aClass505_Sub2_10168.anInterface22_5834;
			...
			this.anInterface31_10161 = this.aClass505_Sub2_10168.method14034(i_3, bool_2, anIntArrayArray10170);
		}
	...
	Class152_Sub2_Sub1(Class505_Sub2 class505_sub2_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
		this.aClass505_Sub2_10168 = class505_sub2_1;
		this.anInt10165 = i_4;
		this.anInt10166 = i_5;
		this.anInt10162 = i_6;
		this.anInt10167 = i_7;
