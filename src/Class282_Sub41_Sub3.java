...
public class Class282_Sub41_Sub3 extends Class282_Sub41 {
	...
	void method13362(OggPacket oggpacket_1, int i_2) {
		...
		if (!this.aBool9554) {
			...
			this.aLong9553 = Class169.method2869(1993913659);
	...
	void method13366(OggPacket oggpacket_1) {
		...
		if (!this.aBool9554) {
			...
			this.aLong9553 = Class169.method2869(2102729991) * -3822562485386198145L * 4278118698289560703L;
	...
	void method13363(OggPacket oggpacket_1) {
		...
		if (!this.aBool9554) {
			...
			this.aLong9553 = Class169.method2869(1699656208) * -3822562485386198145L * 4278118698289560703L;
			i_2 = this.aDecoderContext9549.decodePacketIn(oggpacket_1, this.aGranulePos9550);
			if (i_2 < 0) {
				throw new IllegalStateException("" + i_2);
			}
