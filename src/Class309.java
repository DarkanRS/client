...
public class Class309 {
	...
	public boolean method5476(byte i) {
		...
		if (null == this.aClass282_Sub50_Sub11_Sub1_3626) {
			if (this.aClass312_3624.priorityRequestsFull(-1826319794)) {
				return false;
			}
			this.aClass282_Sub50_Sub11_Sub1_3626 = this.aClass312_3624.request(255, 255, (byte) 0, true, (byte) 26);
		}
	...
	public boolean method5477() {
		...
		if (null == this.aClass282_Sub50_Sub11_Sub1_3626) {
			if (this.aClass312_3624.priorityRequestsFull(-546076436)) {
				return false;
			}
			this.aClass282_Sub50_Sub11_Sub1_3626 = this.aClass312_3624.request(255, 255, (byte) 0, true, (byte) 80);
		}
		if (this.aClass282_Sub50_Sub11_Sub1_3626.incomplete) {
			return false;
		}
	...
	public Class309(Js5StandardRequester class312, Js5LocalRequester class313, BigInteger biginteger, BigInteger biginteger_10_) {
		...
		if (!this.aClass312_3624.priorityRequestsFull(-630500434)) {
			this.aClass282_Sub50_Sub11_Sub1_3626 = this.aClass312_3624.request(255, 255, (byte) 0, true, (byte) 58);
		}
	}
	...
	public boolean method5479() {
		...
		if (null == this.aClass282_Sub50_Sub11_Sub1_3626) {
			if (this.aClass312_3624.priorityRequestsFull(-2011599687)) {
				return false;
			}
			this.aClass282_Sub50_Sub11_Sub1_3626 = this.aClass312_3624.request(255, 255, (byte) 0, true, (byte) -12);
		}
		if (this.aClass282_Sub50_Sub11_Sub1_3626.incomplete) {
			return false;
		}
