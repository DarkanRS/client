...
public class Class488 {
	...
	static final String method8210(int i, int i_0_) {
		...
		if (string.length() > 9)
			return new StringBuilder().append(" ").append(Class59.method1163(65408, 619010179)).append(string.substring(0, string.length() - 8)).append(Message.aClass433_5294.translate(Class223.CURRENT_LANGUAGE, -669112098)).append(" (").append(string).append(")").append(Class2.aString20).toString();
		if (string.length() > 6)
			return new StringBuilder().append(" ").append(Class59.method1163(16777215, 619010179)).append(string.substring(0, string.length() - 4)).append(Message.aClass433_5296.translate(Class223.CURRENT_LANGUAGE, -327274264)).append(" (").append(string).append(")").append(Class2.aString20).toString();
