...
public class Class350_Sub2 extends Class350 {
	...
	static void method12571(int i) {
		if (Renderers.SOFTWARE_RENDERER.method8407()) {
			...
			Renderers.SOFTWARE_RENDERER.method8524(Class351.gameCanvas, dimension.width, dimension.height, (byte) -5);
	...
	static final void method12572(CS2Executor class527, int i) {
		...
		if (class282_sub50_sub6 != null) {
			...
			if (bool) {
				class527.intStack[((class527.intStackPtr += 141891001) * 1942118537) - 1] = CS2Runner.anIntArray5900[1];
				class527.intStack[((class527.intStackPtr += 141891001) * 1942118537) - 1] = CS2Runner.anIntArray5900[2];
			} else {
	...
	static final void method12573(CS2Executor class527, short i) {
		if (client.anInt7166 * -1741204137 == 0)
			Class448.aBool5419 = (class527.intStack[(class527.intStackPtr -= 141891001) * 1942118537]) == 1;
	}
}
