...
public class IComponentDefinition {
	...
	public IComponentSettings iComponentSettings;
	...
	void decode(RsByteBuffer class298_sub53, int i) {
		try {
			...
			int settingsHash = class298_sub53.read24BitUnsignedInteger((byte) 8);
			...
			int i_17_ = -1;
			if (Class68.method784(settingsHash, (byte) 111) != 0) {
			...
			iComponentSettings = new IComponentSettings(settingsHash, i_17_);
			if (i_1_ >= 0) {
	...
	public void method1114(GraphicsToolkit class_ra, Class387 class387, Matrix3f class222, int i, int i_28_) {
		try {
	...
	public void method1123(int i, int i_47_) {
		try {
			if (((IComponentDefinition) this).aClass437_1279 != null) {
				Linkable class298 = ((IComponentDefinition) this).aClass437_1279.get((long) i);
				if (class298 != null)
		...
		try {
			...
			if (1 == anInt1184 * 1548853569) {
				...
				if (null == class387 || class_ra.method5017(class387.m(), i) != 0) {
					...
					Model model = Model.method751((RuntimeException_Sub3.aClass243_6310), 572201537 * anInt1151, 0);
					if (null == model) {
						aBoolean1139 = true;
						return null;
					}
					if (model.size < 13)
						model.method755(2);
					class387 = class_ra.method5037(model, i, Class21.anInt275 * 951783317, 64, 768);
	...
	public IComponentDefinition() {
		...
		anInt1217 = 0;
		aBoolean1246 = false;
		iComponentSettings = IComponentSettings.aClass298_Sub38_7415;
		aBoolean1220 = false;
		aString1228 = "";
		anInt1232 = 7527659;
		aClass105_1233 = null;
	...
	static final void method1132(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2057, client.gameConnection.aClass449_330, (byte) 37);
	...
	static final void method1133(ClientScript2 class403, short i) {
		try {
			if (null != Class350.primaryChannel) {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 1;
				((ClientScript2) class403).aClass298_Sub25_5237 = Class350.primaryChannel;
			} else
