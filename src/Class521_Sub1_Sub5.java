...
public abstract class Class521_Sub1_Sub5 extends Class521_Sub1 {
	...
	boolean method12988(GraphicalRenderer class505) {
		...
		return (aClass206_7970.aClass201_2600.method3275(this, aByte7968, ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293), ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293)));
	}

	int method13025(Class282_Sub24[] class282_sub24s) {
		Vector3 class385 = method11166().aClass385_3595;
		int i = ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293);
		int i_0_ = ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293);
		int i_1_ = 0;
	...
	boolean method13029(byte i) {
		Vector3 class385 = method11166().aClass385_3595;
		return (((SceneObjectManager) aClass206_7970).aBoolArrayArray2651[(((SceneObjectManager) aClass206_7970).anInt2652 * 1459994833 + (((int) class385.x >> aClass206_7970.anInt2592 * -1928575293) - -527863643 * ((SceneObjectManager) aClass206_7970).anInt2628))][(1459994833 * ((SceneObjectManager) aClass206_7970).anInt2652 + (((int) class385.z >> aClass206_7970.anInt2592 * -1928575293) - ((SceneObjectManager) aClass206_7970).anInt2629 * 1580412859))]);
	}

	int method13036(Class282_Sub24[] class282_sub24s, int i) {
		Vector3 class385 = method11166().aClass385_3595;
		int i_3_ = ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293);
		int i_4_ = ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293);
		int i_5_ = 0;
	...
	int method13031(Class282_Sub24[] class282_sub24s) {
		Vector3 class385 = method11166().aClass385_3595;
		int i = ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293);
		int i_12_ = ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293);
		int i_13_ = 0;
		if (-527863643 * ((SceneObjectManager) aClass206_7970).anInt2628 == i)
			i_13_++;
		else if (((SceneObjectManager) aClass206_7970).anInt2628 * -527863643 < i)
	...
	int method13024(Class282_Sub24[] class282_sub24s) {
		Vector3 class385 = method11166().aClass385_3595;
		int i = ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293);
		int i_15_ = ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293);
		int i_16_ = 0;
		if (-527863643 * ((SceneObjectManager) aClass206_7970).anInt2628 == i)
			i_16_++;
		else if (((SceneObjectManager) aClass206_7970).anInt2628 * -527863643 < i)
	...
	int method12982(Class282_Sub24[] class282_sub24s) {
		Vector3 class385 = method11166().aClass385_3595;
		int i = ((int) class385.x >> aClass206_7970.anInt2592 * -1928575293);
		int i_18_ = ((int) class385.z >> aClass206_7970.anInt2592 * -1928575293);
		int i_19_ = 0;
		if (-527863643 * ((SceneObjectManager) aClass206_7970).anInt2628 == i)
			i_19_++;
		else if (((SceneObjectManager) aClass206_7970).anInt2628 * -527863643 < i)
