public class Class80 {
	...
	int[] anIntArray788;
	int[] anIntArray796;
	RsByteBuffer aClass282_Sub35_792 = new RsByteBuffer((byte[]) null);

	void method1392(int i_1) {
		int i_2 = this.aClass282_Sub35_792.method13099(2005906318);
	...
	void method1394(byte[] bytes_1) {
		this.aClass282_Sub35_792.buffer = bytes_1;
		this.aClass282_Sub35_792.index = 10;
		int i_2 = this.aClass282_Sub35_792.readUnsignedShort();
		this.anInt785 = this.aClass282_Sub35_792.readUnsignedShort();
		this.anInt790 = 500000;
		this.anIntArray793 = new int[i_2];

		int i_3;
		int i_5;
		for (i_3 = 0; i_3 < i_2; this.aClass282_Sub35_792.index += i_5) {
			int i_4 = this.aClass282_Sub35_792.readInt();
			i_5 = this.aClass282_Sub35_792.readInt();
			if (i_4 == 1297379947) {
				this.anIntArray793[i_3] = this.aClass282_Sub35_792.index;
				++i_3;
			}
		}
	...
	void method1395() {
		this.aClass282_Sub35_792.buffer = null;
	...
	void method1398(int i_1) {
		this.aClass282_Sub35_792.index = this.anIntArray787[i_1];
	}
	...
	void method1400() {
		this.aClass282_Sub35_792.index = -1;
	}
	...
	void method1404(int i_1) {
		this.anIntArray787[i_1] = this.aClass282_Sub35_792.index;
	}
	...
	void method1406(long long_1) {
		...
		for (int i_4 = 0; i_4 < i_3; i_4++) {
			...
			this.aClass282_Sub35_792.index = this.anIntArray793[i_4];
			this.method1392(i_4);
			this.anIntArray787[i_4] = this.aClass282_Sub35_792.index;
		}

	}

	boolean method1409() {
		return this.aClass282_Sub35_792.buffer != null;
	}

	int method1412(int i_1, int i_2) {
		int i_4;
		if (i_2 == 255) {
			int i_7 = this.aClass282_Sub35_792.readUnsignedByte();
			i_4 = this.aClass282_Sub35_792.method13099(-873046353);
			if (i_7 == 47) {
				this.aClass282_Sub35_792.index += i_4;
				return 1;
			} else if (i_7 == 81) {
				int i_5 = this.aClass282_Sub35_792.read24BitUnsignedInteger();
				i_4 -= 3;
			...
			i_4 = i_2;
			if (b_3 >= 1) {
				i_4 = i_2 | this.aClass282_Sub35_792.readUnsignedByte() << 8;
			}

			if (b_3 >= 2) {
				i_4 |= this.aClass282_Sub35_792.readUnsignedByte() << 16;
			}
	...
	int method1423(int i_1) {
		byte b_2 = this.aClass282_Sub35_792.buffer[this.aClass282_Sub35_792.index];
		int i_5;
		if (b_2 < 0) {
			i_5 = b_2 & 0xff;
			this.anIntArray796[i_1] = i_5;
			++this.aClass282_Sub35_792.index;
		} else {
		...
		if (i_5 != 240 && i_5 != 247) {
			...
			int i_3 = this.aClass282_Sub35_792.method13099(57806040);
			if (i_5 == 247 && i_3 > 0) {
				int i_4 = this.aClass282_Sub35_792.buffer[this.aClass282_Sub35_792.index] & 0xff;
			...
			this.aClass282_Sub35_792.index += i_3;
			return 0;
		}
	}
