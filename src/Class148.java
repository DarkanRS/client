public class Class148 {
	...
	public static String method2550(int i_0) {
		...
		if (class282_sub37_2 != null) {
			Class282_Sub41_Sub2 class282_sub41_sub2_3 = class282_sub37_2.aClass278_Sub1_8001.method4935();
	...
	public static RouteStrategy method2551(int i_0, int i_1, SceneObjectType sceneobjecttype_4, int i_5) {
		...
		Class224.aClass225_Sub5_2775.approxDestinationSizeX = 0;
		Class224.aClass225_Sub5_2775.approxDestinationSizeY = 0;
