public class RasterizerFlags {
	...
	static final boolean method2180(int i_0) {
		return (i_0 & 0x21) != 0;
	}

	static final boolean method2181(int i_0) {
		return (i_0 & 0x22) != 0;
	}

	static final boolean method2183(int i_0) {
		return (i_0 & 0x37) != 0;
	}

	static final boolean method2184(int i_0) {
		return (i_0 & 0x34) != 0;
	}

	static final boolean method2185(int i_0) {
		return (i_0 & 0x84080) != 0;
	}

	static final boolean method2186(int i_0) {
		return (i_0 & 0x100100) != 0;
	}

	static final boolean method2188(int i_0) {
		return (i_0 & 0x10) != 0;
	}

	static final boolean method2189(int i_0) {
		return (i_0 & 0x8000) != 0;
	}

	static final boolean method2190(int i_0) {
		return (i_0 & 0xc580) != 0;
	}

	static final boolean method2191(int i_0) {
		return (i_0 & 0x10000) != 0;
	}

	static final boolean method2192(int i_0) {
		return (i_0 & 0x800) != 0;
	}
	...
	static final boolean method2194(int i_0) {
		return (i_0 & 0x800) != 0;
	}

	static final boolean method2195(int i_0) {
		return (i_0 & 0x220) == 544 | (i_0 & 0x18) != 0;
	}

	static final boolean method2196(int i_0) {
		return (i_0 & 0x800) != 0;
	}

	static final boolean method2197(int i_0) {
		return (method2180(i_0) | method2181(i_0) | method2184(i_0)) & method2192(i_0);
	}

	static final boolean method2199(int i_0, int i_1) {
		return !method2194(i_0) ? false : ((i_0 & 0xb000) != 0 | method2185(i_0) | method2186(i_0) ? true : (i_1 & 0x37) == 0 & (method2195(i_0) | method2191(i_0)));
	}

	static final boolean method2200(int i_0, int i_1) {
		return false & method2201(i_0, i_1);
	}
	...
	static final boolean method2204(int i_0, int i_1) {
		return !((i_0 & 0x10000) != 0 | method2195(i_0)) && !method2261(i_0, i_1) ? (i_1 & 0x37) == 0 && method2199(i_0, i_1) : true;
	}
	...
	static final boolean method2211(int i_0, int i_1) {
		return (i_0 & 0x60000) != 0 | method2188(i_0) || method2199(i_0, i_1) || method2283(i_0, i_1);
	}
