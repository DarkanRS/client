public class Class51 implements Interface2 {
    ...
    public boolean method21() {
        boolean bool_1 = true;
        if (!this.aClass317_487.loadCutscene(this.aClass62_485.anInt658 * -2111808237 * -1949174501)) {
            bool_1 = false;
        }
        if (!this.aClass317_486.loadCutscene(this.aClass62_485.anInt658 * -2111808237 * -1949174501)) {
            bool_1 = false;
        }
        return bool_1;
    }
    ...
    public void method16() {
        ...
        this.aClass8_484 = Renderers.SOFTWARE_RENDERER.createFont(fontmetrics_1, SpriteDefinitions.method1534(this.aClass317_487, -1949174501 * this.aClass62_485.anInt658 * -2111808237), true);
    }

    public boolean method10(int i_1) {
        boolean bool_2 = true;
        if (!this.aClass317_487.loadCutscene(this.aClass62_485.anInt658)) {
            bool_2 = false;
        }
        if (!this.aClass317_486.loadCutscene(this.aClass62_485.anInt658)) {
            bool_2 = false;
        }
        return bool_2;
    }
    ...
    public void method22() {
        ...
        this.aClass8_484 = Renderers.SOFTWARE_RENDERER.createFont(fontmetrics_2, SpriteDefinitions.method1534(this.aClass317_487, this.aClass62_485.anInt658), true);
    }
