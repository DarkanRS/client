public class Class136 {
	...
	static void method2348(OpenGLGraphicalRenderer class505_sub1_0) {
		...
		if (anObject1637 == null) {
			...
			bytes_2 = class370_sub1_sub2_1.method15614(128, 128, 16);
			anObject1637 = JS5Manager.method5493(bytes_2, false, (byte) 83);
		}

		if (anObject1627 == null) {
			Class370_Sub2_Sub2 class370_sub2_sub2_3 = new Class370_Sub2_Sub2();
			bytes_2 = class370_sub2_sub2_3.method15617(128, 128, 16);
			anObject1627 = JS5Manager.method5493(bytes_2, false, (byte) 37);
		}

		Class164 class164_4 = class505_sub1_0.aClass164_8363;
		if (class164_4.method2847() && anObject1628 == null) {
			bytes_2 = Class264.method4782(128, 128, 16, 8, new Class261_Sub1(419684), 4.0F, 4.0F, 16.0F, 0.5F, 0.6F);
			anObject1628 = JS5Manager.method5493(bytes_2, false, (byte) 61);
		}
	...
	Class136(OpenGLGraphicalRenderer class505_sub1_1) {
		...
		if (!this.aBool1631) {
			...
			for (i_2 = 0; i_2 < 16; i_2++) {
				bytes_3 = Class282_Sub17_Sub5.method15410(anObject1637, i_2 * 32768, 32768, -1014539390);
			...
			for (i_2 = 0; i_2 < 16; i_2++) {
				bytes_3 = Class282_Sub17_Sub5.method15410(anObject1627, i_2 * 32768, 32768, 675773741);
			...
			byte[] bytes_5 = Class346.method6154(anObject1637, false, (byte) 1);
			this.aClass137_Sub4_1633 = new Class137_Sub4(class505_sub1_1, Class150.aClass150_1952, Class76.aClass76_751, 128, 128, 16, bytes_5, Class150.aClass150_1952);
			bytes_5 = Class346.method6154(anObject1627, false, (byte) 1);
			this.aClass137_Sub4_1636 = new Class137_Sub4(class505_sub1_1, Class150.aClass150_1952, Class76.aClass76_751, 128, 128, 16, bytes_5, Class150.aClass150_1952);
			Class164 class164_6 = class505_sub1_1.aClass164_8363;
			if (class164_6.method2847()) {
				bytes_5 = Class346.method6154(anObject1628, false, (byte) 1);
				this.aClass137_Sub4_1638 = new Class137_Sub4(class505_sub1_1, Class150.aClass150_1949, Class76.aClass76_751, 128, 128, 16);
				Class137_Sub4 class137_sub4_4 = new Class137_Sub4(class505_sub1_1, Class150.aClass150_1948, Class76.aClass76_751, 128, 128, 16, bytes_5, Class150.aClass150_1948);
				if (!class164_6.method2848(this.aClass137_Sub4_1638, class137_sub4_4, 2.0F)) {
