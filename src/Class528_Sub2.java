public class Class528_Sub2 extends MeshRasterizer {
	...
	int method13799(int i_1, short s_2, int i_3) {
		...
		Class169 class169_5 = this.aClass505_Sub3_8638.anInterface22_5834.method144(s_2 & 0xffff, -1944142308);
		...
		if ((i_3 & 0xc580) != 0) {
			if (class528_sub2_2.aClass176Array8582 != null && class528_sub2_2.aClass176Array8582.length >= this.anInt8617) {
				...
				for (i_10 = 0; i_10 < this.anInt8617; i_10++) {
					class528_sub2_1.aClass176Array8582[i_10].method2968(this.aClass176Array8582[i_10], 1574407861);
				}
			} else {
				i_10 = this.anInt8617;
				...
				for (int i_13 = 0; i_13 < this.anInt8617; i_13++) {
					class528_sub2_1.aClass176Array8582[i_13] = this.aClass176Array8582[i_13].method2972(1878824746);
				}
			}
		} else {
	...
	public void method11273(Matrix44Var matrix44var_1) {
		...
		if (this.aClass87Array8615 != null) {
			for (i_3 = 0; i_3 < this.aClass87Array8615.length; i_3++) {
				Class87 class87_4 = this.aClass87Array8615[i_3];
		...
		if (this.aClass172Array8616 != null) {
			for (i_3 = 0; i_3 < this.aClass172Array8616.length; i_3++) {
				Class172 class172_6 = this.aClass172Array8616[i_3];
	...
	final void method13818(boolean bool_1, boolean bool_2, boolean bool_3, int i_4) {
		...
		if (!this.aClass185_8564.aBool2309) {
			...
			if (this.aShortArray8603 != null && this.aShortArray8603[i_4] != -1) {
				...
				this.aClass144_8566.method2425(bool_1, bool_2, bool_3, this.aFloatArray8605[s_5], this.aFloatArray8605[s_6], this.aFloatArray8605[s_7], this.aFloatArray8590[s_5], this.aFloatArray8590[s_6], this.aFloatArray8590[s_7], this.aFloatArray8636[s_5], this.aFloatArray8636[s_6], this.aFloatArray8636[s_7], Class302.method5364(Class335.anIntArray3916[this.anIntArray8592[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_26 * 255.0F, 833509259), Class302.method5364(Class335.anIntArray3916[this.anIntArray8592[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_9 * 255.0F, 833509259), Class302.method5364(Class335.anIntArray3916[this.anIntArray8592[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_10 * 255.0F, 833509259));
			} else {
				this.aClass144_8566.method2425(bool_1, bool_2, bool_3, this.aFloatArray8605[s_5], this.aFloatArray8605[s_6], this.aFloatArray8605[s_7], this.aFloatArray8590[s_5], this.aFloatArray8590[s_6], this.aFloatArray8590[s_7], this.aFloatArray8636[s_5], this.aFloatArray8636[s_6], this.aFloatArray8636[s_7], Class302.method5364(Class335.anIntArray3916[this.anIntArray8592[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_26 * 255.0F, 833509259), Class302.method5364(Class335.anIntArray3916[this.anIntArray8631[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_9 * 255.0F, 833509259), Class302.method5364(Class335.anIntArray3916[this.anIntArray8594[i_4] & 0xffff], this.aClass185_8564.anInt2307, f_10 * 255.0F, 833509259));
			}
		}
	...
	public void W(short s_1, short s_2) {
		if (this.aShortArray8603 != null) {
			if (!this.aBool8640 && s_2 >= 0) {
				Class169 class169_3 = this.aClass505_Sub3_8638.anInterface22_5834.method144(s_2 & 0xffff, -1877330793);
				if (class169_3.aByte2081 != 0 || class169_3.aByte2090 != 0) {
					this.aBool8640 = true;
				}
			}
	...
	public void di(short s_1, short s_2) {
		if (this.aShortArray8603 != null) {
			if (!this.aBool8640 && s_2 >= 0) {
				Class169 class169_3 = this.aClass505_Sub3_8638.anInterface22_5834.method144(s_2 & 0xffff, -2096330622);
				if (class169_3.aByte2081 != 0 || class169_3.aByte2090 != 0) {
					this.aBool8640 = true;
				}
			}
	...
	public void df(short s_1, short s_2) {
		if (this.aShortArray8603 != null) {
			if (!this.aBool8640 && s_2 >= 0) {
				Class169 class169_3 = this.aClass505_Sub3_8638.anInterface22_5834.method144(s_2 & 0xffff, -2091368936);
				if (class169_3.aByte2081 != 0 || class169_3.aByte2090 != 0) {
					this.aBool8640 = true;
				}
			}
	...
	Class528_Sub2(HardwareRenderer hardwarerenderer_1, RSMesh rsmesh_2, int i_3, int i_4, int i_5, int i_6) {
		...
		this.anInt8578 = rsmesh_2.anInt1974;
		this.anInt8579 = rsmesh_2.anInt1999;
		this.anIntArray8580 = rsmesh_2.anIntArray1976;
		this.anIntArray8581 = rsmesh_2.anIntArray2003;
		this.anIntArray8610 = rsmesh_2.anIntArray1978;
		...
		this.aShortArray8604 = rsmesh_2.aShortArray2006;
		...
		for (i_11 = 0; i_11 < this.anInt8586; i_11++) {
			...
			if (rsmesh_2.aClass84Array2009 != null) {
				...
				for (int i_19 = 0; i_19 < rsmesh_2.aClass84Array2009.length; i_19++) {
					Class84 class84_20 = rsmesh_2.aClass84Array2009[i_19];
					if (i_55 == class84_20.anInt809) {
						...
						if (class347_21.anInt4055 != -1) {
							Class169 class169_22 = interface22_7.method144(class347_21.anInt4055, -1996466919);
							if (class169_22.anInt2074 == 2) {
								this.aBool8630 = true;
							}
						}
					}
			...
			if (rsmesh_2.aShortArray1993 != null) {
				s_68 = rsmesh_2.aShortArray1993[i_55];
				if (s_68 != -1) {
					class169_13 = interface22_7.method144(s_68 & 0xffff, -1793423627);
					if ((i_6 & 0x40) != 0 && class169_13.aBool2056) {
						s_68 = -1;
					} else {
						b_16 = class169_13.aByte2064;
						b_17 = class169_13.aByte2076;
					}
				}
			}

			boolean bool_71 = this.aByteArray8602 != null && this.aByteArray8602[i_55] != 0 || class169_13 != null && class169_13.anInt2074 == 2;
		...
		Class159.method2736(longs_53, ints_8, (byte) 8);
		if (rsmesh_2.aClass84Array2009 != null) {
			this.anInt8617 = rsmesh_2.aClass84Array2009.length;
			...
			for (i_11 = 0; i_11 < rsmesh_2.aClass84Array2009.length; i_11++) {
				...
				i_14 = Class335.anIntArray3916[rsmesh_2.aShortArray2006[class84_12.anInt809] & 0xffff] & 0xffffff;
		...
		for (i_64 = 0; i_64 < this.anInt8586; i_64++) {
			...
			s_68 = rsmesh_2.aShortArray1993 == null ? -1 : rsmesh_2.aShortArray1993[i_67];
			...
			if (s_68 != -1) {
				...
				if (b_17 == -1) {
					...
					if (b_58 == 0) {
						...
						byte b_76 = rsmesh_2.aByteArray1990[i_69];
						f_30 = (float) rsmesh_2.anIntArray1992[i_69] / 256.0F;
						if (b_58 == 1) {
							f_31 = (float) rsmesh_2.anIntArray2001[i_69] / 1024.0F;
							...
							f_31 = (float) rsmesh_2.anIntArray1997[i_69] / 256.0F;
							f_32 = (float) rsmesh_2.anIntArray2004[i_69] / 256.0F;
							...
							f_42 = 64.0F / (float) rsmesh_2.anIntArray1989[i_69];
							f_43 = 64.0F / (float) rsmesh_2.anIntArray2000[i_69];
							f_44 = 64.0F / (float) rsmesh_2.anIntArray2001[i_69];
		...
		if (rsmesh_2.aClass84Array2009 != null && (this.anInt8575 & 0x400) != 0) {
		...
		if (rsmesh_2.aShortArray1993 != null) {
			...
			for (i_67 = 0; i_67 < this.anInt8586; i_67++) {
				short s_70 = rsmesh_2.aShortArray1993[i_67];
				if (s_70 != -1) {
					...
					if ((i_6 & 0x40) != 0 && class169_56.aBool2056) {
						...
						bool_65 = true;
						if (class169_56.anInt2074 == 2) {
							this.aBool8630 = true;
						}

						if (class169_56.aByte2081 != 0 || class169_56.aByte2090 != 0) {
							this.aBool8640 = true;
						}
					}
				} else {
