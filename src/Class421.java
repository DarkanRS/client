...
public class Class421 {
	...
	public Class421(Game class486, Language class495, Index class317, boolean bool) {
		...
		((Class421) this).anInt5013 = (((Class421) this).aClass317_5014.filesCount(((SharedConfigsType.aClass120_1473.anInt1521) * -71319279), 1779903880) * 268916055);
		if (bool) {
			...
			for (int i = 0; i < ((Class421) this).anInt5013 * -1814796697; i++) {
				...
				synchronized (((Class421) this).aClass317_5014) {
					is = (((Class421) this).aClass317_5014.getFile(SharedConfigsType.aClass120_1473.anInt1521 * -71319279, i, -1758012491));
				}
