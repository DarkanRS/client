	...
	public static int method12428(int i, int i_0_, boolean bool, boolean bool_1_) {
		...
		for (int i_3_ = 0; i_3_ < ((Class282_Sub30) class282_sub30).anIntArray7710.length; i_3_++) {
			if (((Class282_Sub30) class282_sub30).anIntArray7710[i_3_] >= 0 && (((Class282_Sub30) class282_sub30).anIntArray7710[i_3_] < -1662523091 * Class119.aClass426_1463.maxItemsCount)) {
				...
				int i_4_ = class425.method7099(i_0_, ((Class125.aClass424_1573.get(i_0_, (byte) 0).anInt5337) * -1741480635), -655698445);
				if (bool)
		...
		if (null == class528 || class505.method8452(class528.m(), i_7_) != 0) {
			...
			if (class238 != null) {
				for (int i_21_ = 0; i_21_ < 10; i_21_++) {
					for (int i_22_ = 0; i_22_ < (AbstractQueue_Sub1.skinColors[i_21_]).length; i_22_++) {
						if (class238.colors[i_21_] < (Class366.skinColors[i_21_][i_22_]).length)
							class528.X((AbstractQueue_Sub1.skinColors[i_21_][i_22_]), (Class366.skinColors[i_21_][i_22_][class238.colors[i_21_]]));
					}
				}
			}
		...
		if (null == class528 || class505.method8452(class528.m(), i_66_) != 0) {
			...
			if (class238 != null) {
				for (int i_80_ = 0; i_80_ < 10; i_80_++) {
					for (int i_81_ = 0; i_81_ < (AbstractQueue_Sub1.skinColors[i_80_]).length; i_81_++) {
						if (class238.colors[i_80_] < (Class366.skinColors[i_80_][i_81_]).length)
							class528.X((AbstractQueue_Sub1.skinColors[i_80_][i_81_]), (Class366.skinColors[i_80_][i_81_][class238.colors[i_80_]]));
					}
				}
			}
			if (null != aClass229_7712) {
