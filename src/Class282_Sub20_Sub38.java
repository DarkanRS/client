public class Class282_Sub20_Sub38 extends Class282_Sub20 {
	...
	int[] method12319(int i_1, int i_2) {
		...
		if (this.aClass320_7667.aBool3722) {
			...
			for (int i_5 = 0; i_5 < Class316.anInt3670; i_5++) {
				ints_3[i_5] = this.method15428(Class316.anIntArray3672[i_5], i_4, 847752759) % 4096;
			}
		}
	...
	int method15428(int i_1, int i_2, int i_3) {
		int i_4 = i_2 * 57 + i_1;
		i_4 ^= i_4 << 1;
	...
	public static void method15430(int i_0, int i_1) {
