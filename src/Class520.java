public class Class520 {
	...
	public Class521_Sub1_Sub2_Sub1 method11158(int i_1) {
		...
		if (class282_sub29_2 == null) {
			...
			CoordGrid coordgrid_3 = IndexLoaders.MAP_REGION_DECODER.getCoordGrid(1160023327);
			...
			if (i_4 >= 0 && i_5 >= 0 && i_4 < IndexLoaders.MAP_REGION_DECODER.getSizeX(453899598) && i_5 < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1973666054)) {
				for (Class282_Sub34 class282_sub34_6 = (Class282_Sub34) class282_sub29_2.aClass482_7708.head((byte) 54); class282_sub34_6 != null; class282_sub34_6 = (Class282_Sub34) class282_sub29_2.aClass482_7708.next(184260692)) {
					if (class282_sub34_6.anInt7853 == this.anInt5933) {
						return (Class521_Sub1_Sub2_Sub1) IndexLoaders.MAP_REGION_DECODER.getSceneObjectManager(-1373135935).method3437(this.aClass219_5934.level, i_4, i_5, (short) 3084);
					}
				}
			}
	...
	static int method11163(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2) {
		return !client.method11633(icomponentdefinitions_0).method12178(i_1, (short) -25478) && icomponentdefinitions_0.params == null ? -1 : (icomponentdefinitions_0.anIntArray1284 != null && icomponentdefinitions_0.anIntArray1284.length > i_1 ? icomponentdefinitions_0.anIntArray1284[i_1] : -1);
	}
