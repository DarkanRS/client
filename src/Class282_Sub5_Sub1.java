...
public class Class282_Sub5_Sub1 extends Class282_Sub5 {
	...
	void method12119(int i_1, Class137_Sub1 class137_sub1_2, Class137_Sub1 class137_sub1_3) {
		...
		if (this.aClass137_Sub1Array10028 != null) {
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10032, 699078378);
			...
			for (i_6 = 0; i_4 > 256 || i_5 > 256; i_6++) {
				...
				if (i_6 == 0) {
					...
					this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1Array10028[i_6 - 1]);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(0, 0);
			...
			this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10032, (byte) -99);
			this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1Array10028[i_6 - 1]);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, 1391966255);
			...
			this.aClass505_Sub1_7507.method13654(class137_sub1_2);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, -1066859380);
			this.aClass158_Sub1_Sub4_10031.method15628(0);
			OpenGL.glViewport(0, 0, 256, 256);
		...
		this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1_10038);
		...
		OpenGL.glEnd();
		this.aClass158_Sub1_Sub4_10031.method15628(0);
		this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1_10034);
		...
		this.aClass505_Sub1_7507.method13610(1);
		this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1_10038);
		this.aClass505_Sub1_7507.method13610(0);
		this.aClass505_Sub1_7507.method13654(class137_sub1_2);
	}

	boolean method15445() {
		return this.aClass505_Sub1_7507.aBool8472 && this.aClass505_Sub1_7507.aBool8365 && this.aClass505_Sub1_7507.aBool8312;
	}
	...
	boolean method12136() {
		if (this.aClass505_Sub1_7507.aBool8472 && this.aClass505_Sub1_7507.aBool8365 && this.aClass505_Sub1_7507.aBool8312) {
			this.aClass158_Sub1_Sub4_10031 = new Class158_Sub1_Sub4(this.aClass505_Sub1_7507);
			this.aClass137_Sub1_10038 = new Class137_Sub1(this.aClass505_Sub1_7507, 3553, Class150.aClass150_1949, Class76.aClass76_755, 256, 256);
			...
			if (!this.aClass158_Sub1_Sub4_10031.method13764()) {
				...
				this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10031, (byte) -102);
				this.aClass128_10043 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10042 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10041 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") });
				this.aClass128_10023 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
				...
				label61: while (true) {
					if (i_5 <= 256 && i_6 <= 256) {
						if (this.aClass158_Sub1_Sub4_10032 == null) {
							this.aClass158_Sub1_Sub4_10032 = new Class158_Sub1_Sub4(this.aClass505_Sub1_7507);
						}
						...
						while (true) {
							...
							this.aClass137_Sub1Array10028[i_7++] = new Class137_Sub1(this.aClass505_Sub1_7507, 3553, Class150.aClass150_1949, Class76.aClass76_755, i_5, i_6);
							if (i_5 > 256) {
								i_5 >>= 1;
							}
	...
	void method12121(int i_1) {
		...
		this.aClass505_Sub1_7507.method13610(1);
		this.aClass505_Sub1_7507.method13654((Class137) null);
		this.aClass505_Sub1_7507.method13610(0);
	}
	...
	void method12134(int i_1, Class137_Sub1 class137_sub1_2, Class137_Sub1 class137_sub1_3) {
		...
		int i_5;
		if (this.aClass137_Sub1Array10028 != null) {
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10032, -1687596109);
			...
			this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10032, (byte) -56);
			this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1Array10028[i_6 - 1]);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, -1515907534);
			this.aClass158_Sub1_Sub4_10031.method15628(0);
			OpenGL.glViewport(0, 0, 256, 256);
			int i_7 = this.aClass128_10042.anInt1583;
			OpenGL.glUseProgram(i_7);
			...
			this.aClass505_Sub1_7507.method13654(class137_sub1_2);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, 1393887669);
			this.aClass158_Sub1_Sub4_10031.method15628(0);
			OpenGL.glViewport(0, 0, 256, 256);
			i_4 = this.aClass128_10043.anInt1583;
			OpenGL.glUseProgram(i_4);
		...
		OpenGL.glPopMatrix();
		OpenGL.glMatrixMode(5888);
		this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10031, (byte) -2);
		i_5 = this.aClass128_10041.anInt1583;
		OpenGL.glUseProgram(i_5);
		OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_5, "sceneTex"), 0);
		OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_5, "bloomTex"), 1);
	...
	boolean method12130() {
		if (this.aClass505_Sub1_7507.aBool8472 && this.aClass505_Sub1_7507.aBool8365 && this.aClass505_Sub1_7507.aBool8312) {
			...
			if (!this.aClass158_Sub1_Sub4_10031.method13764()) {
				...
				this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10031, (byte) -78);
				this.aClass128_10043 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10042 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10041 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") });
				this.aClass128_10023 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
	...
	boolean method12131() {
		if (this.aClass505_Sub1_7507.aBool8472 && this.aClass505_Sub1_7507.aBool8365 && this.aClass505_Sub1_7507.aBool8312) {
			...
			if (!this.aClass158_Sub1_Sub4_10031.method13764()) {
				...
				this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10031, (byte) -112);
				this.aClass128_10043 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10042 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") });
				this.aClass128_10041 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") });
				this.aClass128_10023 = Class128.method2174(this.aClass505_Sub1_7507, new Class140[] { Class140.method2393(this.aClass505_Sub1_7507, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") });
	...
	void method12133(int i_1, Class137_Sub1 class137_sub1_2, Class137_Sub1 class137_sub1_3) {
		...
		int i_5;
		if (this.aClass137_Sub1Array10028 != null) {
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10032, 751227201);
			...
			this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10032, (byte) -62);
			this.aClass505_Sub1_7507.method13654(this.aClass137_Sub1Array10028[i_6 - 1]);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, 1797681002);
			this.aClass158_Sub1_Sub4_10031.method15628(0);
			OpenGL.glViewport(0, 0, 256, 256);
			int i_7 = this.aClass128_10042.anInt1583;
			OpenGL.glUseProgram(i_7);
			...
			this.aClass505_Sub1_7507.method13654(class137_sub1_2);
			this.aClass505_Sub1_7507.method8637(this.aClass158_Sub1_Sub4_10031, 1101521833);
			this.aClass158_Sub1_Sub4_10031.method15628(0);
			OpenGL.glViewport(0, 0, 256, 256);
			i_4 = this.aClass128_10043.anInt1583;
			OpenGL.glUseProgram(i_4);
		...
		OpenGL.glPopMatrix();
		OpenGL.glMatrixMode(5888);
		this.aClass505_Sub1_7507.method8416(this.aClass158_Sub1_Sub4_10031, (byte) -14);
		i_5 = this.aClass128_10041.anInt1583;
		OpenGL.glUseProgram(i_5);
		OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_5, "sceneTex"), 0);
		OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_5, "bloomTex"), 1);
