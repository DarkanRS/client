...
public class Class406 {
	...
	public Class409 method6828(int i, byte i_0_) {
		Class409 class409;
		synchronized (((Class406) this).aClass229_4841) {
			class409 = ((Class409) ((Class406) this).aClass229_4841.get((long) i));
		}
		if (null != class409)
			return class409;
		byte[] is;
	...
	public Class406(Game class486, Language class495, boolean bool, Index class317, Index class317_3_) {
		...
		if (((Class406) this).aClass486_4844 == Game.rs)
			((Class406) this).aStringArray4840 = (new String[] { null, null, null, null, null, Message.EXAMINE.translate((((Class406) this).aClass495_4837), -1623078066) });
		else
