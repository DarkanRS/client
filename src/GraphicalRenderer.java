...
public abstract class GraphicalRenderer {
	...
	static final void method8694(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		IComponentDefinitions icomponentdefinitions_3 = Class117.method1981(i_2, (byte) 95);
		Interface interface_4 = Class468_Sub8.aClass98Array7889[i_2 >> 16];
		Class388.method6690(icomponentdefinitions_3, interface_4, cs2executor_0, (byte) 95);
	}
	...
	static final void method8698(CS2Executor cs2executor_0, int i_1) {
		if (Class282_Sub13.aClass61_7587 != null) {
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = 1;
			cs2executor_0.aClass61_7010 = Class282_Sub13.aClass61_7587;
		} else {
	...
	static void method8700(CS2Executor cs2executor_0, byte b_1) {
		int i_2 = cs2executor_0.intStack[cs2executor_0.intStackPtr - 3];
		int i_3 = cs2executor_0.intStack[cs2executor_0.intStackPtr - 2];
		int i_4 = cs2executor_0.intStack[cs2executor_0.intStackPtr - 1];
		cs2executor_0.intStackPtr -= 3;
		if (i_2 > cs2executor_0.globalArrayLengths[i_3]) {
			throw new RuntimeException();
		} else if (i_2 > cs2executor_0.globalArrayLengths[i_4]) {
			throw new RuntimeException();
		} else if (i_3 == i_4) {
			throw new RuntimeException();
		} else {
			Class225_Sub5.method13047(cs2executor_0.globalArrays[i_3], cs2executor_0.globalArrays[i_4], 0, i_2 - 1, (byte) 46);
		}
	}

	static final void method8701(CS2Executor cs2executor_0, byte b_1) {
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = cs2executor_0.aClass61_7010.aBool624 ? 1 : 0;
	}
