...
public class Class356 {
	...
	static final void method6226(CS2Executor class527, byte i) {
		...
		int i_16_ = (class527.intStack[class527.intStackPtr * 1942118537]);
		int i_17_ = (class527.intStack[1942118537 * class527.intStackPtr + 1]);
		if (i_16_ > 700 || i_17_ > 700)
			class527.intStack[((class527.intStackPtr += 141891001) * 1942118537 - 1)] = 256;
		double d = ((Math.random() * (double) (i_17_ + i_16_) - (double) i_16_ + 800.0) / 100.0);
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = (int) (Math.pow(2.0, d) + 0.5);
	}
