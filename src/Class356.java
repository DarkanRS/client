public class Class356 {
	...
	static final void method6224(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		IComponentDefinitions icomponentdefinitions_3 = Class117.method1981(i_2, (byte) 8);
		Interface interface_4 = Class468_Sub8.aClass98Array7889[i_2 >> 16];
		Class158.method2732(icomponentdefinitions_3, interface_4, cs2executor_0, 2144367938);
	}
	...
	static final void method6226(CS2Executor cs2executor_0, byte b_1) {
		cs2executor_0.intStackPtr -= 2;
		int i_2 = cs2executor_0.intStack[cs2executor_0.intStackPtr];
		int i_3 = cs2executor_0.intStack[cs2executor_0.intStackPtr + 1];
		if (i_2 > 700 || i_3 > 700) {
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = 256;
		}

		double d_4 = (Math.random() * (double) (i_3 + i_2) - (double) i_2 + 800.0D) / 100.0D;
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = (int) (Math.pow(2.0D, d_4) + 0.5D);
	}
