public class PulseEvent extends CacheableNode {
	...
	static void setComponentPosition(int component, int x, int y) {
		PulseEvent event = PulseEvent.createPulseEvent(11, (long) component);
		event.immediate();
		event.primary = x;
		event.secondary = y;
	}
	...
	static void method6751(int i_0, int i_1, int i_2) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(1, (long) i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}
	...
	static void rotateComponentSprite(int interfaceHash, int pitch, int roll, int scale) {
		PulseEvent event = PulseEvent.createPulseEvent(8, (long) interfaceHash);
		event.immediate();
		event.primary = pitch;
