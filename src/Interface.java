public class Interface {
	...
	static final void method1624(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		IComponentDefinitions icomponentdefinitions_3 = Class117.method1981(i_2, (byte) 24);
		Interface interface_4 = Class468_Sub8.aClass98Array7889[i_2 >> 16];
		Class17.method569(icomponentdefinitions_3, interface_4, cs2executor_0, -575655435);
	}

	static final void method1625(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		if (client.anInt7434 == 2 && i_2 >= 0 && i_2 < client.anInt7449) {
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = client.aClass6Array7452[i_2].anInt42;
		} else {
	...
	static final void method1627(CS2Executor cs2executor_0, int i_1) {
