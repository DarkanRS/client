...
public class Class8_Sub4 extends FontRenderer {
	...
	void c(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		this.aClass505_Sub2_9321.method13935();
		this.aClass505_Sub2_9321.method13904(1);
		Class47 class47_6 = this.aClass505_Sub2_9321.aClass47_8698;
		class47_6.anInterface6_443 = this.anInterface6_9322;
		class47_6.method937(3, i_4);
		float f_7 = (float) this.aClass505_Sub2_9321.method8523((byte) 120).method2714();
		float f_8 = (float) this.aClass505_Sub2_9321.method8523((byte) 114).method2716();
		class47_6.aClass384_442.method6525(2.0F / f_7, 2.0F / f_8, 1.0F, 1.0F);
		class47_6.aClass384_442.buf[12] = ((float) i_2 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_7 - 1.0F;
		class47_6.aClass384_442.buf[13] = ((float) i_3 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_8 - 1.0F;
		...
		class47_6.aClass70_447 = this.aClass505_Sub2_9321.aClass70_8832;
		class47_6.method936();
	}

	Class8_Sub4(Class505_Sub2 class505_sub2_1, FontMetrics fontmetrics_2, Class91[] arr_3, boolean bool_4) {
		super(class505_sub2_1, fontmetrics_2);
		this.aClass505_Sub2_9321 = class505_sub2_1;
		int i_5 = 0;
		...
		if (bool_4) {
			...
			for (i_8 = 0; i_8 < 256; i_8++) {
				...
				i_10 = class91_23.anInt954;
				int i_11 = class91_23.anInt957;
				i_12 = i_5 * (i_8 % 16);
				i_13 = i_8 / 16 * i_5;
				i_14 = i_12 + i_13 * i_6;
				i_15 = 0;
				...
				if (class91_23.aByteArray961 == null) {
					bytes_16 = class91_23.aByteArray960;
					...
					bytes_16 = class91_23.aByteArray961;
			...
			for (i_8 = 0; i_8 < 256; i_8++) {
				class91_23 = arr_3[i_8];
				int[] ints_24 = class91_23.anIntArray955;
				byte[] bytes_25 = class91_23.aByteArray961;
				byte[] bytes_26 = class91_23.aByteArray960;
		...
		ByteBuffer bytebuffer_30 = this.aClass505_Sub2_9321.aByteBuffer8838;
		bytebuffer_30.clear();
		...
		for (i_10 = 0; i_10 < 256; i_10++) {
			Class91 class91_38 = arr_3[i_10];
			i_12 = class91_38.anInt954;
			i_13 = class91_38.anInt957;
			i_14 = class91_38.anInt959;
			i_15 = class91_38.anInt956;
		...
		this.anInterface4_9320.method42(0, bytebuffer_30.position(), this.aClass505_Sub2_9321.aLong8695);
	...
	void UA(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		...
		class47_6.anInterface6_443 = this.anInterface6_9322;
		class47_6.method937(3, i_4);
		float f_7 = (float) this.aClass505_Sub2_9321.method8523((byte) 111).method2714();
		float f_8 = (float) this.aClass505_Sub2_9321.method8523((byte) 111).method2716();
		class47_6.aClass384_442.method6525(2.0F / f_7, 2.0F / f_8, 1.0F, 1.0F);
		class47_6.aClass384_442.buf[12] = ((float) i_2 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_7 - 1.0F;
		class47_6.aClass384_442.buf[13] = ((float) i_3 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_8 - 1.0F;
		class47_6.aClass384_442.buf[14] = -1.0F;
	...
	void t(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		...
		class47_6.anInterface6_443 = this.anInterface6_9322;
		class47_6.method937(3, i_4);
		float f_7 = (float) this.aClass505_Sub2_9321.method8523((byte) 124).method2714();
		float f_8 = (float) this.aClass505_Sub2_9321.method8523((byte) 115).method2716();
		class47_6.aClass384_442.method6525(2.0F / f_7, 2.0F / f_8, 1.0F, 1.0F);
		class47_6.aClass384_442.buf[12] = ((float) i_2 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_7 - 1.0F;
		class47_6.aClass384_442.buf[13] = ((float) i_3 + this.aClass505_Sub2_9321.method13905()) * 2.0F / f_8 - 1.0F;
		class47_6.aClass384_442.buf[14] = -1.0F;
