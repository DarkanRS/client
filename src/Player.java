public class Player extends Animable {
	...
	public Class155 aClass155_10561 = new Class155(16);
	String prefixTitle;
	String postfixTitle;
	int anInt10545;
	...
	Class285 method13010(GraphicalRenderer graphicalrenderer_1) {
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048, -231081740)) {
			...
			if (class293_6 != null && class293_6.aClass521_Sub1_Sub3_3499 != null) {
				int i_7 = -2023195771 * this.anInt10325 * -374848179 - class293_6.aClass521_Sub1_Sub3_3499.aShort9561;
			...
			if (Class393.aClass282_Sub54_4783.aClass468_Sub28_8212.method12966((byte) -110) == 1) {
				...
				if (renderanimdefs_8.aBool2787 && (-977770149 * this.playerAppearance.anInt2928 * 232890067 == -1 || IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928 * 232890067 * -977770149, (byte) -104).aBool4912)) {
					...
					MeshRasterizer meshrasterizer_11 = Class116.method1969(graphicalrenderer_1, i_5, -35614997 * this.anInt10322 * 2085530051, this.anInt10323 * 884618779 * -1768311789, -628205413 * this.anInt10363 * -1453470317, 1, this.aClass528Array10372[0], 0, 0, 160, 240, (Animation) (class456_sub3_10 != null ? class456_sub3_10 : animation_9), 16711935);
					if (meshrasterizer_11 != null) {
						...
						meshrasterizer_11.method11282(matrix44var_2, this.aClass275_Sub5Array7965[this.aClass528Array10372.length], 0);
					...
					if (class180_25 != null && 1869984395 * class180_25.anInt2242 * -669014749 != -1) {
						...
						if (-379447335 * class180_25.anInt2236 * -860161943 == 1) {
							...
							if (class282_sub47_26 != null) {
								...
								this.method16136(graphicalrenderer_1, matrix44var_2, this.aClass528Array10372[0], (long) i_13, (long) i_14, 1869984395 * class180_25.anInt2242 * -669014749, 92160000L);
							}
						}

						if (class180_25.anInt2236 * -860161943 * -379447335 == 2) {
							Vector3 vector3_27 = Class84.myPlayer.method11166().aClass385_3595;
							...
							long_15 *= long_15;
							this.method16136(graphicalrenderer_1, matrix44var_2, this.aClass528Array10372[0], long_19, long_21, class180_25.anInt2242 * -669014749 * 1869984395, long_15);
						}
						...
						if (-379447335 * class180_25.anInt2236 * -860161943 == 10 && 1505135749 * class180_25.anInt2238 * -1443656627 >= 0 && 1505135749 * class180_25.anInt2238 * -1443656627 < client.players.length) {
							...
							if (player_28 != null) {
								Vector3 vector3_30 = Vector3.method6632(player_28.method11166().aClass385_3595, Class84.myPlayer.method11166().aClass385_3595);
								int i_23 = (int) vector3_30.x;
								i_13 = (int) vector3_30.z;
								this.method16136(graphicalrenderer_1, matrix44var_2, this.aClass528Array10372[0], (long) i_23, (long) i_13, class180_25.anInt2242 * -669014749 * 1869984395, 92160000L);
							}
						}
					}
				}
			...
			if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < this.aClass528Array10372.length) {
				this.method13008(this.aClass528Array10372.length, (byte) -87);
			}
			...
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_2, false, (byte) 79);

			for (i_18 = 0; i_18 < this.aClass528Array10372.length; i_18++) {
				if (this.aClass528Array10372[i_18] != null) {
					this.aClass528Array10372[i_18].method11282(matrix44var_2, this.aClass275_Sub5Array7965[i_18], this == Class84.myPlayer ? 1 : 0);
				}
			}
			...
			for (i_18 = 0; i_18 < this.aClass528Array10372.length; i_18++) {
				if (this.aClass528Array10372[i_18] != null) {
					this.aBool10312 |= this.aClass528Array10372[i_18].i();
				}

				this.aClass528Array10372[i_18] = null;
			}
	...
	void method12991(GraphicalRenderer graphicalrenderer_1, int i_2) {
		if (this.playerAppearance != null && (this.aBool10370 || this.method16133(graphicalrenderer_1, 0, -231081740))) {
			...
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_3, this.aBool10370, (byte) -50);
	...
	void method13023(GraphicalRenderer graphicalrenderer_1) {
		if (this.playerAppearance != null && (this.aBool10370 || this.method16133(graphicalrenderer_1, 0, -231081740))) {
			...
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_2, this.aBool10370, (byte) -26);
	...
	public String method16127(boolean bool_1, int i_2) {
		String str_3 = "";
	...
	public String method16128(boolean bool_1, int i_2) {
	...
	public final void method16129(int i_1, int i_2, byte b_3, int i_4) {
		...
		for (int i_5 = 0; i_5 < this.aClass161Array10339.length; i_5++) {
			if (this.aClass161Array10339[i_5].anInt2012 != -1) {
				SpotAnimDefinitions spotanimdefinitions_6 = IndexLoaders.SPOT_ANIM_INDEX_LOADER.getSpotAnimDefs(this.aClass161Array10339[i_5].anInt2012, (byte) 55);
				if (spotanimdefinitions_6.aBool6968 && spotanimdefinitions_6.animationId != -1 && IndexLoaders.ANIMATION_INDEX_LOADER.getAnimDefs(spotanimdefinitions_6.animationId, (byte) -26).anInt5921 == 1) {
					this.aClass161Array10339[i_5].aClass456_2014.method7567(-1, (short) 8960);
					this.aClass161Array10339[i_5].anInt2012 = -1;
				}
			}
		}
		...
		if (i_1 >= 0 && i_1 < IndexLoaders.MAP_REGION_DECODER.getSizeX(-1727502065) && i_2 >= 0 && i_2 < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1374799853)) {
			if (this.regionBaseX[0] >= 0 && this.regionBaseX[0] < IndexLoaders.MAP_REGION_DECODER.getSizeX(1713910486) && this.regionBaseY[0] >= 0 && this.regionBaseY[0] < IndexLoaders.MAP_REGION_DECODER.getSizeY(-499497479)) {
				if (b_3 == Class249.aClass249_3086.aByte3085) {
					Class512.method8762(this, i_1, i_2, Class249.aClass249_3086.aByte3085, (byte) -86);
				}

				this.method16132(i_1, i_2, b_3, (short) 255);
			} else {
				this.method16130(i_1, i_2, -1457263225);
			}
		} else {
			this.method16130(i_1, i_2, -1637376735);
		}

	}

	public void method16130(int i_1, int i_2, int i_3) {
		this.anInt10355 = 0;
		this.anInt10367 = 0;
		this.anInt10366 = 0;
	...
	public int getSize(int i_1) {
		return this.playerAppearance != null && this.playerAppearance.anInt2928 != -1 ? IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928, (byte) -115).anInt4858 : super.getSize(828768449);
	}
	...
	boolean method12983(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3, int i_4) {
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 131072, -231081740)) {
			Matrix44Var matrix44var_5 = this.method11168();
			boolean bool_6 = false;

			int i_7;
			for (i_7 = 0; i_7 < this.aClass528Array10372.length; i_7++) {
				if (this.aClass528Array10372[i_7] != null && this.aClass528Array10372[i_7].method11270(i_2, i_3, matrix44var_5, true, 0)) {
					bool_6 = true;
					break;
				}
			}
	...
	public final void method16132(int i_1, int i_2, byte b_3, short s_4) {
	...
	boolean method16133(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
		int i_4 = i_2;
		...
		int i_10 = this.aClass19_10359.method578((byte) 2);
		...
		if (Class496.aClass496_5813 != Class90.aClass496_952 && i_13 < 50) {
			int i_14;
		...
		if (meshrasterizer_12 == null) {
			...
			if (i_8 == 0 && i_9 == 0) {
				this.method15895(i_10, this.getSize(828768449) << 9, this.getSize(828768449) << 9, 0, 0, (byte) 1);
			} else {
				this.method15895(i_10, i_8, i_9, renderanimdefs_5.anInt2813, renderanimdefs_5.anInt2790, (byte) 1);
			...
			if (!this.aBool10573) {
				this.method15837(graphicalrenderer_1, renderanimdefs_5, i_4, i_8, i_9, i_10, (byte) 1);
			}
		...
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048, -231081740)) {
			...
			if (Class393.aClass282_Sub54_4783.aClass468_Sub28_8212.method12966((byte) -42) == 1) {
				...
				if (renderanimdefs_8.aBool2787 && (-977770149 * this.playerAppearance.anInt2928 * 232890067 == -1 || IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928 * 232890067 * -977770149, (byte) -47).aBool4912)) {
					...
					if (meshrasterizer_11 != null) {
						if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < 1 + this.aClass528Array10372.length) {
							this.method13008(this.aClass528Array10372.length + 1, (byte) -105);
						}
			...
			matrix44var_2.method5219(0.0F, (float) (-5 - -2023195771 * this.anInt10325 * -374848179), 0.0F);
			if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < this.aClass528Array10372.length) {
				this.method13008(this.aClass528Array10372.length, (byte) -105);
			}
			...
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_2, false, (byte) -1);
	...
	Class285 method12989(GraphicalRenderer graphicalrenderer_1) {
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048, -231081740)) {
			...
			matrix44var_2.method5219(0.0F, (float) (-5 - -2023195771 * this.anInt10325 * -374848179), 0.0F);
			if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < this.aClass528Array10372.length) {
				this.method13008(this.aClass528Array10372.length, (byte) -61);
			}
	...
	void method13012(GraphicalRenderer graphicalrenderer_1) {
		if (this.playerAppearance != null && (this.aBool10370 || this.method16133(graphicalrenderer_1, 0, -231081740))) {
			...
			matrix44var_2.method5210(this.method11166());
			matrix44var_2.method5219(0.0F, -5.0F, 0.0F);
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_2, this.aBool10370, (byte) 12);
	...
	void method16136(GraphicalRenderer graphicalrenderer_1, Matrix44Var matrix44var_2, MeshRasterizer meshrasterizer_3, long long_4, long long_6, int i_8, long long_9) {
		...
		if (long_11 >= 262144L && long_11 <= long_9) {
			int i_13 = (int) (Math.atan2((double) long_4, (double) long_6) * 2607.5945876176133D - (double) this.aClass19_10359.method578((byte) 2)) & 0x3fff;
			MeshRasterizer meshrasterizer_14 = Defaults7Loader.method8752(graphicalrenderer_1, i_13, this.anInt10322, this.anInt10323, this.anInt10363, i_8, -122250887);
			if (meshrasterizer_14 != null) {
				graphicalrenderer_1.RA(false);
				meshrasterizer_14.method11282(matrix44var_2, (Class275_Sub5) null, 0);
				graphicalrenderer_1.RA(true);
			}
		}
	...
	public Class163 method15809() {
		if (this.aClass163_10334 != null) {
			...
			if (-574868913 * client.anInt7416 * 1429316783 == 0 || client.anInt7416 * 1429316783 * -574868913 == 3 || -574868913 * client.anInt7416 * 1429316783 == 1 && Class249.method4282(this.displayName, (byte) 0)) {
	...
	boolean method13020(GraphicalRenderer graphicalrenderer_1, int i_2, int i_3) {
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 131072, -231081740)) {
			...
			for (i_6 = 0; i_6 < this.aClass528Array10372.length; i_6++) {
				if (this.aClass528Array10372[i_6] != null && this.aClass528Array10372[i_6].method11270(i_2, i_3, matrix44var_4, true, 0)) {
					bool_5 = true;
					break;
				}
			}
	...
	public int method15806() {
		return -(this.anInt10314 * -1498872675 * -1691508299) - 1;
	}
		...
		if (this.playerAppearance != null && this.method16133(graphicalrenderer_1, 2048, -231081740)) {
			...
			if (Class393.aClass282_Sub54_4783.aClass468_Sub28_8212.method12966((byte) -35) == 1) {
				...
				if (renderanimdefs_9.aBool2787 && (this.playerAppearance.anInt2928 == -1 || IndexLoaders.NPC_INDEX_LOADER.getNPCDefinitions(this.playerAppearance.anInt2928, (byte) 90).aBool4912)) {
					...
					MeshRasterizer meshrasterizer_12 = Class116.method1969(graphicalrenderer_1, i_6, this.anInt10322, this.anInt10323, this.anInt10363, 1, this.aClass528Array10372[0], 0, 0, 160, 240, (Animation) (class456_sub3_11 != null ? class456_sub3_11 : animation_10), 16711935);
					if (meshrasterizer_12 != null) {
						if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < this.aClass528Array10372.length + 1) {
							this.method13008(this.aClass528Array10372.length + 1, (byte) -9);
						}

						class285_18 = Class470.method7824(true, (byte) -88);
						this.aBool10312 = true;
						graphicalrenderer_1.RA(false);
						meshrasterizer_12.method11282(matrix44var_3, this.aClass275_Sub5Array7965[this.aClass528Array10372.length], 0);
						graphicalrenderer_1.RA(true);
					}
				}
			}
					...
					if (class180_26 != null && class180_26.anInt2242 != -1) {
						...
						if (class180_26.anInt2236 == 1) {
							...
							if (class282_sub47_27 != null) {
								...
								this.method16136(graphicalrenderer_1, matrix44var_3, this.aClass528Array10372[0], (long) i_14, (long) i_15, class180_26.anInt2242, 92160000L);
							}
						}

						if (class180_26.anInt2236 == 2) {
							Vector3 vector3_28 = Class84.myPlayer.method11166().aClass385_3595;
							...
							long_16 *= long_16;
							this.method16136(graphicalrenderer_1, matrix44var_3, this.aClass528Array10372[0], long_20, long_22, class180_26.anInt2242, long_16);
						}
						...
						if (class180_26.anInt2236 == 10 && class180_26.anInt2238 >= 0 && class180_26.anInt2238 < client.players.length) {
							...
							if (player_29 != null) {
								Vector3 vector3_31 = Vector3.method6632(player_29.method11166().aClass385_3595, Class84.myPlayer.method11166().aClass385_3595);
								int i_24 = (int) vector3_31.x;
								i_14 = (int) vector3_31.z;
								this.method16136(graphicalrenderer_1, matrix44var_3, this.aClass528Array10372[0], (long) i_24, (long) i_14, class180_26.anInt2242, 92160000L);
							}
						}
					}
				}
			...
			if (this.aClass275_Sub5Array7965 == null || this.aClass275_Sub5Array7965.length < this.aClass528Array10372.length) {
				this.method13008(this.aClass528Array10372.length, (byte) -92);
			}
			...
			this.method15799(graphicalrenderer_1, this.aClass528Array10372, matrix44var_3, false, (byte) -20);

			for (i_19 = 0; i_19 < this.aClass528Array10372.length; i_19++) {
				if (this.aClass528Array10372[i_19] != null) {
					this.aClass528Array10372[i_19].method11282(matrix44var_3, this.aClass275_Sub5Array7965[i_19], this == Class84.myPlayer ? 1 : 0);
				}
			}
			...
			for (i_19 = 0; i_19 < this.aClass528Array10372.length; i_19++) {
				if (this.aClass528Array10372[i_19] != null) {
					this.aBool10312 |= this.aClass528Array10372[i_19].i();
				}

				this.aClass528Array10372[i_19] = null;
			}
	...
	public Class163 method15811(int i_1) {
		if (this.aClass163_10334 != null) {
			...
			if (client.anInt7416 == 0 || client.anInt7416 == 3 || client.anInt7416 == 1 && Class249.method4282(this.displayName, (byte) 0)) {
				return this.aClass163_10334;
			}
		}
