...
public abstract class Class217 {
	...
	public static void method3690(Index class317, int i, int i_0_, int i_1_, boolean bool, Class282_Sub15_Sub2 class282_sub15_sub2, int i_2_) {
		Class11.method13400(class317, i, i_0_, i_1_, bool, (byte) -86);
		Class282_Sub33.aClass282_Sub15_Sub2_7836 = class282_sub15_sub2;
	}

	static final void method3691(CS2Executor class527, int i) {
		class527.intStackPtr -= 283782002;
		int i_3_ = (class527.intStack[1942118537 * class527.intStackPtr]);
		int i_4_ = (class527.intStack[class527.intStackPtr * 1942118537 + 1]);
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = i_3_ | i_4_;
	}

	static final void method3692(CS2Executor class527, int i) {
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = Class393.aClass282_Sub54_4783.aClass468_Sub13_8228.method12714(-1998684386);
	}

	static final void method3693(CS2Executor class527, short i) {
		Class393.aClass282_Sub54_4783.method13511(Class393.aClass282_Sub54_4783.aClass468_Sub24_8216, ((class527.intStack[(class527.intStackPtr -= 141891001) * 1942118537]) == 1) ? 2 : 0, 447619076);
