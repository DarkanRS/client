public class Class96_Sub22 extends Class96 {
	...
	static void method14678(Player player_0, boolean bool_1, int i_2) {
		if (Class20.anInt169 < 412) {
			if (Class84.myPlayer == player_0) {
				if (client.aBool7344 && (Class506.anInt5858 & 0x10) != 0) {
					PlayerAppearance.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Class59.method1163(16777215, 619010179) + Message.aClass433_5299.translate(Class223.CURRENT_LANGUAGE, -1114882023), Defaults8Loader.anInt5932, 16, -1, 0L, 0, 0, true, false, (long) player_0.anInt10314, false, -1931180359);
				}
			} else {
				String string_3;
				if (player_0.anInt10556 == 0) {
					...
					if (player_0.anInt10565 >= player_0.anInt10554) {
						string_3 = player_0.method16127(true, 2054627302) + (bool_4 ? ItemIndexLoader.method7169(player_0.anInt10565, Class84.myPlayer.anInt10565, -1737457030) : Class59.method1163(16777215, 619010179)) + " (" + string_8 + player_0.anInt10565 + ")";
					} else {
						string_3 = player_0.method16127(true, 2144417480) + (bool_4 ? ItemIndexLoader.method7169(player_0.anInt10565, Class84.myPlayer.anInt10565, -1524250646) : Class59.method1163(16777215, 619010179)) + " (" + string_8 + player_0.anInt10565 + "+" + (player_0.anInt10554 - player_0.anInt10565) + ")";
					}
				} else if (player_0.anInt10556 == -1) {
					string_3 = player_0.method16127(true, 2137901539);
				} else {
					string_3 = player_0.method16127(true, 1967945336) + " (" + Message.SKILL_.translate(Class223.CURRENT_LANGUAGE, -871379797) + player_0.anInt10556 + ")";
				}

				if (client.aBool7344 && !bool_1 && (Class506.anInt5858 & 0x8) != 0) {
					PlayerAppearance.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Class59.method1163(16777215, 619010179) + string_3, Defaults8Loader.anInt5932, 15, -1, (long) player_0.anInt10314, 0, 0, true, false, (long) player_0.anInt10314, false, -1521566355);
				}

				if (bool_1) {
					PlayerAppearance.method4032(Class59.method1163(13421772, 619010179) + string_3, "", -1, -1, 0, 0L, 0, 0, false, true, (long) player_0.anInt10314, false, -1005059728);
				} else {
					for (int i_10 = 7; i_10 >= 0; --i_10) {
						if (client.aStringArray7329[i_10] != null) {
							...
							PlayerAppearance.method4032(client.aStringArray7329[i_10], Class59.method1163(16777215, 619010179) + string_3, i_7, s_12, -1, (long) player_0.anInt10314, 0, 0, true, false, (long) player_0.anInt10314, false, -1621747030);
						}
					}
				}
				...
				if (!bool_1) {
					for (Class282_Sub50_Sub7 class282_sub50_sub7_9 = (Class282_Sub50_Sub7) Class20.aClass482_171.head((byte) 114); class282_sub50_sub7_9 != null; class282_sub50_sub7_9 = (Class282_Sub50_Sub7) Class20.aClass482_171.next(1246744595)) {
						if (class282_sub50_sub7_9.anInt9587 == 23) {
							class282_sub50_sub7_9.aString9585 = Class59.method1163(16777215, 619010179) + string_3;
							break;
						}
					}
				}
	...
	static final void method14679(CS2Executor cs2executor_0, int i_1) {
		Class93.method1573(cs2executor_0, (byte) 93);
	}
