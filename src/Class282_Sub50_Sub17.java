...
public abstract class Class282_Sub50_Sub17 extends Class282_Sub50 {
	...
	static final void method15511(Class118 class118, Class98 class98, CS2Executor class527, byte i) {
		class118.anInt1343 = ((((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 -= 141891001) * 1942118537]) * -807852535);
	...
	static final void method15512(CS2Executor class527, int i) {
		...
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = i_10_;
	}

	static final void method15513(CS2Executor class527, int i) {
		((CS2Executor) class527).objectStack[(((CS2Executor) class527).anInt7000 += 1476624725) * 1806726141 - 1] = method15508(-1026148530).toString();
	}
