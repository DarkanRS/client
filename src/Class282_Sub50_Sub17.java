...
public abstract class Class282_Sub50_Sub17 extends Class282_Sub50 {
	...
	static void method15506(GraphicalRenderer class505, int i, int i_0_, IComponentDefinitions class118, int i_1_) {
		int i_2_ = 63;
		int i_3_ = 7;
	...
	static int method15507(Class282_Sub50_Sub7 class282_sub50_sub7, FontMetrics class414, int i) {
		...
		int i_7_ = class414.getWidth(string, Class115.aClass160Array1248);
