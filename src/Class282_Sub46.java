public class Class282_Sub46 extends Node {
	...
	static void method13407(GraphicalRenderer graphicalrenderer_0, Interface22 interface22_1, int i_2, int i_3, int i_4, int i_5) {
		...
		if (Class291_Sub1.anInt8015 < 100) {
			...
			if (client.aBool7176) {
				int i_12 = i_2 + i_4 - 5;
				int i_13 = i_3 + i_5 - 8;
				Class16.aClass8_144.method359("Fps:" + Engine.FPS, i_12, i_13, 16776960, -1);
				i_13 -= 15;
				...
				Class16.aClass8_144.method359("Mem:" + i_15 + "k", i_12, i_13, i_16, -1);
				i_13 -= 15;
			}
		}
	}
