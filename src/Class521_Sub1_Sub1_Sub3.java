public class Class521_Sub1_Sub1_Sub3 extends Class521_Sub1_Sub1 {
	...
	public Class521_Sub1_Sub1_Sub3(SceneObjectManager sceneobjectmanager_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, int i_14, boolean bool_15, int i_16) {
	...
	public final void method15910(int i_1, short s_2) {
		...
		if (this.aClass456_10399.method7627(1, -1320963255) && this.aClass456_10399.method7580(1594863337)) {
			this.aClass456_10399.method7582((byte) -115);
		}
