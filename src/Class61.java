public class Class61 {
	...
	static final void method1254(CS2Executor cs2executor_0, int i_1) {
		cs2executor_0.instrPtr += cs2executor_0.intOpValues[cs2executor_0.instrPtr];
	}

	static final void method1255(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		WorldMapAreaDefs worldmapareadefs_3 = IndexLoaders.WORLD_MAP_INDEX_LOADER.getWorldMapDefs(i_2, 676193293);
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = worldmapareadefs_3.anInt2719;
	}
