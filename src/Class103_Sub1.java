...
public class Class103_Sub1 extends Class103 {
	...
	boolean method14483(int i_1) throws Exception_Sub2 {
		...
		this.aClass282_Sub21_Sub1_9149 = this.aClass101_9148.method1691("TexCoordMatrix", (short) 32643);
		this.aClass282_Sub21_Sub1_9146 = this.aClass101_9148.method1691("DiffuseColour", (short) 29027);
	...
	public void method1788(Matrix44Arr matrix44arr_1) {
		...
		this.aClass384_9147.method6523(this.aClass505_Sub2_1057.aClass384_8729);
	}

	public void method1787(int i_1) {
		this.method14486(2119747101);
		this.aClass505_Sub2_1057.method14002(Class352.aClass352_4098, 0, i_1 * 4, 0, i_1 * 2);
	}

	public void method1790() {
		this.method14486(2135879735);
		this.aClass505_Sub2_1057.method14150();
	}
	...
	public void method1785(int i_1) {
		...
		this.aClass505_Sub2_1057.method14002(Class352.aClass352_4098, 0, 4 * i_1, 0, i_1 * 2);
	}
		...
		if (bytes_0 == null) {
			...
			while (true) {
				try {
					...
					MediaTracker mediatracker_4 = new MediaTracker(Class282_Sub44.anApplet8065);
					mediatracker_4.addImage(image_3, 0);
					mediatracker_4.waitForAll();
					int i_5 = image_3.getWidth(Class282_Sub44.anApplet8065);
					int i_6 = image_3.getHeight(Class282_Sub44.anApplet8065);
