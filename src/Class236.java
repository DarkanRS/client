...
public class Class236 {
	...
	static final void method3983(IComponentDefinitions class118, Interface class98, CS2Executor class527, int i) {
		...
		class118.anInt1295 = 1302798223 * (class527.intStack[class527.intStackPtr * 1942118537]);
		class118.anInt1296 = (-1965685901 * (class527.intStack[1942118537 * class527.intStackPtr + 1]));
		int i_0_ = (class527.intStack[2 + class527.intStackPtr * 1942118537]);
		if (i_0_ < 0)
			i_0_ = 0;
		else if (i_0_ > 5)
			i_0_ = 5;
		int i_1_ = (class527.intStack[3 + 1942118537 * class527.intStackPtr]);
		if (i_1_ < 0)
			i_1_ = 0;
		else if (i_1_ > 5)
			i_1_ = 5;
	...
	static final void method3984(CS2Executor class527, int i) {
		...
		class527.intStack[(class527.intStackPtr += 141891001) * 1942118537 - 1] = Class101.method1776(i_2_, false, 610483852);
	}
