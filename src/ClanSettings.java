public class ClanSettings {
	...
	boolean method1212(int i_1, int i_2, int i_3, int i_4, byte b_5) {
		...
		this.variables.put(new IntNode(i_2), (long) i_1);
		return true;
	}

	boolean method1213(int i_1, long long_2) {
		if (this.variables != null) {
			Node node_4 = this.variables.get((long) i_1);
			if (node_4 != null) {
		...
		this.variables.put(new LongNode(long_2), (long) i_1);
		return true;
	}
	...
	boolean method1224(int i_1, String string_2, byte b_3) {
		...
		this.variables.put(new StringNode(string_2), (long) i_1);
		return true;
	}
				...
				if (i_5 > 0) {
					...
					while (i_5-- > 0) {
						...
						if (i_8 == 0) {
							...
							this.variables.put(new IntNode(i_9), (long) i_7);
						} else if (i_8 == 1) {
							long long_11 = buffer.readLong();
							this.variables.put(new LongNode(long_11), (long) i_7);
						} else if (i_8 == 2) {
							String string_13 = buffer.readString();
							this.variables.put(new StringNode(string_13), (long) i_7);
						}
					}
				}
			}
