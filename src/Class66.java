public class Class66 {
	...
	Interface6 method1277(int i_1, int i_2) {
		...
		if (object_5 != null) {
			...
			TextureDetails class169_6 = this.anInterface22_675.method144(i_1, -1825061587);
			if (i_2 == -1) {
				i_2 = class169_6.isHalfSize ? 64 : this.aClass505_Sub2_676.anInt8821;
			}

			Interface6 interface6_7;
			if (class169_6.hdr && this.aClass505_Sub2_676.method8471()) {
				float[] floats_9 = this.anInterface22_675.method145(i_1, i_2, i_2);
				interface6_7 = this.aClass505_Sub2_676.method13958(Class150.aClass150_1949, i_2, i_2, floats_9);
			} else {
				int[] ints_8;
				if (class169_6.blendType != 2 && Class282_Sub41.method13367(class169_6.effectId, (short) 10824)) {
