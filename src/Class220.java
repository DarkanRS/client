...
public class Class220 {
	...
	public NativeSprite method3721(GraphicalRenderer class505) {
		NativeSprite class160 = ((NativeSprite) (((Class218) ((Class220) this).aClass218_2716).aClass229_2708.get((long) (1555531861 * ((Class220) this).anInt2733 | 0x20000 | class505.rendererId * -413843045 << 29))));
		if (null != class160)
			return class160;
	...
	public NativeSprite method3732(GraphicalRenderer class505, boolean bool) {
		...
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.get((long) i_61_);
		if (class160 != null)
			return class160;
	...
	public NativeSprite method3733(GraphicalRenderer class505, boolean bool) {
		...
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.get((long) i_62_);
		if (class160 != null)
			return class160;
	...
	public NativeSprite method3735(GraphicalRenderer class505, boolean bool, byte i) {
		...
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.get((long) i_64_);
		if (class160 != null)
			return class160;
		...
		if (2144330291 * Class20.anInt169 < 412) {
			...
			if (class409.aBool4893) {
				if (class521_sub1_sub1_sub2_sub2.anInt10582 * -1394313433 != 0) {
					String string_65_ = (client.aClass486_7450 == Game.aClass486_5750 ? (Message.aClass433_5290.translate(Class223.aClass495_2772, -834706251)) : (Message.aClass433_5281.translate(Class223.aClass495_2772, -2066176113)));
				...
				if (!bool) {
					...
					if (null != strings) {
						for (int i_66_ = strings.length - 1; i_66_ >= 0; i_66_--) {
							if (null != strings[i_66_] && (0 == class409.aByte4916 || (!(strings[i_66_].equalsIgnoreCase(Message.aClass433_5295.translate(Class223.aClass495_2772, -1264290338))) && !(strings[i_66_].equalsIgnoreCase(Message.EXAMINE.translate(Class223.aClass495_2772, -1819151765)))))) {
								int i_67_ = 0;
						...
						if (1 == class409.aByte4916) {
							for (int i_69_ = 0; i_69_ < strings.length; i_69_++) {
								if (null != strings[i_69_] && ((strings[i_69_].equalsIgnoreCase(Message.aClass433_5295.translate(Class223.aClass495_2772, -436851003))) || (strings[i_69_].equalsIgnoreCase(Message.EXAMINE.translate(Class223.aClass495_2772, -473516287))))) {
									short i_70_ = 0;
