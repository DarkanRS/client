...
public class Class220 {
	...
	void method3717(RsByteBuffer class282_sub35, int i, int i_2_) {
		if (1 == i)
			...
			if (((Class220) this).aClass465_2737 == null) {
				...
				((Class220) this).aClass465_2737 = new IterableNodeMap(i_10_);
			}
	...
	void method3720(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			...
			if (((Class220) this).aClass465_2737 == null) {
				...
				((Class220) this).aClass465_2737 = new IterableNodeMap(i_23_);
			}
	...
	public NativeSprite method3721(GraphicalRenderer class505) {
		NativeSprite class160 = ((NativeSprite) (((Class218) ((Class220) this).aClass218_2716).aClass229_2708.method3865((long) (1555531861 * ((Class220) this).anInt2733 | 0x20000 | class505.rendererId * -413843045 << 29))));
		if (null != class160)
			return class160;
		...
		if (null != class91) {
			...
			((Class218) ((Class220) this).aClass218_2716).aClass229_2708.put(class160, (long) (1555531861 * ((Class220) this).anInt2733 | 0x20000 | class505.rendererId * -413843045 << 29));
		}
		return class160;
	}
	...
	void method3725(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			...
			if (((Class220) this).aClass465_2737 == null) {
				...
				((Class220) this).aClass465_2737 = new IterableNodeMap(i_36_);
			}
	...
	void method3726(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			...
			if (((Class220) this).aClass465_2737 == null) {
				...
				((Class220) this).aClass465_2737 = new IterableNodeMap(i_46_);
			}
	...
	void method3727(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			...
			if (((Class220) this).aClass465_2737 == null) {
				...
				((Class220) this).aClass465_2737 = new IterableNodeMap(i_56_);
			}
	...
	public NativeSprite method3732(GraphicalRenderer class505, boolean bool) {
		int i = bool ? anInt2757 * -992610861 : -1248709255 * anInt2719;
		int i_61_ = i | -413843045 * class505.rendererId << 29;
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.method3865((long) i_61_);
		if (class160 != null)
			return class160;
		...
		if (null != class91) {
			class160 = class505.method8444(class91, true);
			((Class218) ((Class220) this).aClass218_2716).aClass229_2708.put(class160, (long) i_61_);
		}
		return class160;
	}

	public NativeSprite method3733(GraphicalRenderer class505, boolean bool) {
		int i = bool ? anInt2757 * -992610861 : -1248709255 * anInt2719;
		int i_62_ = i | -413843045 * class505.rendererId << 29;
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.method3865((long) i_62_);
		if (class160 != null)
			return class160;
		...
		if (null != class91) {
			class160 = class505.method8444(class91, true);
			((Class218) ((Class220) this).aClass218_2716).aClass229_2708.put(class160, (long) i_62_);
		}
		return class160;
	}
	...
	public NativeSprite method3735(GraphicalRenderer class505, boolean bool, byte i) {
		int i_63_ = bool ? anInt2757 * -992610861 : -1248709255 * anInt2719;
		int i_64_ = i_63_ | -413843045 * class505.rendererId << 29;
		NativeSprite class160 = (NativeSprite) ((Class218) ((Class220) this).aClass218_2716).aClass229_2708.method3865((long) i_64_);
		if (class160 != null)
			return class160;
		...
		if (null != class91) {
			class160 = class505.method8444(class91, true);
			((Class218) ((Class220) this).aClass218_2716).aClass229_2708.put(class160, (long) i_64_);
		}
		return class160;
	}
		...
		if (2144330291 * Class20.anInt169 < 412) {
			...
			if (class409.aBool4893) {
				if (class521_sub1_sub1_sub2_sub2.anInt10582 * -1394313433 != 0) {
					String string_65_ = (client.aClass486_7450 == Game.stellarDawn ? (Message.aClass433_5290.translate(Class223.aClass495_2772, -834706251)) : (Message.aClass433_5281.translate(Class223.aClass495_2772, -2066176113)));
				...
				if (!bool) {
					...
					if (null != strings) {
						for (int i_66_ = strings.length - 1; i_66_ >= 0; i_66_--) {
							if (null != strings[i_66_] && (0 == class409.aByte4916 || (!(strings[i_66_].equalsIgnoreCase(Message.aClass433_5295.translate(Class223.aClass495_2772, -1264290338))) && !(strings[i_66_].equalsIgnoreCase(Message.aClass433_5282.translate(Class223.aClass495_2772, -1819151765)))))) {
								int i_67_ = 0;
								...
								PlayerAppearance.method4032(strings[i_66_], new StringBuilder().append(Class59.method1163(16776960, 619010179)).append(string).toString(), ((strings[i_66_].equalsIgnoreCase(Message.aClass433_5295.translate(Class223.aClass495_2772, -422947170))) ? -1025853585 * class409.anInt4877 : i_68_), i_67_, -1, (long) ((class521_sub1_sub1_sub2_sub2.anInt10314) * -1691508299), 0, 0, true, false, (long) ((class521_sub1_sub1_sub2_sub2.anInt10314) * -1691508299), false, -1773453670);
							}
						}
						if (1 == class409.aByte4916) {
							for (int i_69_ = 0; i_69_ < strings.length; i_69_++) {
								if (null != strings[i_69_] && ((strings[i_69_].equalsIgnoreCase(Message.aClass433_5295.translate(Class223.aClass495_2772, -436851003))) || (strings[i_69_].equalsIgnoreCase(Message.aClass433_5282.translate(Class223.aClass495_2772, -473516287))))) {
									short i_70_ = 0;
	...
	static boolean method3742(GraphicalRenderer class505, Class282_Sub36 class282_sub36, Class220 class220, int i, int i_78_, int i_79_) {
