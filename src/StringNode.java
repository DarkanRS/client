public class StringNode extends Node {
	...
	static void method13409(GraphicalRenderer graphicalrenderer_0) {
		...
		if (Class179.anInt2227 > 0) {
			...
			for (int i_6 = Class179.anInt2223; i_6 < i_2 + Class179.anInt2223 && i_6 < Class179.anInt2227; i_6++) {
				...
				for (int i_9 = 0; i_9 < arr_7.length; i_9++) {
					...
					Class16.aFontRenderer_144.renderText(GameTipsLoader.method6793(arr_7[i_9]), i_10, 350 - Class179.anInt2230 - 2 - Class16.aClass414_139.anInt4979 - (i_6 - Class179.anInt2223) * Class179.anInt2222, -1, -16777216);
				}
			}
		}
		...
		Class285.aFontRenderer_3394.renderText("--> " + GameTipsLoader.method6793(Class179.aString2225), 10, 350 - SkyboxIndexLoader.aClass414_3438.anInt4979 - 1, -1, -16777216);
