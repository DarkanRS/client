...
public class Class246 {
	...
	public static FriendStatus getFriendStatus(int i_0) {
		...
		for (FriendStatus class461_4 : arr_2) {
	...
	static void method4204(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2) {
		...
		if (client.aBool7168 && (client.getIComponentSettings(icomponentdefinitions_0).eventsHash != 0 || icomponentdefinitions_0.type == ComponentType.CONTAINER)) {
