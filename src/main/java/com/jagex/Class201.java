...
public class Class201 {
	...
	boolean method3273(int i_1, int i_2, int i_3, int i_4) {
		if (!aBool2552 || !aBool2542)
			return false;
		if ((aClass205_2547.anInt2588 < 102) || !method3271(i_1, i_2, i_3))
			return false;
		else {
			int i_5 = i_2 << aClass206_2546.anInt2592;
			int i_6 = i_3 << aClass206_2546.anInt2592;
	...
	boolean method3275(GraphNode_Sub1_Sub5 class521_sub1_sub5_1, int i_2, int i_3, int i_4) {
		if (!aBool2552 || !aBool2542)
			return false;
		if ((aClass205_2547.anInt2588 < 102) || !method3271(i_2, i_3, i_4))
			return false;
		else {
	...
	boolean method3276(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		...
		if (!method3277(i_1, i_8, i_3, i_7, i_8, i_9, i_1, i_8, i_9))
			return false;
		if (!method3277(i_1, i_8, i_3, i_7, i_8, i_3, i_7, i_8, i_9))
			return false;
		else {
			if (i_1 < aClass206_2546.anInt2630) {
				if (!method3277(i_1, i_2, i_9, i_1, i_8, i_3, i_1, i_8, i_9) || !method3277(i_1, i_2, i_9, i_1, i_2, i_3, i_1, i_8, i_3))
					return false;
			} else {
				if (!method3277(i_7, i_2, i_9, i_7, i_8, i_3, i_7, i_8, i_9) || !method3277(i_7, i_2, i_9, i_7, i_2, i_3, i_7, i_8, i_3))
					return false;
			}
