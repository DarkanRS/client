...
public class Class18 {
	...
	static void renderInformation(AbstractRenderer graphicalrenderer_0, NodeCollection nodecollection_1) {
		...
		if (!Class291_Sub1.aBool8027)
			for (Node_Sub36 class282_sub36_5 = (Node_Sub36) nodecollection_1.head(); class282_sub36_5 != null; class282_sub36_5 = (Node_Sub36) nodecollection_1.next()) {
				MapAreaDefinitions worldmapareadefs_6 = Class291.MAP_AREA_LOADER.getWorldMapDefs(class282_sub36_5.anInt7991);
