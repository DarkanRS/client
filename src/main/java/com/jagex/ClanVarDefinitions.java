...
public class ClanVarDefinitions {
	...
	static void method6824(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		...
		if (i_1 >= Class532.anInt7070 && i_1 <= Class532.anInt7068) {
			...
			i_40 = EntityNode.method4890(i_0 - i_2, Class532.anInt7071, Class532.anInt7069);
			i_41 = EntityNode.method4890(i_0 + i_2, Class532.anInt7071, Class532.anInt7069);
			i_42 = EntityNode.method4890(i_0 - i_11, Class532.anInt7071, Class532.anInt7069);
			i_43 = EntityNode.method4890(i_0 + i_11, Class532.anInt7071, Class532.anInt7069);
		...
		while (i_9 > 0) {
			...
			i_40 = i_1 - i_9;
			i_41 = i_9 + i_1;
			if (i_41 >= Class532.anInt7070 && i_40 <= Class532.anInt7068) {
				i_42 = EntityNode.method4890(i_0 + i_8, Class532.anInt7071, Class532.anInt7069);
				i_43 = EntityNode.method4890(i_0 - i_8, Class532.anInt7071, Class532.anInt7069);
				if (bool_47) {
					int i_44 = EntityNode.method4890(i_0 + i_10, Class532.anInt7071, Class532.anInt7069);
					int i_45 = EntityNode.method4890(i_0 - i_10, Class532.anInt7071, Class532.anInt7069);
					int[] ints_46;
					if (i_40 >= Class532.anInt7070) {
						ints_46 = Class532.anIntArrayArray7072[i_40];
					...
					if (i_41 <= Class532.anInt7068) {
						ints_46 = Class532.anIntArrayArray7072[i_41];
						KeyHoldInputSubscriber.method3922(ints_46, i_43, i_45, i_5);
						KeyHoldInputSubscriber.method3922(ints_46, i_45, i_44, i_4);
						KeyHoldInputSubscriber.method3922(ints_46, i_44, i_42, i_5);
					}
					...
					if (i_40 >= Class532.anInt7070)
						KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_40], i_43, i_42, i_5);

					if (i_41 <= Class532.anInt7068)
						KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_41], i_43, i_42, i_5);
				}
			}
		}
	...
	public static Class467[] method6825() {
		if (Class149_Sub3.aClass467Array9380 == null) {
			...
			label70:
				for (Class467 class467_10 : arr_1)
