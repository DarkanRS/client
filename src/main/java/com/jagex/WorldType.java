    ...
    public static void method3662(AnimationDefinitions animDef, int i_1, GraphNode_Sub1 class521_sub1_2) {
        if (Class260.SOUNDS_SIZE < 50 && animDef != null && animDef.anIntArrayArray5913 != null && i_1 < animDef.anIntArrayArray5913.length && animDef.anIntArrayArray5913[i_1] != null && class521_sub1_2.plane == VertexNormal.MY_PLAYER.plane) {
            ...
            if (animDef.anIntArrayArray5913[i_1].length > 1) {
                i_8 = (int) (Math.random() * animDef.anIntArrayArray5913[i_1].length);
                if (i_8 > 0) {
                    soundID = animDef.anIntArrayArray5913[i_1][i_8];
                }
            }
            ...
            if (i_7 == 0) {
                if (class521_sub1_2 == VertexNormal.MY_PLAYER) {
                    if (animDef.aBool5928) {
                        Class435.playSoundVorbis(soundID, i_6, 0, i_9, false, i_8);
                    } else {
                        VarNPCMap.playSoundSynth(soundID, i_6, 0, i_9, i_8);
                    }
                }
            } else {
                if (class521_sub1_2 == VertexNormal.MY_PLAYER) {
                ...
                Class260.SOUNDS[++Class260.SOUNDS_SIZE - 1] = new AreadSound((byte) (animDef.aBool5928 ? 2 : 1), soundID, i_6, 0, i_9, i_13, i_8, class521_sub1_2);
            }
        }
