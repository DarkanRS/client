		...
		if (aClass320_7667.aBool3722) {
			...
			for (int i_11 = i_5 - 1; i_11 <= i_6; i_11++) {
				...
				for (int i_13 = i_9 - 1; i_13 <= i_10; i_13++) {
					...
					int i_17 = switch (anInt9949) {
					case 1 -> i_16 * i_16 + i_15 * i_15 >> 12;
					case 2 -> (i_15 < 0 ? -i_15 : i_15) + (i_16 < 0 ? -i_16 : i_16);
					case 3 -> {
						i_15 = i_15 < 0 ? -i_15 : i_15;
						i_16 = i_16 < 0 ? -i_16 : i_16;
						yield Math.max(i_15, i_16);
					}
					case 4 -> {
					...
					case 5 -> {
						i_15 *= i_15;
						i_16 *= i_16;
						yield (int) (Math.sqrt(Math.sqrt((i_16 + i_15) / 1.6777216E7F)) * 4096.0D);
					}
					default -> (int) (Math.sqrt((i_15 * i_15 + i_16 * i_16) / 1.6777216E7F) * 4096.0D);
					};
