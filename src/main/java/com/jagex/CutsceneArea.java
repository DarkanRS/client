...
public class CutsceneArea extends Node {
    ...
    static TCPPacket method12078(int i_0, int i_1, int i_2) {
        ...
        if (i_2 == 0) {
            tcpmessage_4 = Class271.createPacket(ClientProt.WALK, client.GAME_CONNECTION_CONTEXT.isaac);
        }

        if (i_2 == 1) {
            tcpmessage_4 = Class271.createPacket(ClientProt.MINI_WALK, client.GAME_CONNECTION_CONTEXT.isaac);
        }
