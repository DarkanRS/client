...
public class Class502 implements Interface23 {
	...
	AbstractRenderer aAbstractRenderer_5829;

	@Override
	public NativeSprite method162(int[] ints_1, int i_3, int i_4, int i_5) {
		return aAbstractRenderer_5829.method8442(ints_1, 0, i_3, i_4, i_5, false);
	}

	@Override
	public NativeSprite method163(int[] ints_1, int i_2, int i_3, int i_4, int i_5) {
		return aAbstractRenderer_5829.method8442(ints_1, i_2, i_3, i_4, i_5, false);
	}
