...
public class Class137_Sub1 extends GLTexture {
    ...
    Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, int i_3, int i_4, boolean bool_5, int[] ints_6, int i_7, int i_8, boolean bool_9) {
        ...
        if (bindId != 34037 && bool_5 && i_7 == 0 && i_8 == 0) {
            method2371(bindId, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), anInt9087, anInt9086, openGLHardwareRenderer.anInt8410, ints_61);
            method2354(true);
        } else {
            OpenGL.glPixelStorei(3314, i_7);
            OpenGL.glTexImage2Di(bindId, 0, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), anInt9087, anInt9086, 0, 32993, openGLHardwareRenderer.anInt8410, ints_61, i_8 * 4);
    ...
    Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, Class150 class150_3, Class76 class76_4, int i_5, int i_6, boolean bool_7, byte[] bytes_8, Class150 class150_9, boolean bool_10) {
        ...
        if (bool_7 && bindId != 34037) {
            method2359(i_2, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), i_5, i_6, class150_9, bytes_81);
            method2354(true);
        } else {
            OpenGL.glTexImage2Dub(bindId, 0, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), anInt9087, anInt9086, 0, OpenGLRenderer.method13629(class150_9), 5121, bytes_81, 0);
            method2354(false);
        }
    ...
    Class137_Sub1(OpenGLRenderer class505_sub1_1, Class150 class150_3, Class76 class76_4, int i_5, int i_6, boolean bool_7, float[] floats_8, Class150 class150_9) {
        ...
        if (bool_7 && bindId != 34037) {
            ...
            OpenGL.glTexImage2Df(bindId, 0, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), anInt9087, anInt9086, 0, OpenGLRenderer.method13629(class150_9), 5126, floats_8, 0);
            method2354(false);
        }
    ...
    Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, Class150 class150_3, Class76 class76_4, int i_5, int i_6) {
        ...
        anInt9086 = i_6;
        openGLHardwareRenderer.setTexture(this);
        OpenGL.glTexImage2Dub(bindId, 0, OpenGLRenderer.method13630(aClass150_1650, aClass76_1651), i_5, i_6, 0, OpenGLRenderer.method13629(aClass150_1650), 5121, null, 0);
        method2351(true);
    }
    ...
    void method14445(boolean bool_1, boolean bool_2) {
        if (bindId == 3553) {
            openGLHardwareRenderer.setTexture(this);
            OpenGL.glTexParameteri(bindId, 10242, bool_1 ? 10497 : 33071);
            OpenGL.glTexParameteri(bindId, 10243, bool_2 ? 10497 : 33071);
        }
    ...
    void method14452(int i_1, int i_2, int i_3, int i_4, int[] ints_5, int i_7) {
        ...
        OpenGL.glTexSubImage2Di(bindId, 0, i_1, anInt9086 - i_2 - i_4, i_3, i_4, 32993, openGLHardwareRenderer.anInt8410, ints_9, 0);
        if (i_3 != i_71) {
            OpenGL.glPixelStorei(3314, 0);
        }
    ...
    void method14455(int i_2, int i_3, int i_4, byte[] bytes_5, Class150 class150_6, int i_8, boolean bool_9) {
        ...
        OpenGL.glTexSubImage2Dub(bindId, 0, 0, anInt9086 - i_2 - i_4, i_3, i_4, OpenGLRenderer.method13629(class150_6), 5121, bytes_51, 0);
        if (i_3 != i_81) {
            OpenGL.glPixelStorei(3314, 0);
        }
