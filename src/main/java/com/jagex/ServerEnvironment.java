	...
	static void pulseSubInterfaces() {
		if (client.BASE_WINDOW_ID != -1) {
			...
			if (client.aClass118_7257 != null && InputSubscriberType.NO_LAYER == client.aClass118_7247) {
				...
				client.anInt7476 = Engine.BASE_WINDOW_HEIGHT * -969250379;
			}
			LightIntensityIndexLoader.method7313(null, client.BASE_WINDOW_ID, 0, 0, ChangeClanSetting.BASE_WINDOW_WIDTH, Engine.BASE_WINDOW_HEIGHT * -969250379, 0, 0, mouseX, mouseY);
