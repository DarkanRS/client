...
public class Node_Sub46 extends Node {
	...
	static void method13407(AbstractRenderer graphicalrenderer_0, ImageLoader interface22_1, int i_2, int i_3, int i_4, int i_5) {
		...
		if (Class291_Sub1.anInt8015 < 100) {
			...
			int i_17 = MapSpriteIndexLoader.anInt5123 - (int) (i_4 / Class291.aFloat3468);
			i_8 = (int) (i_5 / Class291.aFloat3468) + Class475.anInt5624;
			i_9 = (int) (i_4 / Class291.aFloat3468) + MapSpriteIndexLoader.anInt5123;
			int i_10 = Class475.anInt5624 - (int) (i_5 / Class291.aFloat3468);
			MapRegionLoaderTask.anInt3991 = MapSpriteIndexLoader.anInt5123 - (int) (i_4 / Class291.aFloat3468);
			VarnBitDefinitions.anInt5765 = Class475.anInt5624 - (int) (i_5 / Class291.aFloat3468);
			Class488.anInt5760 = (int) ((i_4 * 2) / Class291.aFloat3468);
			Class351.anInt4097 = (int) ((i_5 * 2) / Class291.aFloat3468);
			Class291.method5139(i_17 + Class291.anInt3472, i_8 + Class291.anInt3473, i_9 + Class291.anInt3472, i_10 + Class291.anInt3473, i_2, i_3, i_2 + i_4, i_3 + i_5 + 1);
			Class291.renderMap(graphicalrenderer_0);
			NodeCollection nodecollection_11 = Class291.method5135();
