...
public class StructIndexLoader {
	...
	static void method7039() {
		...
		RenderAnimIndexLoader.method3629(client.BASE_WINDOW_ID, 0, 0, ChangeClanSetting.BASE_WINDOW_WIDTH, Engine.BASE_WINDOW_HEIGHT * -969250379, 0, 0, -1);
		if (Comparable_Sub1.aClass118Array3772 != null) {
			...
			int i_6 = Engine.BASE_WINDOW_HEIGHT * -969250379;
