...
public class KeyHoldInputSubscriber implements InputSubscriber {
	...
	static void method3920(int i_0) {
		...
		if (i_2 >= 100) {
			...
			int i_3 = (int) Camera.camAngleX;
			if (Camera.anInt7273 >> 8 > i_3)
				i_3 = Camera.anInt7273 >> 8;
				if (Camera.SHAKING[4] && Camera.SHAKE_2[4] + 128 > i_3)
					i_3 = Camera.SHAKE_2[4] + 128;
				int i_4 = (int) Camera.camAngleY + client.anInt7343 & 0x3fff;
				Vector3 vector3_5 = VertexNormal.MY_PLAYER.method11166().coords;
				LoadingStage.method6683(Camera.anInt122, Class504.getTerrainHeightAtPos((int) vector3_5.x, (int) vector3_5.z, Class4.MY_PLAYER_PLANE) - 200, Camera.anInt3289, i_3, i_4, (i_3 >> 3) * 3 + 600 << 2, i_0);
				float f_6 = 1.0F - ((100 - i_2) * (100 - i_2) * (100 - i_2)) / 1000000.0F;
				Camera.CAM_MOVE_ABSOLUTEX = (int) (Class186.anInt2349 + f_6 * (Camera.CAM_MOVE_ABSOLUTEX - Class186.anInt2349));
				Camera.CAM_MOVE_ABSOLUTEZ = (int) (GraphNode_Sub1_Sub2.anInt9461 + f_6 * (Camera.CAM_MOVE_ABSOLUTEZ - GraphNode_Sub1_Sub2.anInt9461));
				Camera.CAM_MOVE_ABSOLUTEY = (int) ((Camera.CAM_MOVE_ABSOLUTEY - Node_Sub15_Sub1.anInt9575) * f_6 + Node_Sub15_Sub1.anInt9575);
				Camera.anInt3512 = (int) (ClipFlagMap.anInt3968 + f_6 * (Camera.anInt3512 - ClipFlagMap.anInt3968));
				int i_7 = Camera.anInt5930 - ParamIndexLoader.anInt5029;
				if (i_7 > 8192)
					i_7 -= 16384;
				else if (i_7 < -8192)
					i_7 += 16384;
				Camera.anInt5930 = (int) (ParamIndexLoader.anInt5029 + f_6 * i_7);
