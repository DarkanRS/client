...
public class Node_Sub25 extends Node {
	...
	static void method12400(int i_0, int i_1, int i_2, int i_4, int i_6, MenuActionEvent class282_sub50_sub7_7, FontRenderer fontrenderer_8, FontMetrics fontmetrics_9, int i_10, int i_11) {
		int i_101 = i_10;
