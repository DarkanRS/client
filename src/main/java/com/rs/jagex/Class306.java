...
public class Class306 implements Runnable {
	...
	static void method5458(int i_0, int i_1, int i_2, int i_3) {
		float f_5 = (float) Class291.yLength / Class291.xLength;
		int i_6 = i_2;
		int i_7 = i_3;
		if (f_5 < 1.0F)
			i_7 = (int) (i_2 * f_5);
		...
		i_0 -= (i_2 - i_6) / 2;
		i_1 -= (i_3 - i_7) / 2;
		MapSpriteIndexLoader.anInt5123 = i_0 * Class291.xLength / i_6;
		Class475.anInt5624 = Class291.yLength - Class291.yLength * i_1 / i_7;
