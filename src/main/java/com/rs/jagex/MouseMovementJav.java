	...
	void method11414() {
		...
		if (class282_sub53_2 != null) {
			...
			if (class282_sub53_2.getClickType() == 2)
				b_6 = 1;
			TCPPacket tcpmessage_7 = TCPPacket.createPacket(ClientProt.MOUSE_CLICK, client.GAME_CONNECTION_CONTEXT.outKeys);
	...
	void method11418() {
		...
		if (class282_sub53_1 != null) {
			...
			if (class282_sub53_1.getClickType() == 2)
				b_5 = 1;
			TCPPacket tcpmessage_6 = TCPPacket.createPacket(ClientProt.MOUSE_CLICK, client.GAME_CONNECTION_CONTEXT.outKeys);
