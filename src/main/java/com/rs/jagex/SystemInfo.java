...
public class SystemInfo extends Node {
	...
	static void method13466(PathingEntity animable_0, boolean bool_1) {
		...
		if (animable_0.anInt10355 == 0) {
			...
			if (animable_0.currentAnimation.hasDefs() && !animable_0.currentAnimation.hasSpeed()) {
				...
				if ((animable_0.anInt10367 > 0 && animationdefinitions_4.animatingPrecedence == 0) || (animable_0.anInt10367 <= 0 && animationdefinitions_4.walkingPrecedence == 0)) {
			...
			for (EntitySpotAnim spotAnim : animable_0.spotAnims)
				if (spotAnim.spotAnimId != -1 && spotAnim.animation.hasSpeed()) {
					SpotAnimDefinitions spotanimdefinitions_19 = IndexLoaders.SPOT_ANIM_LOADER.getSpotAnimDefs(spotAnim.spotAnimId);
					if (spotanimdefinitions_19.aBool6968 && spotanimdefinitions_19.animationId != -1) {
						...
						if ((animable_0.anInt10367 > 0 && animationdefinitions_20.animatingPrecedence == 0) || (animable_0.anInt10367 <= 0 && animationdefinitions_20.walkingPrecedence == 0)) {
							++animable_0.anInt10366;
							IdentikitDefinition.anInt430 = MoveSpeed.STATIONARY.id;
							FontRenderer_Sub1.anInt8515 = 0;
							return;
	...
	public void writeMachineInformation(ByteBuf rsbytebuffer_1) {
		...
		for (int element : rawCPUInformationData)
			rsbytebuffer_1.writeInt(element);
