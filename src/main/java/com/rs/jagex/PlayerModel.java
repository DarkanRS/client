...
public class PlayerModel {
	...
	static void method4032(String string_0, String string_1, int i_2, MenuAction i_3, int i_4, long long_5, int i_7, int i_8, boolean bool_9, boolean bool_10, long long_11, boolean bool_13) {
		if (!Class20.aBool161 && Class20.anInt169 < 520) {
			i_2 = i_2 != -1 ? i_2 : client.anInt7427;
			MenuActionEvent class282_sub50_sub7_15 = new MenuActionEvent(string_0, string_1, i_2, i_3, i_4, long_5, i_7, i_8, bool_9, bool_10, long_11, bool_13);
			Class361.method6269(class282_sub50_sub7_15);
		}
	}
	
	static void method4034(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		int i_8 = EntityNode.method4890(i_2, Class532.anInt7070, Class532.anInt7068);
		int i_9 = EntityNode.method4890(i_3, Class532.anInt7070, Class532.anInt7068);
		int i_10 = EntityNode.method4890(i_0, Class532.anInt7071, Class532.anInt7069);
		int i_11 = EntityNode.method4890(i_1, Class532.anInt7071, Class532.anInt7069);
		int i_12 = EntityNode.method4890(i_2 + i_6, Class532.anInt7070, Class532.anInt7068);
		int i_13 = EntityNode.method4890(i_3 - i_6, Class532.anInt7070, Class532.anInt7068);
		int i_14;
		for (i_14 = i_8; i_14 < i_12; i_14++)
			KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_14], i_10, i_11, i_5);
		for (i_14 = i_9; i_14 > i_13; --i_14)
			KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_14], i_10, i_11, i_5);
		i_14 = EntityNode.method4890(i_0 + i_6, Class532.anInt7071, Class532.anInt7069);
		int i_15 = EntityNode.method4890(i_1 - i_6, Class532.anInt7071, Class532.anInt7069);
		for (int i_16 = i_12; i_16 <= i_13; i_16++) {
			int[] ints_17 = Class532.anIntArrayArray7072[i_16];
