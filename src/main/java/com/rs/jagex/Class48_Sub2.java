...
public class Class48_Sub2 extends Class48 {
	...
	static void method14572(int i_0, int i_1, int i_2, int i_3, int i_4) {
		KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_2++], i_0, i_1, i_4);
		KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_3--], i_0, i_1, i_4);

		for (int i_6 = i_2; i_6 <= i_3; i_6++) {
			int[] ints_7 = Class532.anIntArrayArray7072[i_6];
