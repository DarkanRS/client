				...
				if (animation_4.hasSpeed()) {
					...
					if (spotanimdefinitions_5.aBool6968)
						if (animationdefinitions_6.animatingPrecedence == 3) {
							if (animable_0.anInt10367 > 0 && animable_0.forceMovementT1Delay <= client.FRAME_COUNT && animable_0.forceMovementT2Delay < client.FRAME_COUNT) {
								animation_4.update(-1);
								animable_0.spotAnims[i_3].spotAnimId = -1;
								continue;
							}
						} else if (animationdefinitions_6.animatingPrecedence == 1 && animable_0.anInt10367 > 0 && animable_0.forceMovementT1Delay <= client.FRAME_COUNT && animable_0.forceMovementT2Delay < client.FRAME_COUNT)
							continue;
				}
