...
public class MouseMovementICMP extends MouseMovementRecord {
	...
	static int[] method12815(MenuActionEvent class282_sub50_sub7_0) {
		int[] quests = null;
		if (class282_sub50_sub7_0.menuAction.isGroundItemClick())
		...
		else if (class282_sub50_sub7_0.menuAction.isNPCClick()) {
		...
		} else if (class282_sub50_sub7_0.menuAction.isObjectClick()) {
	...
	Queue<MouseRecord_Sub1> aQueue7921 = new LinkedList<>();
	...
	void method11418() {
		...
		if (class282_sub53_sub1_1 != null) {
			TCPPacket tcpmessage_2 = TCPPacket.createPacket(ClientProt.MOUSE_BUTTON_CLICK, client.GAME_CONNECTION_CONTEXT.outKeys);
