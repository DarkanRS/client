...
public class SpotAnimIndexLoader {
	...
	public static void method8860() {
		if (client.anInt7277 != -1 && client.anInt7448 != -1) {
			...
			Camera.CAM_MOVE_ABSOLUTEX = (int) floats_3[0] - coordgrid_16.x * 512;
			Camera.CAM_MOVE_ABSOLUTEZ = (int) floats_3[1] * -1;
			Camera.CAM_MOVE_ABSOLUTEY = (int) floats_3[2] - coordgrid_16.y * 512;
			...
			Camera.anInt3512 = (int) (Math.atan2(f_20, d_11) * 2607.5945876176133D) & 0x3fff;
			Camera.anInt5930 = (int) (-Math.atan2(f_19, f_21) * 2607.5945876176133D) & 0x3fff;
			Camera.anInt1525 = ((client.anIntArrayArrayArray7302[client.anInt7277][i_4 + 2][3] - client.anIntArrayArrayArray7302[client.anInt7277][i_4][3]) * client.anInt7256 >> 16) + client.anIntArrayArrayArray7302[client.anInt7277][i_4][3];
		}
	}
