	...
	static int method1141() {
		if (client.aClass118_7257 == null)
			if (!Class20.aBool161) {
				...
				int i_4;
				int i_5;
				MenuActionEvent class282_sub50_sub7_7;
				int i_8;
				if (!Class20.aBool162) {
					if (i_2 > Class301.anInt3555 && i_2 < Class301.anInt3555 + Class158_Sub2.anInt8975) {
						...
						if (i_4 != -1) {
							...
							for (class282_sub50_sub7_7 = (MenuActionEvent) nodeiterator_6.method7683(); class282_sub50_sub7_7 != null; class282_sub50_sub7_7 = (MenuActionEvent) nodeiterator_6.next())
								if (i_5++ == i_4)
					...
					if (i_2 > Class301.anInt3555 && i_2 < Class301.anInt3555 + Class158_Sub2.anInt8975) {
						...
						if (i_4 != -1) {
							...
							for (CacheableNode_Sub15 class282_sub50_sub15_10 = (CacheableNode_Sub15) class469_9.method7790(); class282_sub50_sub15_10 != null; class282_sub50_sub15_10 = (CacheableNode_Sub15) class469_9.next())
								if (i_5++ == i_4)
									return ((MenuActionEvent) class282_sub50_sub15_10.aClass477_9770.aCacheableNode_5629.aCacheableNode_8119).anInt9578;
						}
						...
						if (i_4 != -1) {
							...
							for (class282_sub50_sub7_7 = (MenuActionEvent) class469_9.method7790(); class282_sub50_sub7_7 != null; class282_sub50_sub7_7 = (MenuActionEvent) class469_9.next())
								if (i_5++ == i_4)
									return class282_sub50_sub7_7.anInt9578;
						}
					}
