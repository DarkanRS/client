...
public class CutsceneAction_Sub5 extends CutsceneAction {
	...
	public void method1592() {
		Camera.moveTo(anInt8845, anInt8846, anInt8847, 100, 100, false);
		Camera.forceAngle(anInt8848, anInt8849, 0);
		client.aBool7321 = true;
	}

	public void method1601() {
		Camera.moveTo(-1748191497 * anInt8845 * -597628217, anInt8846 * 693223401 * -808646567, -602355731 * anInt8847 * 1851960805, 100, 100, false);
		Camera.forceAngle(-908637089 * anInt8848 * -1393422433, anInt8849 * -652781679 * -1608889999, 0);
		client.aBool7321 = true;
	}
}
