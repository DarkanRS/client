...
public class IdentiKitIndexLoader implements IndexLoader {
	...
	static void method813(int i_0, int i_1, int i_2, int i_3) {
		...
		int i_7 = -i_2;
		int i_8 = -1;
		KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_1], i_0 - i_2, i_0 + i_2, i_3);
		while (i_6 > i_5) {
			i_8 += 2;
			i_7 += i_8;
			++i_5;
			if (i_7 >= 0) {
				--i_6;
				i_7 -= i_6 << 1;
				int[] ints_9 = Class532.anIntArrayArray7072[i_6 + i_1];
				int[] ints_10 = Class532.anIntArrayArray7072[i_1 - i_6];
				int i_11 = i_0 + i_5;
				int i_12 = i_0 - i_5;
			...
			int i_13 = i_0 + i_6;
			int i_14 = i_0 - i_6;
			int[] ints_15 = Class532.anIntArrayArray7072[i_5 + i_1];
			int[] ints_16 = Class532.anIntArrayArray7072[i_1 - i_5];
