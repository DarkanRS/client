...
class Class15 implements Interface35 {
	...
	static String method547(int[] ints_0) {
		...
		for (int element : ints_0) {
			QuestDefinitions questdefinitions_5 = IndexLoaders.QUEST_LOADER.getQuest(element);
			if (questdefinitions_5 != null && questdefinitions_5.graphicId != -1) {
