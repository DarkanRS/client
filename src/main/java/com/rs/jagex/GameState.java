...
public enum GameState {
	...
	public static boolean inLobby(GameState state) {
		return switch (state) {
		case UNK_0, UNK_2, UNK_6, UNK_7 -> true;
		default -> false;
		};
	}
	...
	public static boolean loggedIn(GameState state) {
		return switch (state) {
		case UNK_12, LOGGED_INGAME, UNK_18 -> true;
		default -> false;
		};
	}
	...
	public static boolean loggedOut(GameState state) {
		return switch (state) {
		case IN_ACCOUNT_CREATION, UNK_5, UNK_8, UNK_9, UNK_11, UNK_14, UNK_19 -> true;
		default -> false;
		};
	}
	...
	static boolean method2980(GameState state) {
		return switch (state) {
		case UNK_0, UNK_5, UNK_7, LOGGED_INGAME -> true;
		default -> false;
		};
	}
	...
	static boolean method4198(GameState state) {
		return switch (state) {
		case IN_ACCOUNT_CREATION, UNK_5, UNK_8, UNK_9, UNK_14, UNK_19 -> true;
		default -> false;
		};
	}
	...
	static boolean method7742(GameState state) {
		return switch (state) {
		case UNK_2, UNK_6, UNK_9, UNK_11, UNK_18 -> true;
		default -> false;
		};
	}
