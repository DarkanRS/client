...
public class JS5GrabWorker extends JS5FileWorker {
	...
	static boolean method12562() {
		if (AccountCreationStage.aCacheableNode_Sub7_12 == null)
			return false;
		AccountCreationStage.aCacheableNode_Sub7_12.menuAction = AccountCreationStage.aCacheableNode_Sub7_12.menuAction.removeLowPriority();
		return AccountCreationStage.aCacheableNode_Sub7_12.menuAction == MenuAction.IF_BUTTONX2;
	}
