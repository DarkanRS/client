...
public class IncommingPacket {
	...
	public static IncommingPacket CLAN_CHAT_CHANNEL;
	...
	static {
		...
		CLAN_CHAT_CHANNEL = new IncommingPacket(85, -2);
	...
	static final void method1906(ClientScript2 class403, byte i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2074, client.gameConnection.aClass449_330, (byte) 125);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_5_, -1055367891);
			client.gameConnection.method390(class298_sub36, (byte) -42);
		} catch (RuntimeException runtimeexception) {
