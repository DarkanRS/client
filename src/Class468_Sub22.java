...
public class Class468_Sub22 extends Class468 {
	...
	public void method12871(byte i) {
		if (aClass282_Sub54_5581.method13514((byte) 28) != Game.rs)
			anInt5578 = -754033619;
	...
	public int method7785(int i, int i_0_) {
		if (aClass282_Sub54_5581.method13514((byte) 66) == Game.rs) {
	...
	public int method7784(int i) {
		if (aClass282_Sub54_5581.method13514((byte) 72) == Game.rs) {
	...
	public void method12874() {
		if (aClass282_Sub54_5581.method13514((byte) 68) != Game.rs)
			anInt5578 = -754033619;
		if (0 != -859024475 * anInt5578 && 1 != anInt5578 * -859024475)
	...
	public boolean method12875() {
		if (aClass282_Sub54_5581.method13514((byte) 114) == Game.rs)
			return true;
		return false;
	}

	public boolean method12876() {
		if (aClass282_Sub54_5581.method13514((byte) 60) == Game.rs)
			return true;
		return false;
	}

	public boolean method12877() {
		if (aClass282_Sub54_5581.method13514((byte) 63) == Game.rs)
			return true;
		return false;
	}

	public boolean method12878() {
		if (aClass282_Sub54_5581.method13514((byte) 27) == Game.rs)
			return true;
		return false;
	}
