public class Node_Sub15_Sub4 extends Node_Sub15 {
	...
	void method15274(Node node_1, Node_Sub22 class282_sub22_2) {
		while (this.aClass482_9825.tail != node_1 && ((Node_Sub22) node_1).anInt7676 <= class282_sub22_2.anInt7676) {
			node_1 = node_1.next;
		}

		Class446.method7430(class282_sub22_2, node_1, -579151114);
		this.anInt9827 = ((Node_Sub22) this.aClass482_9825.tail.next).anInt7676;
	}

	public final synchronized void method15275(Node_Sub15 class282_sub15_1) {
		this.aClass482_9824.method8098(class282_sub15_1);
	}

	public final synchronized void method15276(Node_Sub15 class282_sub15_1) {
		class282_sub15_1.remove();
	}

	void method15277() {
		if (this.anInt9826 > 0) {
			for (Node_Sub22 class282_sub22_1 = (Node_Sub22) this.aClass482_9825.head(); class282_sub22_1 != null; class282_sub22_1 = (Node_Sub22) this.aClass482_9825.next(1387776965)) {
	...
	void method15279(Node_Sub22 class282_sub22_1) {
		...
		if (node_2 == this.aClass482_9825.tail) {
			...
			this.anInt9827 = ((Node_Sub22) node_2).anInt7676;
		}

	}

	void method15280(int i_1) {
		for (Node_Sub15 class282_sub15_2 = (Node_Sub15) this.aClass482_9824.head(); class282_sub15_2 != null; class282_sub15_2 = (Node_Sub15) this.aClass482_9824.next(2051746601)) {
	...
	public final synchronized void method12230(int[] ints_1, int i_2, int i_3) {
		while (true) {
			if (this.anInt9827 < 0) {
				...
				this.anInt9826 += i_4;
				this.method15277();
				Node_Sub22 class282_sub22_5 = (Node_Sub22) this.aClass482_9825.head();
	...
	void method15282(int[] ints_1, int i_2, int i_3) {
		for (Node_Sub15 class282_sub15_4 = (Node_Sub15) this.aClass482_9824.head(); class282_sub15_4 != null; class282_sub15_4 = (Node_Sub15) this.aClass482_9824.next(-554485695)) {
	...
	public final synchronized void method12231(int i_1) {
		while (true) {
			if (this.anInt9827 < 0) {
				...
				this.anInt9826 += i_2;
				this.method15277();
				Node_Sub22 class282_sub22_3 = (Node_Sub22) this.aClass482_9825.head();
	...
	Node_Sub15 method12229() {
		return (Node_Sub15) this.aClass482_9824.next(982164521);
	}

	Node_Sub15 method12235() {
		return (Node_Sub15) this.aClass482_9824.next(472610757);
	}

	Node_Sub15 method12236() {
		return (Node_Sub15) this.aClass482_9824.next(1730970362);
	}

	Node_Sub15 method12232() {
		return (Node_Sub15) this.aClass482_9824.head();
	}

	Node_Sub15 method12239() {
		return (Node_Sub15) this.aClass482_9824.next(-1222482007);
	}
