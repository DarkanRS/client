...
public class Class389 {
	...
	static final void method6696(CS2Executor class527, int i) {
		...
		((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 += 141891001) * 1942118537 - 1] = class118.anInt1334 * 539377845;
	}

	static final void method6697(Class118 class118, Class98 class98, CS2Executor class527, int i) {
		class118.aBool1356 = ((((CS2Executor) class527).intStack[(((CS2Executor) class527).anInt7012 -= 141891001) * 1942118537]) == 1);
