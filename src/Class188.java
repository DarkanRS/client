public class Class188 {
	...
	static final void method3138(CS2Executor cs2executor_0, int i_1) {
		cs2executor_0.intLocals[cs2executor_0.intOpValues[cs2executor_0.instrPtr]] = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
	}
				...
				if (TilestreamPacket.aClass364_4218 == tilestreampacket_0) {
					...
					if (IndexLoaders.MAP_REGION_DECODER.method4419(-1960644512) != Class256.aClass256_3153 && i_21 >= 0 && i_5 >= 0 && i_21 < IndexLoaders.MAP_REGION_DECODER.getSizeX(-1162153340) && i_5 < IndexLoaders.MAP_REGION_DECODER.getSizeY(-1140122689)) {
						if (i_6 == -1) {
							...
							client.aClass465_7334.method7765(new Class282_Sub50_Sub10(class521_sub1_sub1_sub4_35), (long) (i_21 << 16 | i_5));
						}
					}
				} else {
					int i_14;
