public class LoadingStage {
	...
	static final void method6677(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = cs2executor_0.aClass282_Sub4_7011.aClass57Array7499[i_2].aByte525;
	}

	static final void method6678(CS2Executor cs2executor_0, byte b_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		if (i_2 < 0 || i_2 > 5) {
			i_2 = 2;
		}
	...
	static final void method6680(CS2Executor cs2executor_0, int i_1) {
		if (client.aString7426 != null) {
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = Class459.anInt5534;
		} else {
	...
	static final void method6685(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
		IComponentDefinitions icomponentdefinitions_3 = Class117.method1981(i_2, (byte) 18);
		Interface interface_4 = Class468_Sub8.aClass98Array7889[i_2 >> 16];
		Class13.method502(icomponentdefinitions_3, interface_4, cs2executor_0, 577432492);
	}
