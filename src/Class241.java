...
public final class Class241 {
	...
	static final void method4146(CS2Executor cs2executor_0, int i_1) {
	...
	static final void method4147(CS2Executor cs2executor_0, int i_1) {
		int i_2 = cs2executor_0.intStack[--cs2executor_0.intStackPtr];
	...
	static final void method4148(CS2Executor cs2executor_0, int i_1) {
		...
		if (i_3 == -1) {
			...
			cs2executor_0.intStack[++cs2executor_0.intStackPtr - 1] = IndexLoaders.QUICK_CHAT_INDEX_LOADER.method5918(i_2, 230168792).method15211((char) i_3, 1343010087);
		}
