...
public class RenderAnimDefs {
	...
	static final void method3830(CS2Executor cs2executor_0, byte b_1) {
		cs2executor_0.stringStack[++cs2executor_0.stringStackPtr - 1] = Preference.method7788((long) cs2executor_0.intStack[--cs2executor_0.intStackPtr] * 60000L, Class223.CURRENT_LANGUAGE.method243((byte) 1), true, 1560112549) + " UTC";
	}
