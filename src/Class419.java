...
public class Class419 {
	...
	void method7023(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			((Class419) this).anInt5003 = class282_sub35.readBigSmart(2014093118) * 1046167957;
		else if (i == 2) {
	...
	void method7025(RsByteBuffer class282_sub35, int i, int i_1_) {
		if (1 == i)
			((Class419) this).anInt5003 = class282_sub35.readBigSmart(2047888647) * 1046167957;
		else if (i == 2) {
			anInt5002 = class282_sub35.readUnsignedByte() * -1596266669;
			anInt5000 = class282_sub35.readUnsignedByte() * 1040737113;
		}
	...
	void method7028(RsByteBuffer class282_sub35, int i) {
		if (1 == i)
			((Class419) this).anInt5003 = class282_sub35.readBigSmart(2079112581) * 1046167957;
		else if (i == 2) {
			anInt5002 = class282_sub35.readUnsignedByte() * -1596266669;
			anInt5000 = class282_sub35.readUnsignedByte() * 1040737113;
		}
