public class Class246 {
	...
	static void method4204(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2, int i_3) {
		if (icomponentdefinitions_0.aByte1333 == 0) {
			icomponentdefinitions_0.anInt1299 = icomponentdefinitions_0.basePositionX;
		} else if (icomponentdefinitions_0.aByte1333 == 1) {
			icomponentdefinitions_0.anInt1299 = icomponentdefinitions_0.basePositionX + (i_1 - icomponentdefinitions_0.anInt1301) / 2;
		} else if (icomponentdefinitions_0.aByte1333 == 2) {
			icomponentdefinitions_0.anInt1299 = i_1 - icomponentdefinitions_0.anInt1301 - icomponentdefinitions_0.basePositionX;
		} else if (icomponentdefinitions_0.aByte1333 == 3) {
			icomponentdefinitions_0.anInt1299 = icomponentdefinitions_0.basePositionX * i_1 >> 14;
		} else if (icomponentdefinitions_0.aByte1333 == 4) {
			icomponentdefinitions_0.anInt1299 = (i_1 - icomponentdefinitions_0.anInt1301) / 2 + (icomponentdefinitions_0.basePositionX * i_1 >> 14);
		} else {
			icomponentdefinitions_0.anInt1299 = i_1 - icomponentdefinitions_0.anInt1301 - (icomponentdefinitions_0.basePositionX * i_1 >> 14);
		}
		if (icomponentdefinitions_0.aByte1355 == 0) {
			icomponentdefinitions_0.anInt1428 = icomponentdefinitions_0.basePositionY;
		} else if (icomponentdefinitions_0.aByte1355 == 1) {
			icomponentdefinitions_0.anInt1428 = (i_2 - icomponentdefinitions_0.anInt1429) / 2 + icomponentdefinitions_0.basePositionY;
		} else if (icomponentdefinitions_0.aByte1355 == 2) {
			icomponentdefinitions_0.anInt1428 = i_2 - icomponentdefinitions_0.anInt1429 - icomponentdefinitions_0.basePositionY;
		} else if (icomponentdefinitions_0.aByte1355 == 3) {
			icomponentdefinitions_0.anInt1428 = i_2 * icomponentdefinitions_0.basePositionY >> 14;
		} else if (icomponentdefinitions_0.aByte1355 == 4) {
			icomponentdefinitions_0.anInt1428 = (i_2 - icomponentdefinitions_0.anInt1429) / 2 + (i_2 * icomponentdefinitions_0.basePositionY >> 14);
		} else {
			icomponentdefinitions_0.anInt1428 = i_2 - icomponentdefinitions_0.anInt1429 - (i_2 * icomponentdefinitions_0.basePositionY >> 14);
		}
