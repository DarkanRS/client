public class ia extends FontRenderer implements Interface40 {
	...
	ia(ja ja_1, ba ba_2, FontMetrics fontmetrics_3, Class91[] arr_4, NativeSprite[] arr_5) {
		...
		this.EA(ja_1, ba_2, bytes_6, arr_4[0].anIntArray955, ints_7, ints_8, ints_9, ints_10);
	}
